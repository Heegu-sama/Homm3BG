...
help() {
  echo "
    ...
    Optional Arguments:
      ...
      -m, --moved A:B               Page A on the left will be with page B on the right.
    ...
    Examples:
      ...
      ./tools/compare_pages.sh -l en -r 2-5 --moved 3:8 --moved 4:3
          This will produce the following 4 images:
          - en-02.png with page 2 on the left and page 2 on the right,
          - en-03.png with page 3 on the left and page 8 on the right,
          - en-04.png with page 4 on the left and page 3 on the right,
          - en-05.png with page 5 on the left and page 5 on the right.
  "
