...
\item Level - Whenever a main hero gains 1 or more experience \includegraphics[scale=0.75]{images/exp.PNG} move the cube that number of steps on this track. When the cube reaches the next slot on the upper row, the hero gains a level.
\end{enumerate}
\clearpage
...
\begin{enumerate}
    ...
    \begin{itemize}
        \item \textbf{Instant} \includegraphics[scale=0.75]{images/instant.PNG} effects are resolved immediately and can be played out of turn.
        ...
        \item \textbf{Map} \includegraphics[scale=0.75]{images/map.PNG} effects must be played on your turn and cannot be used during combat.  
        \item \textbf{Ongoing} \includegraphics[scale=0.75]{images/ongoing.PNG} effects must be played on your turn and last until they are used up or until the player who played them starts their next turn (whichever happens first).
        \item \textbf{Permanent} \includegraphics[scale=0.5]{images/permanent.PNG} effects must be played on your turn and stay in your play area until discarded or replaced. Players may have only one permanent card at a time; playing another discards the first.
    \end{itemize}
