...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \textbf{Permanent} \includegraphics[scale=0.5]{\images/permanent.png} cards stay in your play area until discarded or replaced. \textbf{Players may have only one permanent card at a time}; playing another discards the first.
    \end{itemize}
...
\begin{itemize}
    \item \textbf{Visitable} – Once you visit such a field, place a black cube on it. Treat it as an empty field as long as it has a black cube.
