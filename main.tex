...
%Create section heading with graphics. Argument one is heading name, argument two is picture to use on the left. Also adds the section to table of contents.
\newcommand{\addsection}[2]{
		\begin{center}
			\includegraphics[]{\images/sectionheading.png}
			\vspace*{-20ex}
			\color{yellow} \Huge \section{#1}
		\end{center}
		\vspace{-2ex}
		\begin{tikzpicture}
			\hspace{13ex}
...
\textbf{Heroes of Might and Magic III: The Board Game} is a tactical strategy RPG board game for 1-3 players using the core box set. The continent of Antagarich is under war as several different factions, led by their heroes, battle for supremacy. Choose your faction and your hero and banish your unruly enemies from these lands.\par

\addsection{GAME MODES}{\images/scroll.png}
...
\addsection{SETUP}{\images/skulls.png}
...
\addsection{ROUND STRUCTURE}{\images/huh.png}
...
\addsection{PLAYER TURNS}{\images/teleport.png}
...
\clearpage
\addsection{HEROES}{\images/wizard.png}
...
\clearpage
\addsection{RESOURCES}{\images/bag.png}
...
\addsection{TOWN}{\images/ballista.png}
...
\end{wrapfigure}
\addsection{MAP ELEMENTS}{\images/map.png}
...
\clearpage
\addsection{UNITS}{\images/banner.png}
...
\addsection{SCENARIO END}{\images/target.png}
...
\begin{wrapfigure}{R}{0.5\textwidth}
    ...
    \end{center}
\end{wrapfigure}
\addsection{EXPANSION CONTENT}{\images/globe.png}
...
\begin{wrapfigure}{R}{0.5\textwidth}
    ...
    \end{center}
\end{wrapfigure}
\addsection{ALL MAP LOCATIONS}{\images/catapult.png}
