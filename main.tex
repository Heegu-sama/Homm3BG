...
\begin{figure}
	\begin{subfigure}
		...
		\textbf{Trading Post}\par
		\shadowimage[width=0.48\textwidth]{\images/trading_post.jpg}
	...
	\begin{subfigure}
		\centering
		\captionsetup{width=.48\textwidth}
		\textbf{Black Market}\par
		\shadowimage[width=0.48\textwidth]{\images/black_market.jpg}
		\caption{Category: \textbf{Revisitable}\\Look at the top 4 cards from the Artifact discard pile. You can buy one of them for:\\
			5 \includesvg[height=10px]{\svgs/gold.svg} if it is a \textbf{Minor} Artifact \\
			7 \includesvg[height=10px]{\svgs/gold.svg}  if it is a \textbf{Major} Artifact \\
			10 \includesvg[height=10px]{\svgs/gold.svg}  if it is a \textbf{Relic} Artifact
			}
	\end{subfigure}
\end{figure}
...
\begin{figure}
	...
	\captionsetup{width=.5\linewidth}
	\textbf{Tavern}\par
	\shadowimage[width=0.5\linewidth]{\images/tavern.jpg}
...
\begin{figure}
	...
	\captionsetup{width=.5\linewidth}
	\textbf{Library}\par
	\shadowimage[width=0.5\linewidth]{\images/library.jpg}
