...
\item Level - Whenever a main hero gains 1 or more experience \includegraphics[scale=0.75]{exp.PNG} move the cube that number of steps on this track. When the cube reaches the next slot on the upper row, the hero gains a level.
\end{enumerate}
\clearpage
