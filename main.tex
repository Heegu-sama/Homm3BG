...
\begin{figure}
	\centering
	\captionsetup{width=.5\linewidth}
	\textbf{Star Axis}\par\medskip
	\shadowimage[width=0.5\linewidth]{\images/star_axis.jpg}
	\caption{Category: \textbf{Flaggable}\\
		...
		Once visited by a faction, the Star Axis counts as an empty field for that faction, ust like a visitable field would.
	}
\end{figure}
