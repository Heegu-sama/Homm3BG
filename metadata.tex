...
% Create note box; the first optional parameter is how much width to give for the content
\newcommand{\note}[3][0.85]{
  \begin{tikzpicture}
    \draw (0, 0) node[inner sep=0] {\makebox[\linewidth][c]{\picdims[width=\linewidth]{\linewidth}{#2\baselineskip}{\layout/note-big.jpg}}};
