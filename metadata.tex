...
\newcommand{\svg}[2][10]{%
  ...
  \newif\ifnoraise
  \noraisefalse
  \IfBeginWith{#2}{movement}{\noraisetrue}{}%
  \IfBeginWith{#2}{expert}{\noraisetrue}{}%
  \IfBeginWith{#2}{reinforce}{\noraisetrue}{}%
  \IfBeginWith{#2}{level1}{\noraisetrue}{}%
  \IfBeginWith{#2}{level4}{\noraisetrue}{}%
  \IfBeginWith{#2}{level6}{\noraisetrue}{}%
  \IfBeginWith{#2}{unit_flying}{\noraisetrue}{}%
  \IfBeginWith{#2}{arrow_right}{\noraisetrue}{}%
  \IfBeginWith{#2}{arrow_right_gray}{\noraisetrue}{}%
  \ifnoraise
...
\newcommand{\svgunit}[2][10]{%
  {\raisebox{-0.1\height}{\includesvg[height=#1px]{{\iftoggle{noartbackground}{\svgs/\detokenize{#2}-mono.svg}{\svgs/\detokenize{#2}.svg}}}}}%
}%
