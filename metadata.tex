...
\NewDocumentEnvironment{expansion}{ O{} m +b }{
  ...
  \tl_clear_new:N \l_firstexpname_tl
  \tl_set:No \l_firstexpname_tl {\clist_item:Nn \l_tmpa_clist {1}}

  % All expansions for the title
  \tl_clear_new:N \l_exptitles_tl
  \seq_clear:N \l_tmpa_seq
  \clist_map_inline:Nn \l_tmpa_clist {
    \seq_put_right:No \l_tmpa_seq {\color{##1}\MakeUppercase{\expansiontext{##1}}}
  }
  \tl_set:No \l_exptitles_tl {\seq_use:Nn \l_tmpa_seq { ,~ }}
  ...
  \begin{tcolorbox}[
    ...
    overlay={
      ...
      \fill[
        top~color=\l_firstexpname_tl,
        bottom~color=\l_firstexpname_tl,
...
\cs_new:Nn \__expansion_tikz_square: {
  \begin{tikzpicture}[baseline=0]
    \fill[\l_firstexpname_tl] (0,0) rectangle (2.2mm,2.2mm);
    \draw[borderinyellow,~line~width=0.9pt] (0,0) rectangle (2.2mm,2.2mm);
    \draw[borderoutyellow,~line~width=0.8pt] (current~bounding~box.north~west) rectangle (current~bounding~box.south~east);
  \end{tikzpicture}
}
...
\NewDocumentCommand{\expansionlabel}{ m }{
  ...
  \seq_clear:N \l_tmpa_seq
  \clist_map_inline:Nn \l_tmpa_clist {
    \seq_put_right:No \l_tmpa_seq {\MakeUppercase{\use:c{expansiontext}{##1}}}
  }
  \tl_set:No \l_exptitles_tl {\seq_use:Nn \l_tmpa_seq { ,~ }}

  \vspace{-\baselineskip}\makebox[1.0055\columnwidth][r]{\textcolor{\l_firstexpname_tl}{\tiny\raisebox{0.8\baselineskip}{\textbf{\l_exptitles_tl} \hspace{2pt}\raisebox{-0.08\baselineskip}{%
    \__expansion_tikz_square:
  }}}}
...
\NewDocumentCommand{\expansionlabelnocap}{ m }{
  ...
  \vspace{-\baselineskip}\makebox[1.0055\columnwidth][r]{\textcolor{\l_firstexpname_tl}{\tiny\raisebox{-1.1\baselineskip}{\textbf{\l_exptitles_tl} \hspace{2pt}\raisebox{-0.08\baselineskip}{%
    \__expansion_tikz_square:
  }}}}
