...
\NewDocumentEnvironment{expansion}{ O{} m +b }{
  ...
  \iftoggle{textright2left}{
    \tl_set:No \l_expoverlay_tl {
      \fill[
        ...
        ([xshift=5pt, yshift=3pt]frame.north~east) rectangle
      ...
      ([xshift=8pt, yshift=3pt]frame.north~east) rectangle
  ...
  % minipage is here for the correct text alignment in Hebrew
  \textlang{english}{\begin{tcolorbox}[
    enhanced,
    title=\textlang{\mainlanguagename}{\begin{minipage}{\linewidth}\textbf{\tiny\l_exptitles_tl}\end{minipage}},
    opacityfill=0,
    size=small,
    boxrule=0pt,
    arc=0pt,
    ...
    #1]
    \textlang{\mainlanguagename}{\begin{minipage}{\linewidth}#3\end{minipage}}
  \end{tcolorbox}}
}{}
