...
\newcommand{\note}[2]{
  \begin{tikzpicture}
    ...
    \begin{pgfonlayer}{background}
      \draw [shade, blur shadow={shadow blur steps=5, shadow opacity=15}] (current bounding box.north west) rectangle (current bounding box.south east);
    \end{pgfonlayer}
  \end{tikzpicture}
}
...
\newcommand{\hommtable}[2]{
  \begin{tikzpicture}
    ...
    \begin{pgfonlayer}{background}
      \draw [shade, blur shadow={shadow blur steps=5, shadow opacity=40}] (current bounding box.north west) rectangle (current bounding box.south east);
    \end{pgfonlayer}
  \end{tikzpicture}
}
