  ...
  \iftoggle{textright2left}{
    \tl_set:No \l_expoverlay_tl {
      \fill[
        ...
        \IfBooleanTF{#1}{([xshift=5pt-\linewidth, yshift=-\paperheight]frame.south~west)}{([xshift=5pt-\linewidth, yshift=-3pt]frame.south~west)};
      \fill[
    ...
    \tl_set:No \l_expoverlay_tl {
      \fill[
        ...
        \IfBooleanTF{#1}{([xshift=5pt, yshift=-\paperheight]frame.south~east)}{([xshift=5pt, yshift=-3pt]frame.south~east)};
      \fill[
        top~color=\l_expcolor_tl,
        bottom~color=\l_expcolor_tl,
        rounded~corners=1.5pt,
...
\newcommand\encirclebase[4][normal]{%
  ...
  \tikz[baseline=(X.base)]{
    ...
    \begin{scope}[on background layer]
      \node [inner sep=0pt, opacity=0.7] at ([xshift=\shadowoffset, yshift=-\shadowoffset]X.center) {\includegraphics[width=\shadowscale]{\layout/circle_drop_shadow.png}};
    \end{scope}
  }
  \end{footnotesize}%
}
