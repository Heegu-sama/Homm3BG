...
\definecolor{difficultydec}{rgb}{0.38, 0.77, 0.53}
\definecolor{difficultyinc}{rgb}{1, 0.53, 0.46}
% Expansion colors
...
\newcommand\encircleinline[1]{%
  \phantom{(#1)}\makebox[0pt][r]{%
    \raisebox{0.1\height}[0pt][0pt]{\encirclebase[legend]{goblin}{0.9em}{#1}\hspace*{-1ex}}%
  }%
}

\newcommand\itemdotimage[1]{%
  \makebox[0pt][r]{%
    \raisebox{0\height}[0pt][0pt]{#1}%
  }%
}
