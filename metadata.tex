...
\newcommand{\addsection}[3][1]{
  ...
  \begin{fullwidth}[leftmargin=0.16\textwidth, outermargin=0.16\textwidth, innermargin=0.16\textwidth]
    \begin{center}
      ...
      \sectionheadertext{#2}
      \cleardoublepage\phantomsection\addcontentsline{toc}{section}{\protect\mbox{#2}}
    \end{center}
  \end{fullwidth}
  \vspace{1.75em}
  \ifthenelse{\oneliner}{}{\vspace{-13pt}}
...
\newcounter{subheadcounter}
\newcommand{\subheader}[2][true]{%
    \stepcounter{subheadcounter}%
    \ifstrequal{#1}{false}{}{%
        \addcontentsline{toc}{subsection}{\protect #2}%
    }%
    \begin{center}
