...
\cs_new:Nn \__expansion_color_titles:NNn {
  ...
  \tl_set:No #2 {\seq_use:Nn \l_tmpa_seq { \\[-0.7em] }}
}
...
\newcommand{\imagecaption}[1]{%
  \textbf{\textit{\textcolor{darkcandyapplered}{#1}}}%
}
...
% Copied from newcomputermodern package
\newfontfamily{\computermodernfont}[
  SizeFeatures={%
...
\newcommand{\subheader}[2][]{%
  ...
  \begin{center}
    \textbf{\subheaderfont\Large\scshape #2}
    \\[0.02em]
...
\newcommand\encirclebase[3]{%
  \tikz[baseline=(X.base)]
  \node (X) [draw=white, shape=circle, minimum size=1.6em, align=center, inner sep=0, fill=#1, text=white, #2] {\strut \textbf{#3}};%
}
\newcommand\encircle[1]{
  \encirclebase{goblin}{blur shadow={shadow blur steps=5}}{#1}
}
\newcommand\encirclered[1]{%
  \encirclebase{darkcandyapplered}{blur shadow={shadow blur steps=5}}{#1}
}
\newcommand\encirclelegend[2]{%
  \encirclebase{#1}{blur shadow={shadow blur steps=3, shadow xshift=0.5pt, shadow yshift=-0.5pt, shadow blur radius=1pt}}{#2}
}
