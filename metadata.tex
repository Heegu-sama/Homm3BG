...
% Expansion colors
\definecolor{tower}{HTML}{AAAAAA}      % gray
...
\definecolor{stronghold}{HTML}{D2B48C} % tan
\definecolor{conflux}{HTML}{DA70D6}    % orchid
\definecolor{cove}{HTML}{20B2AA}       % lightseagreen

\newtcolorbox{expansion}[1]{
  enhanced,
  title=\textbf{\scriptsize \MakeUppercase{#1 expansion}},
  coltitle=#1,
  colback=#1,
  colbacktitle=#1,
  colframe=#1,
