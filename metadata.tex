...
\definecolor{stretchgoal2}{HTML}{000000}
...
\NewDocumentCommand{\expansionlabel}{ m }{
  ...
  \vspace{-\baselineskip}\makebox[1.0055\linewidth][r]{\textcolor{\l_firstexpname_tl}{\tiny\raisebox{0.8\baselineskip}{\textbf{\l_exptitles_tl} \hspace{2pt}\raisebox{-0.14\baselineskip}{%
...
\NewDocumentCommand{\expansionlabelnocap}{ m }{
  ...
  \vspace{-\baselineskip}\makebox[1.0055\linewidth][r]{\textcolor{\l_firstexpname_tl}{\tiny\raisebox{-1.1\baselineskip}{\textbf{\l_exptitles_tl} \hspace{2pt}\raisebox{-0.14\baselineskip}{%
    \__expansion_tikz_square:
  }}}}
