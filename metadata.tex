...
\newcommand{\ifnoraisepfx}[3]{%
  \IfBeginWith{#1}{movement}{#2}{%
  \IfBeginWith{#1}{expert}{#2}{%
  \IfBeginWith{#1}{reinforce}{#2}{%
  \IfBeginWith{#1}{level1}{#2}{%
  \IfBeginWith{#1}{level4}{#2}{%
  \IfBeginWith{#1}{level6}{#2}{%
  \IfBeginWith{#1}{unit_flying}{#2}{%
  \IfBeginWith{#1}{arrow_right_gray}{#2}{%
  \IfBeginWith{#1}{arrow_right}{#2}{#3}%
}}}}}}}}}
