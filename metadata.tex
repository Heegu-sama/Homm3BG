...
\usetikzlibrary{shadows, shadows.blur, calc, backgrounds, positioning}
...
\definecolor{stretchgoals2}{HTML}{000000}  % black
...
\newcommand{\wikilink}[2]{%
  \bgroup%
  \hypersetup{urlcolor=.}%
  \href{https://\wikilang.homm3bg.wiki/#1}{#2\textcolor{\hyperlinkcolor}{\textbf{°}}}%
  \egroup%
}
