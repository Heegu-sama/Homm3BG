...
\newcommand{\getenv}[2][]{%
  \CatchFileEdef{\value}{"|kpsewhich --var-value #2"}{\endlinechar=-1}%
...
\begin{center}
  ...
  \getenv[\repourl]{REPO_URL}
  \getenv[\version]{HOMM3_VERSION}

  \ifdefempty{\githubsha}{
    \versionlabel{} \version
  }{
    \versionwarning{} \href{\repourl}{\githubsha}.
  }
