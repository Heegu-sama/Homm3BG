...
\NewDocumentCommand{\expansionlabelnocap}{ m }{
  ...
  \makebox[\columnwidth][r]{\textcolor{\l_firstexpname_tl}{\tiny\raisebox{\baselineskip}{\textbf{\l_exptitles_tl} \hspace{2pt}\raisebox{-0.08\baselineskip}{\rule{2.2mm}{2.2mm}}}}}
  \vspace{-\baselineskip}
}
\ExplSyntaxOff
