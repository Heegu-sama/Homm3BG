...
% Languages that have issues with header alignment also have different
% spacing around subsection titles. This should apply the same correction
% and there shouldn't be any need for \vspace*{\lang_header_adjustment}
\titlespacing*{\subsection}{0em}{1.1em}{0.2em}
