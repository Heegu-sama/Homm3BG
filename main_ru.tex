...
\newcommand{\expansiontext}[1]{%
  \stringswitch{#1}{
    {tower}{Дополнение <<Tower>>}
    {rampart}{Дополнение <<Rampart>>}
    {fortress}{Дополнение <<Fortress>>}
    {inferno}{Дополнение <<Inferno>>}
    {stronghold}{Дополнение <<Stronghold>>}
    {conflux}{Дополнение <<Conflux>>}
    {cove}{Дополнение <<Cove>>}
    {battlefield}{Дополнение <<Battlefield>>}
    {navalbattles}{Дополнение <<Naval Battles>>}
    {stretchgoals2}{Дополнение <<Stretch Goals 2>>}
  }{Дополнение <<#1>>}%
}
