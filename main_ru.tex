...
\newcommand{\expansiontext}[1]{%
  \stringswitch{#1}{
    {tower}{Расширение <<Башня>>}
    {rampart}{Расширение <<Оплот>>}
    {fortress}{Расширение <<Крепость>>}
    {inferno}{Расширение <<Инферно>>}
    {stronghold}{Расширение <<Цитадель>>}
    {conflux}{Расширение <<Сопряжение>>}
    {cove}{Расширение <<Причал>>}
    {battlefield}{Расширение <<Поле Битвы>>}
    {navalbattles}{Расширение <<Морские Баталии>>}
    {stretchgoals2}{Расширение <<Stretch Goals 2>>}
  }{Расширение <<#1>>}%
}
