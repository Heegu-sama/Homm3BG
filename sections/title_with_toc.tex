...
\begin{center}
  ...
  {\large\doclicenseIcon}
\end{center}

This project is licensed under \doclicenseLongNameRef.
It is community-driven, and has a \href{\repourl}{GitHub repository}.
Everyone is welcome to contribute, make changes, and fix errors.
You can get in touch with creators through \href{\discordurl}{Discord} or by writing in the \href{\bggthreadurl}{BoardGameGeek thread}.
...
\AddToHookNext{shipout/background}{%
  \iftoggle{noartbackground}{}{
    \put (\iftoggle{printable}{0.005\paperwidth}{0.03\paperwidth},-0.75\paperheight){\transparent{0.15}{\includegraphics[width=0.9\paperwidth]{\art/minotaur_crusader_skeleton.png}}}%
  }%
  \iftoggle{printable}{
    \drawbottom
...
More Factions, Heroes, and their armies await in the expansions.
