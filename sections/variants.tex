...
\begin{multicols*}{2}
  ...
  Creature Bank Unit cards don't have a tier (\svg{bronze}, \svg{silver}, \svg{golden}, \svg{azure}), therefore all effects that interact with tiers do not work for them (e.g. the \wikilink{spells/berserk}{Berserk Spell}).
