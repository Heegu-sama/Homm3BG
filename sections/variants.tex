...
\begin{multicols*}{2}
  ...
  Depending on the Creature Bank you are visiting, take the corresponding units from the Creature Bank unit cards and place them randomly in the Neutral unit deployment zone. Creature Bank Unit cards don't have a tier (svg{bronze},svg{silver},svg{golden},svg{azure}), therefore all effects that interact with tiers do not work for them (e.g. the Spell \wikilink{spells/berserk}{Berserk}).
