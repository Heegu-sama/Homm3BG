...
\begin{center}
  {\transparent{0.3}\includegraphics[width=0.7\linewidth]{\art/astrologers.png}}
\end{center}

\begin{figure}[H]
  \begin{tikzpicture}
    \node at (0, 0) {\includegraphics[width=\linewidth]{\cards/astrolog-back.png}};
    \node at (0.7, 1.2) {\includegraphics[width=\linewidth]{\cards/astrolog.png}};
  \end{tikzpicture}
  \centering\footnotesize\textit{Astrologers Proclaim Card}
\end{figure}
