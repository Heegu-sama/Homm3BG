...
\pl{
  \addsection{Przygotowanie gry}{\skills/necromancy.png}
}
...
\begin{enumerate}
  ...
  \begin{itemize}
    \en{\item[a)]1 × Double-sided Hero Card (on the side of the chosen Hero)}
    \pl{\item[a)]}
    \en{\item[b)]2 × Hero model}
    \pl{}
    \en{\item[c)]7 × Town Building Tile}
    \pl{}
    \en{\item[d)]1 × Town Board}
    \pl{}
    \en{\item[e)]7 × Double-sided Unit Card}
    \pl{}
    \en{\item[f)]3 × Hero-specific Specialty Card (of the chosen Hero)}
    \pl{}
    \en{\item[g)]1 × Hero-specific Ability Card (of the chosen Hero)}
    \pl{}
    \en{\item[h)]20 × Faction Cube}
    \pl{}
    \en{\item[i)]1 × Build Token}
    \pl{}
    \en{\item[j)]1 × Population Token}
    \pl{}
    \en{\item[k)]1 × Spell Book Token}
    \pl{}
  \end{itemize}
  \en{
  ...
  \en{
    \item Choose a starting player.
      The starting player never changes during the game.
  }
  \pl{
  }
\end{enumerate}
