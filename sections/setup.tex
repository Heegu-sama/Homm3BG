...
\begin{figure}[p]
  ...
  \begin{tikzpicture}
    ...
    \begin{relcoords}{game}
      ...
      \draw (0.83, 0.64) node {\encircle{3}};
      \draw (0.5, 0.25) node {\encircle{4a}};
      \draw (0.74, 0.6) node {\encircle{4a}};
      \draw (0.33, 0.4) node {\encircle{4b}};
      \draw (0.71, 0.55) node {\encircle{4b}};
      \draw (0.8, 0.05) node {\encircle{4c}};
      \draw (0.55, 0.72) node {\encircle{4c}};
      \draw (0.9, 0.2) node {\encircle{4d}};
      \draw (0.44, 0.62) node {\encircle{4d}};
      \draw (0.1, 0.82) node {\encircle{4e}};
      \draw (0.92, 0.82) node {\encircle{4e}};
      \draw (0.59, 0.1) node {\encircle{4f}};
      \draw (0.7, 0.7) node {\encircle{4f}};
      \draw (0.46, 0.1) node {\encircle{4g}};
      \draw (0.8, 0.7) node {\encircle{4g}};
      \draw (0.58, 0.57) node {\encircle{4h}};
      \draw (0.62, 0.28) node {\encircle{4h}};
      \draw (0.8, 0.1) node {\encircle{4i}};
      \draw (0.53, 0.69) node {\encircle{4i}};
      \draw (0.85, 0.1) node {\encircle{4j}};
      \draw (0.49, 0.69) node {\encircle{4j}};
      \draw (0.89, 0.1) node {\encircle{4k}};
      \draw (0.42, 0.69) node {\encircle{4k}};
      \draw (0.66, 0.58) node {\encircle{4l}};
      \draw (0.9, 0.27) node {\encircle{4l}};
      \draw (0.6, 0.44) node {\encircle{6}};
      \draw (0.7, 0.1) node {\encircle{7}};
      \draw (0.6, 0.69) node {\encircle{7}};
      \draw (0.86, 0.15) node {\encircle{8}};
      \draw (0.45, 0.65) node {\encircle{8}};
      \draw (0.33, 0.25) node {\encircle{9}};
      \draw (0.8, 0.33) node {\encircle{9}};
      \draw (0.8, 0.57) node {\encircle{9}};
      \draw (0.11, 0.26) node {\encircle{10}};
      \draw (0.25, 0.13) node {\encircle{11}};
      \draw (0.28, 0.69) node {\encircle{11}};
      \draw (0.1, 0.4) node {\encircle{15}};
      \draw (0.22, 0.4) node {\encircle{16}};
      \draw (0.9, 0.45) node {\encircle{18}};
      \draw (0.75, 0.75) node {\encircle{19}};
      \draw (0.34, 0.57) node {\encircle{20}};
      \draw (0.23, 0.59) node {\encircle{21}};
      \draw (0.09, 0.59) node {\encircle{24}};
    \end{relcoords}
\end{tikzpicture}}
\end{figure}
