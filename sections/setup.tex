...
\begin{figure}[p]
  ...
  \begin{tikzpicture}
    ...
    \draw (5.1, 5.8) node {\encircle{20}};
    \draw (-4.8, -2) node {\encircle{21}};
    \draw (-7.1, -1.5) node {\encircle{22}};
    \draw (-9.1, -1.5) node {\encircle{23}};
  \end{tikzpicture}
  \end{scriptsize}
\end{figure}
...
\begin{enumerate}
  ...
  \end{itemize}
  \item Place one of your Faction Cubes on the first space of the Level Tracker found on the Hero Card (Represented by \svg{level1}).
  ...
  \begin{expansion}[before skip balanced=0.3em,left=7mm]{navalbattles}
    \item Group Stack Tokens, Far- and Near Creature Bank Tokens into separate piles and shuffle them.
      Place Creature Bank Unit Cards near Neutral Unit Decks.
  \end{expansion}
  \vspace{-0.9em}
  \begin{expansion}[left=7mm]{conflux}
    \item Place Summon Elemental Cards near Neutral Unit Decks.
  \end{expansion}
  ...
  \begin{expansion}[before skip balanced=0.3em,left=7mm]{fortress}
    \item Shuffle the Event Cards and place them face down next to the Round Tracker.
  \end{expansion}
  ...
  \begin{expansion}[before skip balanced=0.3em,left=7mm]{stronghold}
    \item Shuffle the Spell Scroll Cards and place them face down near the Ability, Artifact, and Spell Decks.
  \end{expansion}
  \begin{expansion}[before skip balanced=0.3em,left=7mm]{stretchgoals2}
    \item Shuffle \pagelink{Pandora Card}{Pandora's Box Cards}.
  \end{expansion}
  \begin{expansion}[before skip balanced=0.3em,left=7mm]{navalbattles}
    \item Place the Empowered Ability Cards face up next to the Ability Deck.
  \end{expansion}
  \begin{expansion}[before skip balanced=0.3em,left=7mm]{battlefield}
    \item Shuffle the \pagelink{Morale Cards}{Morale Cards} and place them within reach for all players.
  \end{expansion}
\end{enumerate}

\vspace*{\fill}
\begin{center}
  \transparent{0.2}{\reflectbox{\includegraphics[width=1.15\linewidth, keepaspectratio]{\art/unicorn.png}}}
\end{center}
