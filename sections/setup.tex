...
\begin{enumerate}
  ...
  \item Sort the Statistic cards into four piles: Attack, Defense, Power, and Knowledge.
    Refer to the Statistics on your \pagelink{Herocard}{Hero Board}, take the corresponding number of cards from each pile, and add them to your Starting Deck.
...
\vspace*{\fill}
\begin{center}
  \transparent{0.2}{\reflectbox{\includegraphics[width=\linewidth, keepaspectratio]{\art/unicorn.png}}}
\end{center}
