...
\begin{enumerate}[leftmargin=2.3em]
  ...
  \end{itemize}
  \item Place one of your Faction Cubes on the first space of the Level Tracker found on the Hero Board (Represented by \herolevel{I}).
  ...
  \item \pagetarget{SetupStartingDeck}{} Sort the Statistic cards into four piles: \wikilink{statistics/attack}{Attack,} \wikilink{statistics/defense}{Defense,} \wikilink{statistics/power}{Power,} and \wikilink{statistics/knowledge}{Knowledge.}
  ...
  \columnbreak
  \item \label{SetupStartingDeckEnd} Add your Hero's \pagelink{Ability}{Ability} and Level I \pagelink{Specialty}{Specialty} cards to your Starting Deck.
  ...
  \item \pagetarget{setupdifficulty}{Choose the Scenario's \pagelink{Difficulty}{Difficulty} and take the corresponding Starting Bonus(es)}.
...
\begin{figure}[p]
  ...
  \begin{tikzpicture}
    ...
    \begin{relcoords}{game}
      ...
      \draw (0.13, 0.22) node {\encircle{10}};
      \draw (0.08, 0.22) node {\encirclered{10}};
      ...
      \draw (0.74, 0.93) node {\encirclered{25}};
      \draw (0.93, 0.34) node {\encirclered{28}};
      \draw (0.08, 0.25) node {\encirclered{29}};
      \draw (0.93, 0.5) node {\encirclered{30}};
      \draw (0.93, 0.42) node {\encirclered{32}};
    \end{relcoords}
    \node (bar) [below=3pt of game.south, opacity=0.7] {
      \centering
      \includegraphics[width=\linewidth,height=1em,keepaspectratio]{\layout/subsection_separator.png}
    };
    \node [below=0pt of bar.south] {
      \centering
      \begin{minipage}{0.3\linewidth}
        \raisebox{.2\height}{\encirclelegend{goblin}{C}} Core game\\
        \raisebox{.2\height}{\encirclelegend{darkcandyapplered}{E}} Expansions
      \end{minipage}
    };
  \end{tikzpicture}}
\end{figure}
