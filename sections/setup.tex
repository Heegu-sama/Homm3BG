...
\begin{figure}[p]
  ...
  \begin{tikzpicture}
    ...
    \draw (5.1, 5.8) node {\encircle{22}};
    \draw (-4.8, -2) node {\encircle{23}};
    \draw (-7.1, -1.5) node {\encircle{24}};
    \draw (-9.1, -1.5) node {\encircle{25}};
  \end{tikzpicture}
  \end{scriptsize}
\end{figure}
...
\begin{enumerate}
  ...
  \begin{expansion}[before skip balanced=0.3em,left=7mm]{stronghold}
    \item Shuffle 10 Spell Scroll Cards into the Artifact Deck.
  ...
  \begin{expansion}[before skip balanced=0.8em,left=7mm]{inferno}
    \item Place the Empowered Statistic Cards face up in a separate pile.
  \end{expansion}
