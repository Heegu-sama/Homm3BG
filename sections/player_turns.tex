...
If a player has both a Main and a \pagelink{Secondary}{Secondary Hero}, track their MP separately.
...
\begin{itemize}
  \item [{\includegraphics[height=1.5\baselineskip, valign=c]{\images/build.png}}] Build Token, used to expand your \pagelink{Town}{Town}.
  \item [{\includegraphics[height=1.5\baselineskip, valign=c]{\images/population.png}}] Population Token, used to Recruit and Reinforce \pagelink{Units}{Units} or to Recruit \pagelink{Secondary}{a Secondary Hero}.
  \item [{\includegraphics[height=1.5\baselineskip, valign=c]{\images/spells.png}}]Spell Book Token, used to purchase \pagelink{spells}{Spells}.
\end{itemize}
...
\textit{She then spends her Build Token to construct the \includesvg[height=10px]{\svgs/golden.svg} Dwelling, and then her Population Token to \pagelink{Units}{Recruit} the \includesvg[height=10px]{\svgs/golden.svg} Unit Champions.
She is allowed to do this, as she had previously built the prerequisite lower Level Dwellings (\includesvg[height=10px]{\svgs/bronze.svg} and \includesvg[height=10px]{\svgs/silver.svg}) and has enough \pagelink{Resources}{Resources} to both Build the Dwelling and to Recruit the Champions.}\par
