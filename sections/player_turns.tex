...
She can do this, as she had previously built the prerequisite lower Level Dwellings (\includesvg[height=10px]{\svgs/bronze.svg} and \includesvg[height=10px]{\svgs/silver.svg}) and has enough \pagelink{Resources}{Resources} to both Build the Dwelling and to Recruit the Champions.}\par
