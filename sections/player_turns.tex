...
\note{medium}{
  Whenever you are instructed to gain (additional) MP, sometimes shorthanded with the symbol \includesvg[height=10px]{\svgs/movement.svg}, that MP persists for \textbf{only the Turn it was gained on}.
...
\note{small}{The Necropolis \includesvg[height=10px]{\svgs/necro.svg} Faction ignores any Morale effects.
