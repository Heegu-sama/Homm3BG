...
\note{10}{
  Whenever you are instructed to gain (additional) MP, sometimes represented by the symbol \svgeven{movement-yellow}, that MP persists for \textbf{only the Turn it was gained on}.
