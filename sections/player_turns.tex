...
\subsection*{\hypertarget{Town Actions}{Town Actions}\index{Town Actions}}
...
\begin{itemize}
  \item [{\includegraphics[height=1.5\baselineskip, valign=c]{\images/build.png}}] Build Token\index{Build Token}, used to expand your \hyperlink{Town}{Town}.
  \item [{\includegraphics[height=1.5\baselineskip, valign=c]{\images/population.png}}] Population Token\index{Population Token}, used to Recruit and Reinforce \hyperlink{Units}{Units} or to Recruit \hyperlink{Secondary}{a Secondary Hero}.
  \item [{\includegraphics[height=1.5\baselineskip, valign=c]{\images/spells.png}}]Spell Book Token\index{Spell Book Token}, used to purchase \hyperlink{spells}{Spells}. Requires the Mage Guild Town building to use.
\end{itemize}

\subsection*{\hypertarget{Morale}{Morale} Actions}\index{Morale Actions}
