...
\begin{scriptsize}
  \begin{tikzpicture}
    ...
    \draw (2.4, 0) node[inner sep=0] {\makebox[0.47\linewidth][c]{\includegraphics[width=0.47\linewidth]{\cards/morale-negative.png}}};
    ...
    \draw (1.5, -1.4) node {\encircle{\phantom{.}2\phantom{.}}};
    \draw (2.4, -1.9) node {\encircle{\phantom{.}3\phantom{.}}};
    \draw (-2.0, -1.9) node {\encircle{\phantom{.}3\phantom{.}}};
  \end{tikzpicture}
\end{scriptsize}
\vspace{-1em}
\begin{multicols*}{2}
