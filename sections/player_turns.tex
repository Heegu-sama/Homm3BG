...
\subheader{\pagetarget{Town Actions}{Town Actions}\index{Town Actions}}
...
\subheader{\pagetarget{Morale}{Morale} Actions}\index{Morale Actions}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[t]{0.7\linewidth}
    \begin{itemize}
      \item[\textbf{3.}] Battlefield symbol\\{\scriptsize\textit{(Use such Cards only in \pagelink{Battlefield Modes}{Adventure and Skirmish} games)}}
    \end{itemize}
  \end{subfigure}
\end{figure}
