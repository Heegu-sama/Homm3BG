...
\begin{itemize}
  ...
  \item [{\includegraphics[height=1.5\baselineskip, valign=c]{\images/spells.png}}]Spell Book Token\index{Spell Book Token}, used to purchase \pagelink{spells}{Spells}.
    Requires the \pagelink{Town}{Mage Guild} Town building to be \textbf{built in a previous Round}.
\end{itemize}
