...
\pl{
  \addsection{Tury graczy}{\spells/dimension_door.png}
}

\begin{multicols}{2}

\en{At the start of your Turn, refresh your hand of Cards following these steps:}
\pl{}
\begin{itemize}
  \en{
  ...
  \pl{\item}
  \en{\item You may then draw Cards up to your Hand Limit.}
  \pl{\item}
  \en{\item Resolve any "at the beginning of your turn" abilities after drawing.}
  \pl{\item}
\end{itemize}
\en{
...
\begin{itemize}
  \en{\item Move a Hero 1 Field in any direction.}
  \pl{\item}
  \en{\item \hyperlink{Categories}{Revisit} a Field where your Hero is in.}
  \pl{\item}
  \en{\item \hyperlink{Timelimit}{Continue Combat} against Neutral Units for 1 additional Combat Round.}
  \pl{\item}
  \en{\item \hyperlink{Placing}{Discover a face down Map Tile} if your Hero is on a Field next to that Tile.}
  \pl{\item}
  \en{\item Place a new Map Tile from your pool of Far (II–III) Map Tiles.}
  \pl{\item}
\end{itemize}
...
\begin{center}
  ...
  \medskip
  \en{\footnotesize\textit{An active and an inactive Movement Token.}}
  \pl{}
\end{center}
...
\pl{}
\begin{itemize}
  \item [{\includegraphics[height=1.5\baselineskip, valign=c]{\images/build.png}}]
    \en{Build Token, used to expand your \hyperlink{Town}{Town}.}
    \pl{}
  \item [{\includegraphics[height=1.5\baselineskip, valign=c]{\images/population.png}}]
    \en{Population Token, used to Recruit and Reinforce \hyperlink{Units}{Units} or to Recruit \hyperlink{Secondary}{a Secondary Hero}.}
    \pl{}
  \item [{\includegraphics[height=1.5\baselineskip, valign=c]{\images/spells.png}}]
    \en{
      Spell Book Token, used to purchase \hyperlink{spells}{Spells}.
      Requires the Mage Guild Town building to use.
    }
    \pl{}
\end{itemize}
...
\pl{}
\begin{itemize}
  \en{\item Draw a Card from your Deck.}
  \pl{\item}
  \en{\item Discard any number of Cards, then draw that many Cards.}
  \pl{\item}
  \en{\item Reroll any Die you have thrown.}
  \pl{\item}
\end{itemize}
\en{
...
\note{5}{
  \en{
    The Necropolis \includesvg[height=10px]{\svgs/necro-note.svg} Faction ignores any Morale effects.
