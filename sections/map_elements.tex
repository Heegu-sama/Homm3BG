...
% \vfill
\begin{center}
  \transparent{0.2}\includegraphics[width=0.4\linewidth]{\art/counterstrike.png}
\end{center}
\vfill
...
\subheader{\pagetarget{Categories}{Location Categories}}
...
\end{multicols*}
\subheader{\pagetarget{Discover Location Tokens}{Placing and Discovering Location Tokens}}
\begin{multicols}{2}
