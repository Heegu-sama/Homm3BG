...
\begin{expansion}[before=\vspace*{0pt}]{conflux}
  \subsection*{Monolith Tokens}
   The position of \pagelink{Monolith}{Monolith} Tokens is determined by the chosen Scenario Layout.
...
\begin{expansion}[before=\vspace*{0pt}]{cove}
  ...
  Discovering \pagelink{Whirlpool}{Whirlpool} Tokens follows the same rules as Monoliths.
  \bigskip
  \begin{center}
