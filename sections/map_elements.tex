...
\begin{center}
  \begin{tikzpicture}
    ...
    \draw (0, -0.3) node {\encircle{1}};
    \draw (-1.9, 0) node {\encircle{2}};
    \draw (2.3, 0) node {\encircle{2}};
    \draw (-1.4, 1.7) node {\encircle{2}};
    \draw (0.6, -1.9) node {\encircle{2}};
    \draw (0.5, 1.7) node {\encircle{2}};
    \draw (1.4, -2.2) node {\encircle{3}};
    \draw (1.4, 2.5) node {\encircle{4}};
    \draw (1.4, -1) node {\encircle{4}};
    \draw (-1, 0.5) node {\encircle{5}};
    \draw (-1.1, -1.1) node {\encircle{6}};
    \draw (-1.4, -1.7) node {\encircle{7}};
  \end{tikzpicture}
\end{center}
