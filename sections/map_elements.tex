...
\begin{expansion}[before=\vspace*{-11mm}]{stronghold}
  ...
  \pagelink{Subterranean Gate}{\textbf{Subterranean Gate Tokens}} are also determined by a scenario's Map Layout and they connect both a Surface Map Tile and an adjacent Subterranean Map Tile.
  ...
  The scenario map layout only shows which two two tiles are connected, not the exact fields that must be connected.
  \bigskip
  \begin{center}
...
\begin{expansion}{stronghold}
  ...
  Otherwise treat a Subterranean Gate Token as empty field.
