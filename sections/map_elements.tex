...
\begin{center}
    ...
    \begin{tikzpicture}
      ...
      \node at (0, 2.2) {\imagecaption{Surface Map Tile}};
      \node at (3.21, -1.07) {\includegraphics[width=0.5\linewidth]{\images/map-tile-sub.png}};
      \node at (3.21, -3.43) {\imagecaption{Subterranean Map Tile}};
      \node[rotate=-60] (gate) at (1.6, -0.56) {\includegraphics[width=0.33\linewidth]{\images/subter-gate-outline.png}};
      \node at (3.21, 1.11) {\imagecaption{Subterranean Gate}};
    \end{tikzpicture}
\end{center}
\end{multicols}
\clearpage
