...
\textit{The Combat lasted for only one Round, so Alice would not have been able to cast both Magic Arrow and the drawn Lightning Bold, since players are limited to playing only one Spell card per Combat Round.}\par
