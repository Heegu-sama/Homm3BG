...
\vspace*{\fill}
\begin{center}
  \transparent{0.2}\includegraphics[width=0.6\linewidth]{\art/earth_magic.png}
\end{center}
...
\begin{center}
  \textbf{\textit{\footnotesize\textcolor{darkcandyapplered}{Types of Map Tiles}}}
\end{center}
\begin{itemize}
  \footnotesize
...
\begin{center}
  \textbf{\textit{\footnotesize\textcolor{darkcandyapplered}{Map Tile Anatomy}}}
\end{center}
\begin{itemize}
  \footnotesize
  \begin{multicols}{2}
...
\begin{multicols}{2}
\pagelink{Location Token}{Location Tokens} are added by several expansions to the game.
