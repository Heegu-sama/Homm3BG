...
\vfill
\begin{center}
  \transparent{0.3}\includegraphics[width=0.6\linewidth]{\art/counterstrike.png}
\end{center}
\vfill
...
Heroes may spend 1 MP to either reveal an adjacent face-down Tile, or to place a Far (II–III) Map Tile from their own supply of Tiles (some scenarios provide such option).
...
\vfill
\hspace{2em}
{\transparent{0.3}\includegraphics[width=\linewidth]{\art/resurrection.png}}
\end{multicols*}
