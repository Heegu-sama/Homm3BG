...
The Combat lasted only one Round, so Alice could not have cast both Magic Arrow and the drawn Lightning Bolt, since players may play only one Spell card per Combat Round.
Sandro gains his second \svg{experience}, reaching Level II, so he performs Search~(2) on the Ability Deck before visiting the Field.}\par

\textit{Alice now flags the Mine by placing one of her Faction Cubes on it.
    Flagging this Mine increases her Building Materials \svg{building_materials} production by 2, and she immediately gains the Mine's production value of 2~\svg{building_materials} because she was the first player to flag it.}\par
\textit{Afterwards, Alice wants to go back to defend a previously flagged Settlement by casting the Town Portal still in her hand.
