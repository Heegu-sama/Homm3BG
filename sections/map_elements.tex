...
\begin{expansion}[before=\vspace*{0pt}]{conflux}
  \subsection*{Monolith Tokens}
   The position of Monolith Tokens is determined by the chosen Scenario Layout.
...
\begin{expansion}[before=\vspace*{0pt}]{cove}
  ...
  Discovering Whirlpool Tokens follows the same rules as Monoliths.
  \bigskip
  \begin{center}
...
\begin{expansion}[before=\vspace*{-11mm}]{stronghold}
  ...
  \pagetarget{Subterranean Gate}{Subterranean Gate Tokens} are also determined by a Scenario's Map Layout and connect both a Surface Map Tile and an adjacent Subterranean Map Tile.
