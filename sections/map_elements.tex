...
\vfill
\begin{center}
  \includegraphics[width=0.85\linewidth]{\images/fields.png}
\end{center}
\begin{itemize}
  \footnotesize
  \begin{multicols}{2}
    ...
    \item[\textbf{4.}] Blocked Field
    \item[\textbf{5.}] Border line
    \item[\textbf{6.}] Field Difficulty
  \end{multicols}
\end{itemize}
\end{multicols*}
...
\begin{figure*}[!hb]
  ...
  \begin{tikzpicture}[overlay]
    ...
    \node at (4, 1) {\footnotesize{\textbf{\textit{\textcolor{cadmiumgreen}{be adjacent to two other tiles}}}}};
  \end{tikzpicture}
\end{figure*}
