...
\begin{center}
  \vspace*{-3em}
  \begin{tikzpicture}
    \draw (0, 0) node[inner sep=0] {\makebox[\linewidth][c]{\includegraphics[width=1.1\linewidth]{\images/elemental_tiles.png}}};
    \draw (-2.3, 0.1) node {\imagecaption{Elemental Fire Tile}};
    \draw (2.3, 0.1) node {\imagecaption{Elemental Water Tile}};
    \draw (-2.3, -4.7) node {\imagecaption{Elemental Air Tile}};
    \draw (2.3, -4.7) node {\imagecaption{Elemental Earth Tile}};
  \end{tikzpicture}
\end{center}
