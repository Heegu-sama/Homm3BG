...
Alice's current hand consists of a Power card, a Lightning Bolt, Sorcery, and a Town Portal.
During the Combat, Alice plays Sorcery first hoping to draw an additional helpful card: She draws a Magic Arrow. Now she casts the Lightning Bolt, and Empowers \svg{empower} it with the already played Sorcery's effect and Magic Arrows's alternative (bottom) effect, which makes the Lightning Bolt deal 4 damage \svg{damage}, killing the Griffins and winning the Combat.}

\includegraphics[width=\linewidth]{\examples/sandro_empowering_lightning_bolt.png}

\columnbreak
\textit{The Combat lasted for only one Round, so Alice would not have been able to cast both Lightning Bolt and the drawn Magic Arrow, since players are limited to playing only one Spell card per Combat Round.}\par
