...
\begin{center}
  \begin{scriptsize}
  \begin{tikzpicture}
    \draw (0, 0) node[inner sep=0] {\makebox[\linewidth][c]{\includegraphics[width=\linewidth]{\images/fields.png}}};
    \draw (0, -0.3) node {\encircle{\phantom{.}1\phantom{.}}};
    \draw (-2.6, 0) node {\encircle{\phantom{.}2\phantom{.}}};
    \draw (3, 0) node {\encircle{\phantom{.}2\phantom{.}}};
    \draw (-2, 2.3) node {\encircle{\phantom{.}2\phantom{.}}};
    \draw (0.8, -2.3) node {\encircle{\phantom{.}2\phantom{.}}};
    \draw (0.8, 2.3) node {\encircle{\phantom{.}2\phantom{.}}};
    \draw (1.8, -3) node {\encircle{\phantom{.}3\phantom{.}}};
    \draw (1.8, 3.3) node {\encircle{\phantom{.}4\phantom{.}}};
    \draw (1.8, -1.3) node {\encircle{\phantom{.}4\phantom{.}}};
    \draw (-1.4, 0.8) node {\encircle{\phantom{.}5\phantom{.}}};
    \draw (-1.6, -1.4) node {\encircle{\phantom{.}6\phantom{.}}};
    \draw (-1.9, -2.3) node {\encircle{\phantom{.}7\phantom{.}}};
  \end{tikzpicture}
  \end{scriptsize}
\end{center}
\begin{itemize}
