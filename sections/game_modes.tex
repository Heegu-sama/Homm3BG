...
In addition to the scenario objectives, read the \pagelink{Scenario end}{general victory conditions} depending on the scenario type.\par 
...
A Cooperative mode where everyone shares the same goal. \pagelink{AIrules}{The AI-rules} and expanded \pagelink{Trading}{Trading-rules} apply here as well.
