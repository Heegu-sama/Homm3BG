...
\begin{expansion}{cove}
    \begin{multicols}{2}
        ...
        Then place the small Clone Token on the chosen unit and the bigger Token of the same color (blue or red) on the empty space.
...
\begin{multicols}{2}
    ...
    \begin{expansion}{cove,stretchgoals2}
        ...
        (TODO: why would anyone give -1 instead of -2? Or even let the enemy replace their existing -2 with new shiny -1?))
    \end{expansion}
