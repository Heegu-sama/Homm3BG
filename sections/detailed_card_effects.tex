...
\begin{expansion}{cove}
    \begin{multicols}{2}
        ...
        \begin{wrapfigure}{r}{0.3\linewidth}
            ...
            \centering\textbf{\textit{\scriptsize\color{darkcandyapplered}Clone \mbox{Tokens}\\}}
        \end{wrapfigure}
        When you cast the \textbf{Clone Spell}, choose an allied unit (depending on the \svg{empower} used) and an empty space on the Combat Board adjacent to that unit.
        ...
        \textit{%
            One of your units in Combat is a Few Griffins whose Initiative value is 6.
            You cast the Clone Spell on them and place the small Clone Token on the Griffins and the big one of the same color on an empty space next to them.
            Later, you decide to cast ``Haste'' with 0 \svg{empower} on the original Griffins unit to increase their Initiative by 1.
            Now, the original Griffins' Initiative Value is 7, but the cloned unit's Initiative remains 6.
        }
        \begin{tikzpicture}
          \draw (0, 0) node[rotate=180] {\includegraphics[width=\linewidth]{\images/combat_board_half.jpg}};
          ...
          \draw (-0.4, -1.7) node {\includegraphics[width=0.28\linewidth]{\cards/haste.png}};
        \end{tikzpicture}
    \end{multicols}
\end{expansion}
...
\begin{expansion}{stronghold}
    ...
    \begin{multicols*}{2}
        ...
        \textbf{\textit{\scriptsize\color{darkcandyapplered}Quicksand Token\\}}

        \columnbreak
        \includegraphics[width=0.5\linewidth]{\images/quicksand-token-2.png}\\
        \textbf{\textit{\scriptsize\color{darkcandyapplered}Empty Quicksand\\Token\\}}
    \end{multicols*}
\end{expansion}
...
\begin{expansion}{battlefield,conflux}
    ...
    \begin{multicols}{2}
        ...
        \textbf{\textit{\scriptsize\color{darkcandyapplered}Firewall Token\\ (Spell card)}}

        \columnbreak
        \includegraphics[width=0.7\linewidth]{\images/firewall-vi-token.png}\\
        \textbf{\textit{\scriptsize\color{darkcandyapplered}Firewall Token\\ (Specialty card)}}
    \end{multicols}
\end{expansion}
...
\begin{expansion}{stretchgoals2}
    ...
    \begin{multicols}{3}
        ...
        \textbf{\textit{\scriptsize\color{darkcandyapplered}Landmine Token\\ (Backside)}}

        \columnbreak
        \includegraphics[width=0.9\linewidth]{\images/land-mine-token-0.png}\\
        \textbf{\textit{\scriptsize\color{darkcandyapplered}Empty Landmine Token\\}}

        \columnbreak
        \includegraphics[width=0.9\linewidth]{\images/land-mine-token-2.png}\\
        \textbf{\textit{\scriptsize\color{darkcandyapplered}Landmine Token\\}}
    \end{multicols}
\end{expansion}
...
\begin{expansion}{stretchgoals2}
    ...
    \begin{wrapfigure}{r}{0.2\linewidth}
        ...
        \begin{center}
          \textbf{\textit{\scriptsize\color{darkcandyapplered}Force\\Field\\Token\\}}
        \end{center}
    \end{wrapfigure}
...
\begin{expansion}{conflux}
    ...
    \columnbreak
        ...
        \textbf{\textit{\scriptsize\color{darkcandyapplered}A Few Fire Elementals}}\par
        \smallskip
        \includegraphics[width=0.5\linewidth]{\images/summon-token-fire.png}\par
        \centering\textbf{\textit{\scriptsize\color{darkcandyapplered}Fire Elemental Token}}\par
        \smallskip
        \includegraphics[width=0.5\linewidth]{\images/summon-token-earth.png}\par
        \centering\textbf{\textit{\scriptsize\color{darkcandyapplered}Earth Elemental Token}}\par

        \columnbreak
        \includegraphics[width=0.9\linewidth]{\cards/unit-summoned-pack.png}\par
        \textbf{\textit{\scriptsize\color{darkcandyapplered}A Pack of Fire Elementals\\}}\par
        \smallskip
        \includegraphics[width=0.5\linewidth]{\images/summon-token-water.png}\par
        \centering\textbf{\textit{\scriptsize\color{darkcandyapplered}Water Elemental Token\\}}\par
        \smallskip
        \includegraphics[width=0.5\linewidth]{\images/summon-token-air.png}\par
        \centering\textbf{\textit{\scriptsize\color{darkcandyapplered}Air Elemental Token}}\par
        \end{multicols}
    \end{multicols}
\end{expansion}
\bigskip
...
\begin{multicols}{2}
    ...
    \begin{expansion}{cove}
        ...
        \begin{wrapfigure}{r}{0.2\linewidth}
            ...
            \centering\textbf{\textit{\scriptsize\color{darkcandyapplered}Weakness \mbox{Token}\\}}
        \end{wrapfigure}
    ...
    \begin{expansion}{stronghold}
        ...
        \begin{wrapfigure}{r}{0.2\linewidth}
            ...
            \centering\textbf{\textit{\scriptsize\color{darkcandyapplered}Attack \mbox{Token}\\}}
        \end{wrapfigure}
    ...
    \begin{expansion}{stronghold}
        ...
        \begin{wrapfigure}{r}{0.2\linewidth}
            ...
            \centering\textbf{\textit{\scriptsize\color{darkcandyapplered}Corrosion \mbox{Token}\\}}
        \end{wrapfigure}The \textbf{Behemoth unit} from the Stronghold Faction can use his \svg{unit_attack} ability to place a Corrosion Token on the defending units, which reduces their \svg{defense} by 1 to a minimum of ``0''.
