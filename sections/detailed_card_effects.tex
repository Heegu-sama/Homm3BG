...
\begin{multicols}{2}
  ...
  \vspace*{\fill}
  {\hfill\transparent{0.2}\includegraphics[width=0.8\linewidth]{\art/gremlin.png}\hfill}
  \vspace*{\fill}
\end{multicols}
...
\begin{multicols}{2}
    ...
    \end{expansion}
    \vspace*{\fill}
    {\hfill\transparent{0.2}\includegraphics[width=0.8\linewidth]{\art/vision.png}\hfill}
    \vspace*{\fill}
    \columnbreak
