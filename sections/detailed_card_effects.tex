...
\begin{multicols}{2}
    ...
    \begin{expansion}{stretchgoals2}
        ...
        \end{wrapfigure}
        There is a second, but slightly different copy of a \textbf{Manticore unit card} in the game.
        When you play the Dungeon Faction, you can choose one of these cards to play with in the current Scenario.
    \end{expansion}
\columnbreak
