...
\begin{expansion}{battlefield,conflux}
    ...
    \begin{multicols}{2}
        \centering
        \includegraphics[width=0.9\linewidth]{\images/firewall-bf-token.png}
...
\begin{expansion}{cove}
    ...
    \begin{wrapfigure}{r}{0.4\linewidth}
        \includegraphics[width=0.5\linewidth]{\images/clone-token.png}\vspace*{1em}
    ...
    %in official cove book is a example. is it necessary?. -- yeah, I think it is
\end{expansion}
\end{multicols}
...
\begin{expansion}{inferno}
	...
	The \textbf{Pit Lords Unit} from the Inferno Faction may Summon Demon Units\index{Summoning} during Combat.
