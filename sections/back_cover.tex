...
\hommtable{14}{
  ...
  \begin{tabularx}{\linewidth}{>{\hsize=0.23\hsize\linewidth=\hsize}X
    ...
    \darkcell{\color{white}Sells/gets} & \darkcell{...to purchase \svg{gold}} & \darkcell{...to purchase \svg{valuables}} & \darkcell{...to purchase \svg{building_materials}} \\
    \darkcell{I am selling \svg{gold} ...} & \lightcell{--} & \lightcell{6 \svg{gold} \svg[7]{arrow_right_gray} 1 \svg{valuables}} & \lightcell{2 \svg{gold} \svg[7]{arrow_right_gray} 1 \svg{building_materials}} \\
    \darkcell{I am selling \svg{valuables} ...} & \lightcell{1 \svg{valuables} \svg[7]{arrow_right_gray} 3 \svg{gold}} & \lightcell{--} & \lightcell{1 \svg{valuables} \svg[7]{arrow_right_gray} 2 \svg{building_materials}} \\
    \darkcell{I am selling \svg{building_materials} ...} & \lightcell{1 \svg{building_materials} \svg[7]{arrow_right_gray} 1 \svg{gold}} & \lightcell{3 \svg{building_materials} \svg[7]{arrow_right_gray} 1 \svg{valuables}} & \lightcell{--} \\
  \end{tabularx}
}
