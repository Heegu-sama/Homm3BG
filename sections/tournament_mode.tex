\addsection{Tournament Mode}{\images/homm-shield.png}
...
\textbf{Note:} The Tournament Mode is designed only with the Core Game in mind. Rules to include expansion content (e.~g. Sea Map Tiles) are not known.
...
\columnbreak
    ...
    \item \textbf{Optional rule}: You can decide to play a variant with \pagelink{Splitted Artifact and Spell Decks}{splitted Artifact and Spell Decks} to have a bit more control what you draw.
\end{itemize}
...
\vspace*{\fill}
\columnbreak
\subheader{Splitted Artifact and Spell Decks}
...
The order of rarity is Minor, then Major and finally Relic.
