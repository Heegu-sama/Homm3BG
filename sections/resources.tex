...
\begin{itemize}
  ...
  \item[{\includesvg[height=15px]{\svgs/2_building_materials.svg}}] — 2 × Building Materials
  \item[{\includesvg[height=15px]{\svgs/4_building_materials.svg}}] — 4 × Building Materials
  \item[{\includesvg[height=15px]{\svgs/1_valuables.svg}}] — 1\texttimes Valuables
  \item[{\includesvg[height=15px]{\svgs/2_valuables.svg}}] — 2 × Valuables
  \item[{\includesvg[height=15px]{\svgs/3_gold.svg}}] — 3 × Gold
  \item[{\includesvg[height=15px]{\svgs/6_gold.svg}}] — 6 × Gold
\end{itemize}
