...
You can gain Resources from the \pagelink{Mines}{Settlements and Mines} that you have \pagelink{Categories}{Flagged}, but also by playing Cards and rolling Resource Dice \includesvg[height=10px]{\svgs/resource_die.svg}.
...
Possible Resource Die\index{Resource Die} \includesvg[height=10px]{\svgs/resource_die.svg} results:
\medskip
\begin{itemize}
