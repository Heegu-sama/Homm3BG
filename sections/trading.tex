...
\begin{itemize}
  ...
  \item \textbf{remove one card} from your hand at the trading post to gain 1 \svg{gold},
...
\begin{itemize}
  ...
  \item In Cooperative Scenarios, Resources may be given to other players when Visiting a Trading Post. This works in addition to the regular effect of the Trading Post.
