...
\begin{multicols*}{2}
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \draw (1.5, 1.6) node {\encircle{2}};
      \draw (-0.4, 1.4) node {\encircle{3}};
...
\textbf{Neutral Units cannot be reinforced} because they are single-sided.
...
\begin{expansion}[title=\phantom{\textbf{\tiny{foo}}}, overlay={}]{}
  \begin{center}
    \includegraphics[width=0.6\linewidth]{\cards/neutral-back.png}\\
...
\begin{expansion}{navalbattles}
  \begin{center}
    \includegraphics[width=0.6\linewidth]{\cards/creature_bank_unit.png}\\
