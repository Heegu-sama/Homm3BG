...
\begin{expansion}[title=\phantom{\textbf{\tiny{foo}}}, overlay={}]{}
  \begin{center}
    \includegraphics[width=0.7\linewidth]{\cards/neutral-back.png}\\
...
\begin{expansion}{navalbattles}
  \begin{center}
    \includegraphics[width=0.7\linewidth]{\cards/creature_bank_unit.png}\\
...
\begin{expansion}{conflux}
  \begin{center}
    \includegraphics[width=0.7\linewidth]{\cards/unit-summoned-few.png}\\
