...
\hommtable{13}{
  \begin{tabularx}{\linewidth}{>{\hsize=0.181\hsize\linewidth=\hsize}X
    ...
    \darkcell[1.6]{\svg[12]{bronze} \\ Bronze units} &
...
\begin{center}
  \includegraphics[width=0.5\linewidth]{\cards/neutral-back.png}\\
  \imagecaption{Neutral Unit}
\end{center}

\bigskip
\begin{expansion}{navalbattles}
  \subsection*{Creature Bank Units}
  \begin{center}
    \includegraphics[width=0.5\linewidth]{\cards/creature_bank_unit.png}\\
  \end{center}
...
\begin{expansion}{conflux}
  \subsection*{Summoned Elemental Units}
  \begin{center}
    \includegraphics[width=0.5\linewidth]{\cards/unit-summoned-few.png}\\
  \end{center}
