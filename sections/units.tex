...
\includesvg[height=30px]{\svgs/health_points.svg}\textbf{\pagetarget{HP}{HP}} - The maximum amount of damage a Unit can sustain before it is defeated.
...
\includesvg[height=30px]{\svgs/initiative.svg}{\pagetarget{Initiative}{\textbf{Initiative}}} - Determines when the Unit Activates during Combat.
Units with a higher Initiative\index{Initiative} Activate first.
In case of a tie, the \pagelink{Combatterminology}{attacking} side's Unit should always Activate first.
...
\begin{itemize}[wide]
  ...
  \item In any other cases without one of the above icons, the Unit's ability is used according to its text.
    Units may also use \pagelink{Playerdecks}{these} symbols.
\end{itemize}
