...
\note{small}{Any effects which allow you to Reinforce outside of using the Population Token \textbf{do not} require a Citadel or any Dwellings.}\par
\bigskip

\begin{center}
  \shadowimage[width=0.6\linewidth]{\cards/necromancy.jpg}\\
  \footnotesize\textit{
...
%
% \hspace{3.5em}
% \includegraphics[width=0.85\linewidth]{\art/gremlin.png}
