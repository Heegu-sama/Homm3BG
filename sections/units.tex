...
\pl{
  \addsection{Jednostki}{\skills/leadership.png}
}
...
\note{13}{
  \en{Any effects which instruct you to Reinforce \textbf{do not} require spending your Population Token nor owning a Citadel or any Dwellings.\par}
  \pl{}

  \medskip

  \en{If all Units in your Unit Deck are defeated, \textbf{immediately} replace your Unit Deck with the starting Units\index{Starting Units} of the Scenario. Defeated Faction Units can always be Recruited again with another use of the Population Token.}
  \pl{}
}
...
\includegraphics[height=30px]{\images/attack.png}
\en{\textbf{Attack} – The amount of damage this Unit deals when it attacks.\par}
\includegraphics[height=30px]{\images/defense.png}
\en{
  \textbf{Defense} - The amount by which this Unit reduces oncoming Attack damage.
  Does not apply to damage received from Spells or other non-attack effects.\par
}
\includegraphics[height=30px]{\images/hp.png}
\en{
...
\pl{}
\includegraphics[height=30px]{\images/initiative.png}
\en{
  \textbf{\hypertarget{Initiative}{Initiative}} - Determines when the Unit Activates during Combat.
...
\en{Most Units have a \textbf{special ability}\index{Special Ability}:\par}
\pl{}
\begin{itemize}[wide]
  \en{\item\textbf{Activation} \includesvg[height=10px]{\svgs/activation.svg} resolves when the Unit is Activated.}
  \pl{\item}
  \en{
  ...
  \pl{\item}
  \en{\item\textbf{Passive} \includesvg[height=10px]{\svgs/unit_passive.svg} resolves whenever its condition is met.}
  \pl{\item}
  \en{\item\textbf{Retaliate} \includesvg[height=10px]{\svgs/unit_retaliate.svg} resolves when the Unit retaliates.}
  \pl{\item}
  \en{
...
\pl{
  \subsection*{\hypertarget{Rodzaje Jednostek}{Rodzaje Jednostek}}
}
\begin{itemize}
  \en{\item \textbf{Ground}\index{Ground Units} \includesvg[height=10px]{\svgs/unit_ground.svg} Units may move up to 3 spaces and then attack an adjacent enemy.}
  \pl{\item}
  \en{\item \textbf{Flying}\index{Flying Units} \includesvg[height=10px]{\svgs/unit_flying.svg} Units may move up to 3 spaces, \textbf{ignoring Combat Obstacles}, and then attack an adjacent enemy.}
  \pl{\item}
  \en{\item \textbf{Ranged}\index{Ranged Units} \includesvg[height=10px]{\svgs/unit_ranged.svg} Units may attack \textbf{any Unit anywhere} and then move up to 1 space OR move up to 1 space without attacking.}
  \pl{\item}
\end{itemize}
\en{
...
\pl{
  \subsection*{Jednostki Neutralne}
}
