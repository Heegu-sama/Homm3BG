...
\includegraphics[height=30px]{\images/hp.png} \textbf{\hypertarget{HP}{HP}} - The amount of damage required to defeat the Unit.
...
\vfill
\hfill\includegraphics[width=0.7\linewidth]{\art/cerberi.png}
