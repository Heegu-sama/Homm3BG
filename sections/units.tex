...
\note{5}{Any effects which allow you to Reinforce outside of using the Population Token \textbf{do not} require a Citadel or any Dwellings.}\par
\bigskip

\begin{center}
  \includegraphics[width=0.6\linewidth]{\cards/necromancy_card.png}\\
  \footnotesize\textit{
