...
\begin{figure}[H]
  ...
  \begin{subfigure}[c]{0.15\linewidth}
    \begin{expansionmini}{stronghold}
      ...
      \vspace{0.5em}
      \begin{tikzpicture}
        \node at (0, 0) {\includegraphics[width=0.65\linewidth]{\images/quicksand-token-2.png}};
        \node at (0.7, 0) {\includegraphics[width=0.65\linewidth]{\images/quicksand-token.png}};
      \end{tikzpicture}
  ...
  \begin{subfigure}[c]{0.15\linewidth}
    \begin{expansionmini}{stretchgoals2}
      ...
      \vspace{0.5em}
      \begin{tikzpicture}
        \node at (0.1, 0) {\includegraphics[width=0.65\linewidth]{\images/land-mine-token-0.png}};
        \node at (0.5, 0.5) {\includegraphics[width=0.65\linewidth]{\images/land-mine-token.png}};
        \node at (0.9, 0) {\includegraphics[width=0.65\linewidth]{\images/land-mine-token-2.png}};
      \end{tikzpicture}
  ...
  \begin{subfigure}[c]{0.15\linewidth}
    \begin{expansionmini}{stretchgoals2}
      \centering
      \vspace{0.5em}
      \includegraphics[width=0.65\linewidth]{\images/force-field-token.png}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[c]{0.2\linewidth}
    \begin{expansionmini}{conflux}
      \centering
      \vspace*{0.5em}
      \includegraphics[width=\linewidth]{\images/summon-tokens.png}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[c]{0.2\linewidth}
    ...
    \begin{expansionmini}{conflux}
      ...
      \caption{\textbf{\pagelink{Fire Wall Token}{Luna's Fire Wall Token for Battlefield}}}
    \end{expansionmini}
  \end{subfigure}
  ~
  ~
