...
\begin{figure}[H]
  ...
  \begin{subfigure}[t]{0.4\linewidth}
    ...
    \caption{\textbf{Battlefield Board} \\\color{darkcandyapplered}(Battlefield Expansion)}
  \end{subfigure}
\end{figure}
\vspace*{-1.5em}
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.16\linewidth}
    ...
    \caption{\textbf{Initiative Token} \color{darkcandyapplered}(Battlefield Expansion) \iftoggle{printable}{\phantom{Expansion}}{}}
  \end{subfigure}
  ~
  ...
  \begin{subfigure}[b]{0.25\linewidth}
    ...
    \caption{\textbf{\pagelink{Heroes}{Hero Card}}}
  \end{subfigure}
  ~
  \begin{subfigure}[b]{0.25\linewidth}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.18\linewidth}
    ...
    \caption{\textbf{\pagelink{Resources}{Gold Tokens}} \phantom{Popupulation} \phantom{Popupulation} \phantom{Popupulation}}
  \end{subfigure}
  \begin{subfigure}[b]{0.12\linewidth}
    \centering
    \includegraphics[width=0.6\linewidth]{\images/building-materials-token.png}
    \caption{\textbf{\pagelink{Resources}{Building Materials Token}} \phantom{Population}}
  \end{subfigure}
  \begin{subfigure}[b]{0.12\linewidth}
    \centering
    \includegraphics[width=0.6\linewidth]{\images/valuables-token.png}
    \caption{\textbf{\pagelink{Resources}{Valuables Token}} \phantom{Population} \phantom{Population}}
  \end{subfigure}
  \begin{subfigure}[b]{0.15\linewidth}
    \centering
    \includegraphics[width=0.8\linewidth]{\images/grail.png}
    \caption{\textbf{\pagelink{Grail}{Grail Token} \phantom{Population} \phantom{Population}}}
  \end{subfigure}
  \begin{subfigure}[b]{0.12\linewidth}
    \centering
    \includegraphics[width=5em]{\images/build.png}
    \caption{\textbf{\pagelink{Town Actions}{Build Token}} \phantom{Population} \phantom{Population}}
  \end{subfigure}
  \begin{subfigure}[b]{0.13\linewidth}
    \centering
    \includegraphics[width=5em]{\images/population.png}
    \caption{\textbf{\pagelink{Town Actions}{Population Token}} \phantom{Population} \phantom{Population}}
  \end{subfigure}
  \begin{subfigure}[b]{0.12\linewidth}
    \centering
    \includegraphics[width=5em]{\images/spells.png}
    \caption{\textbf{\pagelink{Town Actions}{Spell Book Token}} \phantom{Population}}
  \end{subfigure}
\end{figure}
\vspace*{-3.5em}
\begin{figure}[H]
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.27\linewidth}
    ...
    \end{tikzpicture}
    \caption{\textbf{Positive Morale Card} \color{darkcandyapplered}(Battlefield Expansion)}
  \end{subfigure}
  \begin{subfigure}[b]{0.27\linewidth}
    \begin{tikzpicture}
    ...
    \end{tikzpicture}
    \caption{\textbf{Negative Morale Card} \color{darkcandyapplered}(Battlefield Expansion)}
  \end{subfigure}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[t]{0.23\linewidth}
    ...
    \end{tikzpicture}
    \caption{\textbf{\pagelink{Events}{Event Card}}\\\color{darkcandyapplered}(Fortress Expansion)}
  \end{subfigure}
  ...
  \begin{subfigure}[t]{0.25\linewidth}
    ...
    \caption{\textbf{Adventure Card} \color{darkcandyapplered}(Battlefield Expansion)}
  \end{subfigure}
\end{figure}
\vspace*{-2em}
\begin{figure}[H]
...
\begin{figure}[H]
  ...
  \begin{subfigure}[t]{0.23\linewidth}
    ...
    \end{tikzpicture}
    \caption{\textbf{\pagelink{War Machines}{War Machine Card}} \color{darkcandyapplered}(Rampart Expansion)}
  \end{subfigure}
  \begin{subfigure}[t]{0.23\linewidth}
    \centering
    \begin{tikzpicture}
  ...
  \begin{subfigure}[t]{0.23\linewidth}
    ...
    \end{tikzpicture}
    \caption{\textbf{\pagelink{Empowered Statistic}{Empowered Statistic Card}} \color{darkcandyapplered}(Inferno Expansion)}
  \end{subfigure}
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{\iftoggle{printable}{0.8\linewidth}{\linewidth}}
    ...
    \caption{\textbf{Obstacles} \color{darkcandyapplered}(Battlefield Expansion)}
  \end{subfigure}
\end{figure}
\end{paracol}
