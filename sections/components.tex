...
\begin{figure}[H]
  ...
  \begin{subfigure}[c]{0.12\linewidth}
    \begin{expansionmini}{cove}
      ...
      \caption{\textbf{\pagelink{Whirlpool Tokens}{Whirlpool Token} \phantom{Population}}}
    \end{expansionmini}
  \end{subfigure}
  ~
  \begin{subfigure}[c]{0.12\linewidth}
    \begin{expansionmini}{conflux}
      ...
      \caption{\textbf{\pagelink{Monolith Tokens}{Monolith Token} \phantom{Population}}}
    \end{expansionmini}
  \end{subfigure}
  ~
  \begin{subfigure}[c]{0.14\linewidth}
    \begin{expansionmini}{stronghold}
      ...
      \vspace*{-1em}
      \caption{\textbf{\pagelink{Subterranean Gate Tokens}{Subterranean Gate}}}
    \end{expansionmini}
  \end{subfigure}
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[c]{0.15\linewidth}
    \begin{expansionmini}{navalbattles}
      ...
      \caption{\textbf{\pagelink{Stack Tokens}{Stack Token} \phantom{Population}}}
    \end{expansionmini}
  \end{subfigure}
  ~
  \begin{subfigure}[c]{0.15\linewidth}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[c]{0.9\linewidth}
    ...
    \end{tikzpicture}
    \caption{\textbf{\pagelink{Miniatures}{Unit Miniatures}}\\\textit{(Not included in the base game)}}
  \end{subfigure}
\end{figure}
