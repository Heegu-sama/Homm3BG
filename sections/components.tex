...
\begin{figure}[H]
  ...
  \begin{subfigure}[c]{0.17\linewidth}
    \begin{expansionmini}{navalbattles}
      ...
      \centering
      \begin{tikzpicture}
        \draw (1.0, 0) node {\includegraphics[width=0.55\linewidth]{\map_locations/creature_bank_back.png}};
        \draw (-0.3, 0) node {\includegraphics[width=0.55\linewidth]{\map_locations/creature_bank_token.png}};
      \end{tikzpicture}\\
  ...
  \begin{subfigure}[c]{0.22\linewidth}
    \begin{expansionmini}{stretchgoals2}
      ...
      \begin{tikzpicture}
        ...
        \node at (1, 0.1) {\includegraphics[width=0.6\linewidth]{\cards/town-card.png}};
      \end{tikzpicture}
  ...
  \begin{subfigure}[c]{0.23\linewidth}
    \begin{expansionmini}{stretchgoals2}
      ...
      \begin{tikzpicture}
        ...
        \node at (1, 0.1) {\includegraphics[width=0.6\linewidth]{\cards/pandora.png}};
      \end{tikzpicture}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[c]{0.18\linewidth}
    \begin{expansionmini}{navalbattles}
      \centering
      \vspace{0.5em}
      \includegraphics[width=0.45\linewidth]{\images/crown-token.png}
  ...
  \begin{subfigure}[c]{0.2\linewidth}
    \begin{expansionmini}{stretchgoals2}
      \centering
      \includegraphics[width=0.9\linewidth]{\images/expert_effect_markers.png}
      \caption{\textbf{\pagelink{Expert Effect Markers}{Expert Effect Markers}}}
    \end{expansionmini}
  \end{subfigure}
  ~
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[c]{0.23\linewidth}
    ...
    \begin{tikzpicture}
      ...
      \node at (1, 0.1) {\includegraphics[width=0.6\linewidth]{\cards/spell.png}};
    \end{tikzpicture}
  ...
  \begin{subfigure}[c]{0.23\linewidth}
    ...
    \begin{tikzpicture}
      \node at (0, 0) {\includegraphics[width=0.6\linewidth]{\cards/mmback.png}};
      \node at (1, 0.1) {\includegraphics[width=0.6\linewidth]{\cards/artifact-front.png}};
    \end{tikzpicture}
  ...
  \begin{subfigure}[c]{0.23\linewidth}
    ...
    \begin{tikzpicture}
      \node at (0, 0) {\includegraphics[width=0.6\linewidth]{\cards/mmback.png}};
      \node at (1, 0.1) {\includegraphics[width=0.6\linewidth]{\cards/ability-offense.png}};
    \end{tikzpicture}
  ...
  \begin{subfigure}[c]{0.23\linewidth}
    ...
    \begin{tikzpicture}
      \node at (0, 0) {\includegraphics[width=0.6\linewidth]{\cards/mmback.png}};
      \node at (1, 0.1) {\includegraphics[width=0.6\linewidth]{\cards/statistic.png}};
    \end{tikzpicture}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[c]{0.23\linewidth}
    ...
    \begin{tikzpicture}
      \node at (0, 0) {\includegraphics[width=0.6\linewidth]{\cards/mmback.png}};
      \node at (1, 0.1) {\includegraphics[width=0.6\linewidth]{\cards/specialty.png}};
    \end{tikzpicture}
  ...
  \begin{subfigure}[c]{0.22\linewidth}
    \begin{expansionmini}{stronghold}
      ...
      \begin{tikzpicture}
        \node at (0, 0) {\includegraphics[width=0.6\linewidth]{\cards/mmback.png}};
        \node at (1, 0.1) {\includegraphics[width=0.6\linewidth]{\cards/spell_scroll.png}};
      \end{tikzpicture}
  ...
  \begin{subfigure}[c]{0.23\linewidth}
    \begin{expansionmini}{navalbattles}
      ...
      \begin{tikzpicture}
        \node at (0, 0) {\includegraphics[width=0.6\linewidth]{\cards/mmback.png}};
        \node at (1, 0.1) {\includegraphics[width=0.6\linewidth]{\cards/ability-offense-empowered.png}};
      \end{tikzpicture}
  ...
  \begin{subfigure}[c]{0.23\linewidth}
    \begin{expansionmini}{inferno}
      ...
      \begin{tikzpicture}
        \node at (0, 0) {\includegraphics[width=0.6\linewidth]{\cards/mmback.png}};
        \node at (1, 0.1) {\includegraphics[width=0.6\linewidth]{\cards/empowered_statistic.png}};
      \end{tikzpicture}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[c]{0.23\linewidth}
    ...
    \begin{tikzpicture}
      ...
      \node at (1, 0.1) {\includegraphics[width=0.6\linewidth]{\cards/unit-few.png}};
    \end{tikzpicture}
  ...
  \begin{subfigure}[c]{0.23\linewidth}
    \begin{expansionmini}{conflux}
      \centering
      \begin{tikzpicture}
        \node at (0, 0) {\includegraphics[width=0.6\linewidth]{\cards/unit-air-elemental-pack.png}};
        \node at (1, 0.1) {\includegraphics[width=0.6\linewidth]{\cards/unit-air-elemental-few.png}};
      \end{tikzpicture}
  ...
  \begin{subfigure}[c]{0.23\linewidth}
    \begin{expansionmini}{navalbattles}
      ...
      \begin{tikzpicture}
        ...
        \node at (1, 0.1) {\includegraphics[width=0.6\linewidth]{\cards/creature-bank.png}};
      \end{tikzpicture}
  ...
  \begin{subfigure}[c]{0.23\linewidth}
    \begin{expansionmini}{rampart,cove}
      ...
      \begin{tikzpicture}
        \node at (0, 0) {\includegraphics[width=0.6\linewidth]{\cards/mmback.png}};
        \node at (1, 0.1) {\includegraphics[width=0.6\linewidth]{\cards/war_machine.png}};
      \end{tikzpicture}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[c]{0.23\linewidth}
    ...
    \begin{tikzpicture}
      ...
      \node at (1, 0.1) {\includegraphics[width=0.6\linewidth]{\cards/neutral-front.png}};
    \end{tikzpicture}
  ...
  \begin{subfigure}[c]{0.23\linewidth}
    ...
    \begin{tikzpicture}
      ...
      \node at (1, 0.1) {\includegraphics[width=0.6\linewidth]{\cards/arrow_tower.png}};
    \end{tikzpicture}
  ...
  \begin{subfigure}[c]{0.23\linewidth}
    ...
    \caption{\textbf{\pagelink{AI Deck}{AI card}}}
  \end{subfigure}
  \hfill
  ~
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[c]{0.17\linewidth}
    \centering
    \begin{tikzpicture}
      \node at (0, 0) {\includegraphics[width=3em]{\images/paralysis.png}};
      \node at (0.8, 0) {\includegraphics[width=3em]{\images/defense-token.png}};
    \end{tikzpicture}
    \caption{\textbf{\pagelink{Combatterminology}{Paralysis/ Defense Token}}}
  \end{subfigure}
  ...
  \begin{subfigure}[c]{0.28\linewidth}
    \begin{expansionmini}{navalbattles}
      ...
      \vspace{0.5em}
      \begin{tikzpicture}
        \node at (-0.2, 0) {\includegraphics[width=3em]{\images/stack-token.png}};
        \node at (0.75, 0) {\includegraphics[width=3em]{\images/stack-token-initiative.png}};
        \node at (1.5, 0)  {\includegraphics[width=3em]{\images/stack-token-hp.png}};
        \node at (2.25, 0) {\includegraphics[width=3em]{\images/stack-token-defense.png}};
        \node at (3, 0)    {\includegraphics[width=3em]{\images/stack-token-attack.png}};
      \end{tikzpicture}
      \caption{\textbf{\pagelink{Stack Tokens}{Stack Tokens}}}
    \end{expansionmini}
  \end{subfigure}
  ~
  \begin{subfigure}[c]{0.15\linewidth}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[c]{0.16\linewidth}
    \begin{expansionmini}{stronghold}
      ...
      \vspace{0.5em}
      \begin{tikzpicture}
        \node at (0, 0.8) {\includegraphics[width=4.6em]{\images/quicksand-token-2.png}};
        \node at (0.7, 0) {\includegraphics[width=4.6em]{\images/quicksand-token.png}};
      \end{tikzpicture}
      \caption{\textbf{\pagelink{Quicksand Token}{Quicksand Tokens}}}
    \end{expansionmini}
  \end{subfigure}
  ~
  \begin{subfigure}[c]{0.18\linewidth}
    \begin{expansionmini}{cove}
      \centering
      \vspace{0.5em}
      \includegraphics[width=\linewidth]{\images/clone-tokens.png}
  ...
  \begin{subfigure}[c]{0.19\linewidth}
    \begin{expansionmini}{stretchgoals2}
      ...
      \vspace{0.5em}
      \begin{tikzpicture}
        \node at (0.0, 0) {\includegraphics[width=4.6em]{\images/land-mine-token-0.png}};
        \node at (0.5, -0.8) {\includegraphics[width=4.6em]{\images/land-mine-token.png}};
        \node at (1.0, 0) {\includegraphics[width=4.6em]{\images/land-mine-token-2.png}};
      \end{tikzpicture}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[c]{0.2\linewidth}
    \begin{expansionmini}{conflux,cove,stronghold}
      \centering
      \vspace{0.5em}
      \includegraphics[width=3em]{\images/time-token.png}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[c]{0.2\linewidth}
    \centering
    \begin{tikzpicture}
      \node at (0, 0) {\includegraphics[width=0.5\linewidth]{\images/morale-negative.png}};
      \node at (1, 0) {\includegraphics[width=0.5\linewidth]{\images/morale-positive.png}};
    \end{tikzpicture}
    ...
    \begin{expansionmini}{conflux}
      ...
      \caption{\textbf{\pagelink{Fire Wall Token}{Luna's Fire Wall Token}}}
    \end{expansionmini}
  \end{subfigure}
  ~
  ~
  ...
  \begin{subfigure}[c]{0.12\linewidth}
    \begin{expansionmini}{battlefield}
      \centering
      \vspace{0.5em}
      \includegraphics[width=4.6em]{\images/initiative-bf.png}
