...
\begin{figure}[H]
  ...
  \begin{subfigure}[c]{0.9\linewidth}
    \centering
    \begin{tikzpicture}
      \node at (0.5, 1) {\includegraphics[scale=1.5]{\images/unitmini-dreadknight.png}};
      \node at (1.7, 0.5) {\includegraphics[scale=1.5]{\images/unitmini-lich.png}};
      \node at (3, -0.1) {\includegraphics[scale=1.5]{\images/unitmini-zealot.png}};
      \node at (4, 1) {\includegraphics[scale=1.5]{\images/unitmini-archangel.png}};
