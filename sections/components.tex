...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.1\linewidth}
    ...
    \caption{\textbf{\hyperlink{combatround}{Damage Token}}}
  \end{subfigure}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.27\linewidth}
    \begin{tikzpicture}
      ...
      \node at (1.5, 0.1) {\includegraphics[width=0.45\linewidth]{\cards/morale-positive.png}};
    \end{tikzpicture}
  ...
  \begin{subfigure}[b]{0.27\linewidth}
    \begin{tikzpicture}
      ...
      \node at (1.5, 0.1) {\includegraphics[width=0.45\linewidth]{\cards/morale-negative.png}};
    \end{tikzpicture}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[t]{0.23\linewidth}
    ...
    \end{tikzpicture}
    \caption{\textbf{\hyperlink{Events}{Event Card}}\\\textit{(Fortress Expansion)}}
  \end{subfigure}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[t]{0.23\linewidth}
    ...
    \end{tikzpicture}
    \caption{\textbf{\hyperlink{War Machines}{War Machine Card}} \textit{(Rampart Expansion)}}
  \end{subfigure}
  \begin{subfigure}[t]{0.23\linewidth}
    \centering
    \begin{tikzpicture}
  ...
  \begin{subfigure}[t]{0.23\linewidth}
    ...
    \end{tikzpicture}
    \caption{\textbf{\hyperlink{Empowered Statistic}{Empowered Statistic Card}} \textit{(Inferno Expansion)}}
  \end{subfigure}
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[t]{0.23\linewidth}
    ...
    \end{tikzpicture}
    \caption{\textbf{\hyperlink{Units}{Faction Unit Card}}}
  \end{subfigure}
  ~
  \begin{subfigure}[t]{0.23\linewidth}
    \centering
