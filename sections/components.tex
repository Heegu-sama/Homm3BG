  ...
  \begin{subfigure}[c]{0.28\linewidth}
    \begin{expansionmini}{navalbattles}
      ...
      \begin{tikzpicture}
        ...
        \node at (0.75, 0) {\includegraphics[width=3em]{\images/stack-token-ini.png}};
        \node at (1.5, 0)  {\includegraphics[width=3em]{\images/stack-token-hp.png}};
        \node at (2.25, 0) {\includegraphics[width=3em]{\images/stack-token-def.png}};
        \node at (3, 0)    {\includegraphics[width=3em]{\images/stack-token-atk.png}};
      \end{tikzpicture}
