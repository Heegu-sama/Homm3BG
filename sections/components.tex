...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.16\linewidth}
    ...
    \caption{\textbf{Initiative Token} (Battlefield Expansion) \iftoggle{printable}{\phantom{Expansion}}{}}
  \end{subfigure}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[t]{0.23\linewidth}
    ...
    \end{tikzpicture}
    \caption{\textbf{\pagelink{Events}{Event Card}}\\(Fortress Expansion)}
  \end{subfigure}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[t]{0.23\linewidth}
    ...
    \end{tikzpicture}
    \caption{\textbf{\pagelink{War Machines}{War Machine Card}} (Rampart Expansion)}
  \end{subfigure}
  \begin{subfigure}[t]{0.23\linewidth}
    \centering
    \begin{tikzpicture}
  ...
  \begin{subfigure}[t]{0.23\linewidth}
    ...
    \end{tikzpicture}
    \caption{\textbf{\pagelink{Empowered Statistic}{Empowered Statistic Card}} (Inferno Expansion)}
  \end{subfigure}
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[t]{0.23\linewidth}
    ...
    \end{tikzpicture}
    \caption{\textbf{Faction \pagelink{Units}{Unit Card}}}
  \end{subfigure}
  ~
  \begin{subfigure}[t]{0.23\linewidth}
    \centering
