...
\begin{figure}[H]
  ...
  \begin{subfigure}[c]{0.16\linewidth}
    \begin{expansionmini}{stronghold}
      ...
      \vspace{0.5em}
      \begin{tikzpicture}
        \node at (0, 0) {\includegraphics[width=4.6em]{\images/quicksand-token-2.png}};
  ...
  \begin{subfigure}[c]{0.17\linewidth}
    \begin{expansionmini}{stretchgoals2}
      ...
      \begin{tikzpicture}
        ...
        \node at (0.4, 0.5) {\includegraphics[width=4.6em]{\images/land-mine-token.png}};
        \node at (0.8, 0) {\includegraphics[width=4.6em]{\images/land-mine-token-2.png}};
      \end{tikzpicture}
