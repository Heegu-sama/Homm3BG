...
\begin{figure}[H]
  ...
  \begin{subfigure}[c]{0.9\linewidth}
    \centering
    \begin{tikzpicture}
      \node at (-3, 1.2) {\includegraphics[scale=1]{\images/unitmini-magicelemental.png}};
      \node at (-1.3, 1.2) {\includegraphics[scale=1.5]{\images/unitmini-dreadknight.png}};
      \node at (-2.9, 0.2) {\includegraphics[scale=0.75]{\images/unitmini-seadog.png}};
      \node at (-1.5, 0) {\includegraphics[scale=1.5]{\images/unitmini-dwarf.png}};
      \node at (2, 1) {\includegraphics[scale=0.75]{\images/unitmini-archdevil.png}};
      \node at (-0.1, 0.8) {\includegraphics[scale=1.5]{\images/unitmini-lich.png}};
      ...
      \node at (5.9, 1.4) {\includegraphics[scale=1.5]{\images/unitmini-lizardman.png}};
      \node at (6.8, 1) {\includegraphics[scale=1.5]{\images/unitmini-troglodyte.png}};
