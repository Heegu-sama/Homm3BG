...
\begin{figure}[H]
  ...
  \begin{subfigure}[c]{0.9\linewidth}
    ...
    \begin{tikzpicture}
      ...
      \node[opacity=0.75] at (-2.2, 1) {\includegraphics[scale=1.2]{\images/unitmini-troglodyte.png}};
      % foreground
      \node at (-3.5, 0) {\includegraphics[scale=0.9]{\images/unitmini-magicelemental.png}};
      \node at (-1.6, -0.4) {\includegraphics[scale=0.9]{\images/unitmini-seadog.png}};
      \node at (2, -0.1) {\includegraphics[scale=0.9]{\images/unitmini-archdevil.png}};
      \node at (0, 0) {\includegraphics[scale=1]{\images/unitmini-cyclops.png}};
