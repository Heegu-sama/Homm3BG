...
\begin{figure}[H]
  ...
  \begin{subfigure}[c]{0.23\linewidth}
    \begin{expansionmini}{conflux}
      \centering
      \begin{tikzpicture}
        \node at (0, 0) {\includegraphics[width=0.6\linewidth]{\cards/unit-earth-elemental-pack.png}};
        \node at (1, 0.1) {\includegraphics[width=0.6\linewidth]{\cards/unit-earth-elemental-few.png}};
      \end{tikzpicture}
