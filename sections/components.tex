...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.4\linewidth}
    \begin{expansionmini}{battlefield}
      \begin{tikzpicture}
        \node at (0, 0) {\includegraphics[width=\linewidth]{\images/battlefield-alone.png}};
      \end{tikzpicture}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.16\linewidth}
    ...
    \begin{expansionmini}{battlefield}
      \begin{tikzpicture}
        \node at (0, 0) {\includegraphics[width=0.6\linewidth]{\images/initiative-bf.png}};
      \end{tikzpicture}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.25\linewidth}
    ...
    \begin{expansionmini}{battlefield}
      \begin{tikzpicture}
        \node at (0, 0) {\includegraphics[width=\linewidth]{\cards/adventure.png}};
      \end{tikzpicture}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.23\linewidth}
    ...
    \end{tikzpicture}
    \caption{\textbf{\pagelink{Statistic}{Statistic Card}\\\phantom{blah}}}
  \end{subfigure}
  \hspace*{1em}
  \begin{subfigure}[b]{0.23\linewidth}
    \centering
