...
\begin{figure}[H]
  ...
  \begin{subfigure}[c]{0.9\linewidth}
    \centering
    \begin{tikzpicture}
      \node at (-3, 1.2) {\includegraphics[scale=0.75]{\images/unitmini-magicelemental.png}};
      \node at (-1.3, 1.2) {\includegraphics[scale=1.5]{\images/unitmini-dreadknight.png}};
      \node at (-1.5, 0) {\includegraphics[scale=0.75]{\images/unitmini-seadog.png}};
      \node at (-2.7, 0.4) {\includegraphics[scale=1.5]{\images/unitmini-dwarf.png}};
