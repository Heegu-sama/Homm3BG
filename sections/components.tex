...
\begin{figure}[H]
  ...
  \begin{subfigure}[c]{0.15\linewidth}
    \begin{expansionmini}{conflux}
      \centering
      \begin{tikzpicture}
        \node at (0, 0.7) {\includegraphics[width=0.5\linewidth]{\images/summon-token-earth.png}};
        \node at (0.7, 0.7) {\includegraphics[width=0.5\linewidth]{\images/summon-token-fire.png}};
        \node at (0, 0) {\includegraphics[width=0.5\linewidth]{\images/summon-token-water.png}};
        \node at (0.7, 0) {\includegraphics[width=0.5\linewidth]{\images/summon-token-air.png}};
      \end{tikzpicture}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[c]{0.22\linewidth}
    \begin{expansionmini}{stronghold}
      \centering
      \includegraphics[width=0.7\linewidth]{\cards/spell-scroll.png}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[c]{0.23\linewidth}
    \begin{expansionmini}{navalbattles}
      ...
      \begin{tikzpicture}
        \node at (0, 0) {\includegraphics[width=0.6\linewidth]{\cards/mmback.png}};
        \node at (1.5, 0.1) {\includegraphics[width=0.6\linewidth]{\cards/empowered-ability.png}};
      \end{tikzpicture}
