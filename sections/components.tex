...
\begin{figure}[H]
  ...
  \begin{subfigure}[c]{0.15\linewidth}
    \begin{expansionmini}{cove}
      \centering
      \vspace{0.5em}
      \includegraphics[width=0.5\linewidth]{\images/clone-token.png}
  ...
  \begin{subfigure}[c]{0.15\linewidth}
    \begin{expansionmini}{stretchgoals2}
      \centering
      \vspace{0.5em}
      \includegraphics[width=0.5\linewidth]{\images/land-mine-token.png}
  ...
  \begin{subfigure}[c]{0.15\linewidth}
    \begin{expansionmini}{conflux}
      \centering
      \vspace{0.5em}
      \includegraphics[width=0.5\linewidth]{\images/summon-token.png}
