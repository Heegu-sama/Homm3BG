...
Accessing the second and third effects requires the spell to be \textbf{empowered} before it is played.
The amount a spell needs to be empowered for each effect is indicated within a circle in the middle of its card text.\par
You may empower a spell by playing any card for its empower \includesvg[height=10px]{\svgs/empower.svg} effect.
The bottom, alternative effect of all spell cards is to empower another spell.\par
