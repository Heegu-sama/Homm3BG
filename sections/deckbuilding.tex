...
\begin{tikzpicture}[remember picture, overlay]
  \node[rotate=-28, opacity=0.15] at ([xshift=0em, yshift=-6em]current page.center) {\includegraphics[width=0.45\linewidth]{\art/frost_ring.png}};
\end{tikzpicture}
\begin{multicols*}{2}
  ...
  \begin{tikzpicture}
    \begin{scope}[scale=1.5, transform shape]
      ...
      \begin{scope}[cm={cos(45),-0.5*sin(45),sin(45),0.5*cos(45),(1.5,-1.4)}, transform shape]
        \draw(0, 0) node {\includegraphics[width=0.17\linewidth]{\cards/spell-curse.png}};
        \filldraw[fill=black, draw=black, opacity=0.5] (-0.6, -0.9) rectangle(0.6, 0.9);
      \end{scope}
      \draw(-1, 0.5) node[rotate=15] {\includegraphics[width=0.3\linewidth]{\cards/spell-magicarrow.png}};
      \begin{scope}[rotate=-15, transform shape]
        \draw(0, 0) node {\includegraphics[width=0.48\linewidth]{\examples/glow.png}};
        \draw(0, 0) node {\includegraphics[width=0.3\linewidth]{\cards/spell-fireball.png}};
      \end{scope}
    \end{scope}
  \end{tikzpicture}
\end{center}
