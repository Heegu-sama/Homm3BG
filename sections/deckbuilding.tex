...

{
  ...
  \medskip
  \footnotesize
  \textbf{\textit{\textcolor{darkcandyapplered}{Spell Card}}}
...
\begin{center}
  % for translators: if there's not enough space here, swap this with air magic art below
...
\clearpage
\includegraphics[width=\linewidth]{\art/azure_dragon.jpg}
\columnbreak
...
\hfill\includegraphics[width=0.8\linewidth]{\art/air_magic.png}
