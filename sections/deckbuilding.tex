...
You may pay this cost by playing other cards for their Empower \includesvg[height=10px]{\svgs/empower.svg} effect (e.g. the Spell Power Statistic) before casting the Spell.
All Spell Cards also have an alternative bottom (5) \includesvg[height=10px]{\svgs/empower.svg} effect.
You cannot preserve the played \includesvg[height=10px]{\svgs/empower.svg}: casting a Spell consumes all \includesvg[height=10px]{\svgs/empower.svg} played so far, and if you stop playing cards in sequence, the power dissipates.\par
