...
Using the topmost, basic version usually has no additional cost, but by paying the indicated cost (3) you can use a stronger effect (4).
...
Each Spell card also has an alternative +1 \svg{empower} effect (5).\par
