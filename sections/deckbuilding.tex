...
Each Spell card also has an alternative +1 \svg{empower} effect \encircleinline{5}.\par

See examples of Empowering on \hyperlink{example flagging mine}{page \pageref{example flagging mine}}.

\begin{expansion}{conflux}
  \textbf{Note:} \pagelink{Elemental Map Tiles}{Elemental Map Tiles} also increase Spells' \svg{empower}.
\end{expansion}
...
\vspace*{-0.5em}
\note{6.5}{
  Playing the cards together means that you can resolve the effects in any order, and even change midway which Spell you're casting, if e.g. you drew a better Spell using \wikilink{abilities/sorcery}{Sorcery.}
}
...
\begin{center}
  \vspace*{\fill}
  {\transparent{0.2}\includegraphics[width=0.8\linewidth]{\art/air_magic.png}}
  \vspace*{\fill}
\end{center}
