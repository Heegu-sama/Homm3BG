...
\begin{expansion}*{navalbattles}
\pagetarget{Empowered Ability Token}{\subheader{Empowered Abilities}}\index{Empowered Ability}
\begin{multicols*}{2}
  ...
  \end{wrapfigure}
  These cards improve your Hero's Ability cards.
  You can gain them by spending \textbf{Empowered Ability Tokens}.
