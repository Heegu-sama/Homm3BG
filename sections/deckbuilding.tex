...
\subheader{\pagetarget{Statistic}{Statistic} and \pagetarget{Ability}{Ability} Cards}
\begin{multicols}{2}
...
\vspace*{-5em}
\begin{tikzpicture}
  \node[rotate=-28, opacity=0.15] at (0, 0) {\includegraphics[width=0.7\linewidth]{\art/frost_ring.png}};
\end{tikzpicture}
\end{multicols}

\clearpage
\begin{multicols*}{2}
\subheader{\pagetarget{spells}{Spell Cards}}
...
\pagebreak
\subheader{\pagetarget{Specialty}{Hero Specialty Cards}}
...
\columnbreak
\subheader{\pagetarget{Artifact}{Artifact} Cards}
...
\subheader{\pagetarget{Spell Scroll Cards}{Spell Scroll Cards}}
...
\begin{expansion}{rampart,cove}
  \subheader{\pagetarget{War Machines}{War Machines}}
