...
You may pay this cost by playing other cards for their Empower \svg{empower} effect (e.g. the Statistic card \wikilink{statistics/power}{Spell Power}) before casting the Spell.
...
\begin{itemize}
    ...
    \item You may only use the Spell's lowest Power \svg{empower} effect, but even if it is 1\svg{empower} (e.g. \wikilink{spells/implosion}{Implosion}).
