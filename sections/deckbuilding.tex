\addsection{Deckbuilding}{\images/wisdom.png}
...
Every ability and statistic card has a basic effect and a stronger expert \includesvg[height=10px]{\svgs/expert.svg} effect, which is shown below the basic effect.
Whenever a player plays an ability or statistic card, they must choose which effect they are using.
The number of \includesvg[height=10px]{\svgs/expert.svg} effects a player can use each round is limited by their main hero’s \hyperlink{Level}{level}.
...
\begin{wrapfigure}{R}{0.50\textwidth}
    \begin{center}
    \shadowimage[width=0.28\textwidth]{\images/spell_example.jpg}
...
\begin{figure}[h]
\centering
\shadowimage[width=0.25\linewidth]{\images/specialty_card.jpg}
\end{figure}
\begin{center}
