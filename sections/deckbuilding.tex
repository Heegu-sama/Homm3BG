...
\begin{wrapfigure}{R}{0.5\textwidth}
  ...
  \centering
  \shadowimage[width=0.5\linewidth]{\images/spell_example.png}
    \begin{itemize}
      \item[ \textbf{1}] - Spell name.
      \item[\textbf{2}] - School of magic.
      \item[\textbf{3}] - Empower cost.
      \item[\textbf{4}] - Primary effects.
...
You may pay this cost by playing any amount of cards for their empower \includesvg[height=10px]{\svgs/empower.svg} effect.
