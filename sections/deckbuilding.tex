...
\begin{expansion}[before=\vspace*{-2em}]{inferno}
  ...
  The Empowered Statistic Cards work very similarly to Empowered Ability Cards.
  Their only effect corresponds to the Expert effect of normal Statistic Cards, but without requiring you to use your \svg{expert}.
  \medskip
