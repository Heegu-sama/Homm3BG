...
All the \svg{empower} played this way is consumed, though you may use a cheaper effect than the \svg{empower} you paid for.
...
\note{8.5}{
  Playing the cards together means you can resolve their effects in any order.
  Until you do, you may reassign which card is the Spell and which are played for \svg{empower-yellow}.
  \textit{Example: You play a Spell and add \svg{empower-yellow} with \wikilink{abilities/sorcery}{Sorcery.} Sorcery draws you a better Spell, so you cast that one instead.}
}

During Combat, each player may play \textbf{only one Spell card per Combat Round} for its primary effect, though some effects such as \svg{expert} \wikilink{statistics/knowledge}{Knowledge} can increase this number.
...
Spells can be \pagelink{Trading}{traded} in Alliance and Cooperative Scenarios.
