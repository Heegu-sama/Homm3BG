...
\begin{itemize}
    ...
    % TODO: What, if the lowest Power is 1? Can it be still played or not?
...
\begin{expansion}{stronghold}
    ...
    %TODO: Is it a new option at a Trading Post or can i combine it with other actions in a single visit?
