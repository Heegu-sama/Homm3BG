...
\begin{expansion}[before=\vspace*{-11mm}]{navalbattles}
    ...
    \medskip
    These Cards can be gained by spending an \pagelink{Empowered Ability Token}{Empowered Ability Token}, which is available only in certain Scenarios. Other ways to gain them are not know.
\end{expansion}
...
\begin{expansion}{inferno}
    ...
    The Empowered Statistic Cards work very similar to Empowered Ability Cards.

    Their only effect corresponds to the Expert effect of normal Statistic Cards, but without requiring to use your \svg{expert}.
...
\vspace*{1em}
When you gain a Spell Scroll place it near your Hero Card, take the 2 top Cards from the Spell Deck and place them face down on the Spell Scroll.
You can look at these Spells at any time and they don't count for your Hand Limit.
