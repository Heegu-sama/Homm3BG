...
You pay by playing other cards for their \textbf{Empower}\index{Empowering Spells} \svg{empower} effect (e.g. the \wikilink{statistics/power}{Power} Statistic card) together with the Spell. Playing the cards together means you can resolve their effects in any order, even resolve Empower effects before casting the Spell.
