...
\begin{enumerate}
  ...
  \begin{itemize}
    ...
    \item \textbf{Ongoing} \svg{ongoing} Effects\index{Ongoing Effects} last until they are used up or until the player who played them starts their next Turn (whichever happens first). You can use Time Tokens to track the duration of ongoing effects.
    \item \textbf{Permanent} \svg{permanent} Cards\index{Permanent Cards} stay in play until discarded or replaced. When a permanent card is in play, you can still use its effects, either Basic or Expert, not both. If you use the Expert effect, don't add it to the Basic effect. 
...
\vfill
\hfill{\transparent{0.2}\includegraphics[width=0.7\linewidth]{\art/coin.png}}
...
\vspace*{\fill}
{\transparent{0.2}{\includegraphics[width=1.2\linewidth]{\art/thunder_helmet.png}}}
...
\vspace*{\fill}
{\transparent{0.15}{\hspace{-4em}\includegraphics[width=2.3\linewidth]{\art/minotaur.png}}}
% \vspace*{\fill}
