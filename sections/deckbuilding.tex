...
\begin{paracol}{2}
  ...
  \begin{expansion}{inferno}
    ...
    \begin{minipage}[t]{0.65\linewidth}
      \vspace*{0mm}
      \subsection*{\pagetarget{Empowered Statistic}{Empowered} Statistic cards}\index{Empowered Statistic}
...
\begin{paracol}{2}
  ...
  \begin{expansion}{navalbattles}
    ...
    \hfill
    \begin{minipage}[t]{0.65\linewidth}
      \subsection*{\pagetarget{Empowered Ability}{Empowered} Ability cards}\index{Empowered Ability}
...
\pagetarget{Spell Scroll Cards}{\subheader{Spell Scroll Cards}}\index{Spell Scroll}
