...
\begin{enumerate}
  ...
  \item After a Card is used, discard it.
    Each player has their own separate Discard Pile\index{Discard Pile} for their own Deck.
...
\subsection*{\pagetarget{Ability}{Ability and Statistic Cards}}

All Ability and Statistic cards\index{Statistic Cards} have a Basic Effect\index{Basic Effect} and a stronger Expert \includesvg[height=10px]{\svgs/expert.svg} Effect\index{Expert Effect}, which is shown below the Basic Effect.
...
\note{10}{
  ...
  When a non-Necropolis player draws Necropolis Card\index{Necropolis Card} from the Ability Deck, they may either discard it and draw a new Card as a replacement or gain it as normal.
...
Artifact Cards\index{Artifact Card} are divided into 3 Levels: Minor, Major, and Relic.
...
\note{5}{During Combat, \textbf{only one Spell Card} may be played by each player \textbf{per Combat Round}.}\par
Spells can be gained by Building the Mage Guild\index{Mage Guild}.
Building it also enables you to use the Spell Book Token\index{Spell Book Token} to buy additional Spells.
...
\note{7}{When you use an effect which lets you cast a Spell from somewhere other than your hand (such as directly from the Spell Deck), place that Spell into your Discard Pile after casting it.
}
