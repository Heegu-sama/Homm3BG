...
You cannot preserve the played \includesvg[height=10px]{\svgs/empower.svg}: casting a Spell consumes all the \includesvg[height=10px]{\svgs/empower.svg} played so far, and if you stop playing cards in sequence, the power dissipates.\par
