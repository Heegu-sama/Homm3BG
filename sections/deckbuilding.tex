...
\begin{multicols}{4}
  ...
  \begin{center}
    \begin{scriptsize}
    \begin{tikzpicture}
      \draw (0, 0) node {\includegraphics[width=\linewidth]{\cards/empowered-ability.png}};
  ...
  \begin{center}
    \begin{scriptsize}
    \begin{tikzpicture}
      \draw (0, 0) node {\includegraphics[width=\linewidth]{\cards/empowered-knowledge.png}};
      \draw (0.75, 1.9) node {\encircle{1}};
      \draw (-1, -1.5) node {\encircle{2}};
    \end{tikzpicture}
    \end{scriptsize}
...
\begin{tikzpicture}[remember picture, overlay]
  \node[rotate=-28, opacity=0.15] at ([xshift=0em, yshift=-8em]current page.center) {\includegraphics[width=0.5\linewidth]{\art/frost_ring.png}};
\end{tikzpicture}
\begin{multicols*}{2}
