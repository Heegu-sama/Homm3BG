...
\note{10}{
  Certain cards are limited to the Necropolis Faction \includesvg[height=10px]{\svgs/necro.svg}.
...
\note{4}{During Combat, \textbf{only one Spell Card} may be played by each player \textbf{per Combat Round}.}\par
...
\includegraphics[width=1.1\linewidth]{\examples/fireball_over_magic_arrow.png}\par
