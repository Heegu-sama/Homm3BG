...
\note{8.5}{
  Playing the cards together means you resolve their effects as a single action.
  Until then, you may reassign which card is the Spell and which are played for \svg{empower-yellow}.
  \textit{Example: Cast a Spell, add \svg{empower-yellow} with \wikilink{abilities/sorcery}{Sorcery,} draw a better Spell, then cast that one instead.}
}
