...
This deck is called your \textbf{Deck of Might \& Magic}\index{Deck of Might \& Magic}. From this point in this rule book this is \textbf{shorthanded} to \textbf{Your Deck}.
...
\begin{enumerate}
  ...
  \item The Ability, Artifact, and Spell Decks each have their own Discard Piles, created during the setup, which help players identify these Decks.
    ...
    Also, whenever one of these Discard Piles i\index{Deck of Might \& Magic}s empty, \textbf{refill it} with that deck's top Card.
...
\textit{He spends the token and pays 5 \includesvg[height=10px]{\svgs/gold.svg} cost indicated on his Town Board, allowing him to \textbf{Search (2)} the Spell Deck.}\par
