...
\subsection*{Overview}
    ...
    \smallskip
    In \textbf{Skirmish Mode} the players simply get pre-constructed Decks and armies, on whose composition they have only a little influence.
    With their Decks the players jump directly into Combat.\par
    \smallskip
    In \textbf{Adventure Mode}, a card-driven Adventure Phase is played before the final Combat, which replaces and simulates the discovery of the Map from regular games.
    ...
    \smallskip
\begin{center}
    {\transparent{0.4}{\includegraphics[width=\linewidth]{\art/cannon.png}}}
\end{center}\par
...
\end{expansion}
\begin{center}
    \includegraphics[width=\linewidth]{\images/battlefield_setup.png}
\end{center}
...
\begin{expansion}{battlefield}
    ...
    The Adventure Mode is divided into two Phases: The \textbf{Adventure Phase} and the \textbf{Final Combat}. The latter works identically as in the Skirmish Mode.\par
