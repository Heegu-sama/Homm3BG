...
\begin{expansion}{battlefield}
    \begin{multicols}{2}
        ...
        Instead of randomly draw \textbf{one} Postive Morale card you \textbf{Search(2)} the Positive Morale Deck instead. All other rules of Morale cards remain unchanged.\par
    \end{multicols}
\end{expansion}
\vspace{\fill}
