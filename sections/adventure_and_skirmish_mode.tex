...
\begin{expansion}{battlefield}
  ...
  \begin{multicols}{2}
    ...
    \begin{enumerate}
      ...
      \item Prepare the Positive and Negative \pagelink{Morale Cards}{Morale cards} (including all cards with the battlefield symbol).
...
\begin{expansion}{battlefield}
    \begin{multicols}{2}
        ...
        Instead of randomly draw \textbf{one} Postive Morale card you \textbf{Search(2)} the Positive Morale Deck instead, the unwanted card goes to the bottom of the Deck. All other rules of Morale cards remain unchanged.\par
    \end{multicols}
\end{expansion}
\vspace{\fill}
...
\begin{expansion}{battlefield}
  ...
  \begin{enumerate}
    \item \textbf{Declare one of the tree available Combat Power Levels:}\index{Combat Power}
