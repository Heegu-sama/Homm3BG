...
\pagetarget{Adventure and Skirmish Modes}{\addsection[2]{Adventure and \break{}Skirmish Modes}{\spells/frenzy.png}}
...
\begin{expansion}{battlefield}
  ...
  \begin{multicols}{2}
    ...
    \begin{enumerate}
      ...
      \begin{itemize}
        \item[a)] Hero Board
        \item[b)] 3 Hero's Specialty cards and its starting Ability card
        \item[c)] 7 unit cards and their corresponding 7 unit miniatures
      ...
      \item Build your starting Deck as normal (\pagelinkwithcomma{Setup Starting Deck}{steps 11--13 of Setup}).
     \end{enumerate}

     \subsection*{Additional Steps for Adventure Mode}
     \begin{enumerate}[resume]
      \item Put also Resource Tokens and Treasure Dice ready.
      \item Each player takes the Town Board with following starting requirements:
      \begin{itemize}
        \item[a)] Income tracks at 10 \svg{gold}, 0 \svg{building_materials} and 0 \svg{valuablegreater}.
        \item[b)] Starting resources: 15 \svg{gold}, 3 \svg{building_materials} and 1 \svg{valuablegreater}.
        \item[c)] Start without Town Buildings and without units in your Unit Deck
...
\begin{center}
  ...
  \begin{tikzpicture}
    ...
    \draw (-4, 0) node {\encircle{\phantom{.}1\phantom{.}}};
    \draw (-5, -1.5) node {\encircle{2a}};
    \draw (3.8, 2.9) node {\encircle{2a}};
    \draw (-5.5, 1.2) node {\encircle{2c}};
    \draw (2, 0.2) node {\encircle{2c}};
    \draw (5.5, 1.2) node {\encircle{2c}};
    \draw (5.3, -2) node {\encircle{\phantom{.}3\phantom{.}}};
    \draw (2.9, -1.6) node {\encircle{\phantom{.}4\phantom{.}}};
    \draw (-2, 2.8) node {\encircle{\phantom{.}5\phantom{.}}};
    \draw (2.8, -2.5) node {\encircle{\phantom{.}6\phantom{.}}};
    \draw (0, -2.5) node {\encircle{\phantom{.}7\phantom{.}}};
    \draw (0, 3.4) node {\encircle{\phantom{.}7\phantom{.}}};
    \draw (3.5, -3) node {\encirclered{\phantom{.}8\phantom{.}}};
    \draw (-3.8, 3) node {\encirclered{\phantom{.}8\phantom{.}}};
    \draw (-2, -2) node {\encirclered{9a}};
    \draw (2, 3) node {\encirclered{9a}};
    \draw (-6, -1.7) node {\encirclered{9b}};
    \draw (5, 3) node {\encirclered{9b}};
    \draw (1, -1.6) node {\encirclered{10}};
    \draw (-1.9, 3.5) node {\encirclered{11}};
  \end{tikzpicture}
  \end{scriptsize}
\end{center}
\end{expansion}
