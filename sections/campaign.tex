...
\begin{multicols}{3}
  ...
  \columnbreak
  0~\svg{building_materials}

  \columnbreak
  0~\svg{valuablegreater}
\end{multicols}
...
If you choose to change your Hero between the Scenarios or when you repeat the scenario with a different Hero, replace all of the previous Hero’s Statistic cards and the level 1 Specialty card with all of the Statistic cards and the level 1 Specialty card of your new Hero.
If the previous Hero had \pagelink{Empowered Statistic}{Empowered Statistics cards}, you can remove Statistic cards of the same type from the new Hero’s deck, and replace them with Empowered Statistic cards of the corresponding type.
