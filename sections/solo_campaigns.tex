...
You cannot have more than 4 \wikilink{spells/magic_arrow}{Magic Arrow} cards, even if the old Hero had 5 of them.
...
\begin{tikzpicture}[remember picture, overlay]
  \node[opacity=0.15] at ([xshift=11em, yshift=14.48em]current page.south) {\includegraphics[width=1.2\linewidth]{\art/satyr.png}};
\end{tikzpicture}
\end{multicols*}
