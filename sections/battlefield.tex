...
\begin{expansion}{battlefield}
  ...
  \begin{multicols}{2}
    ...
    \begin{enumerate}
      ...
      \item Build your starting Deck as as per \pagelinkwithcomma{Setup Starting Deck}{steps 11--13 of Setup}.
     \end{enumerate}
  ...
  Set your starting Deck aside for now; you will only need it for the final Combat.
  \end{multicols}
\begin{center}
  \begin{scriptsize}
  \begin{tikzpicture}
