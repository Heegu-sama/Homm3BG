...
\begin{expansion}{battlefield}
  ...
  \begin{center}
    {\transparent{0.2}{\includegraphics[width=0.8\linewidth]{\art/land_mine.png}}}
  \end{center}\par
  ...
  \smallskip
  The game developers have \pagetarget{battlefield card clarifications}{clarified the following interactions}:
  \begin{itemize}
