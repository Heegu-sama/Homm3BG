  ...
  \begin{multicols}{2}
    ...
    \begin{enumerate}[leftmargin=1.5em]
      ...
      \item Both players roll 2 \svg{resource_die}.
        ...
        Give the Initiative Token to this player.
     \end{enumerate}
     \columnbreak
...
\begin{expansion}[before=\vspace*{-11mm}]{battlefield}
  ...
  \begin{enumerate}[leftmargin=1.3em]
    ...
    \item \textbf{Player Turns} -- starting with the starting player, both players take their turn by performing any of the following actions in any order:
    \begin{itemize}
