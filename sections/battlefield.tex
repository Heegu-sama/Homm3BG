...
\begin{expansion}[before=\vspace*{-11mm}]{battlefield}
  ...
  \begin{wrapfigure}{r}{0.33\linewidth}
    ...
    \vspace{1em}
  \end{wrapfigure}
  Starting with the player with the \pagetarget{Initiative Token}{\textbf{Initiative Token}} (in case of a \pagelink{BF for regular}{non-Adventure/Skirmish game}, that's the attacker), both players take turns choosing and placing one Obstacle Tokens on the Battlefield Board one-by-one until \textbf{all Obstacle Tokens (except Effects) are placed}.
