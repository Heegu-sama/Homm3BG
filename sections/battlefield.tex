...
\begin{expansion}[before=\vspace*{-11mm}]{battlefield}
  ...
  \begin{enumerate}[leftmargin=1.3em]
    ...
    If you still have \textbf{Magic Spring} Adventure card in hand, \textbf{discard it}.
  \end{enumerate}\par
  \smallskip
...
\begin{expansion}[before=\vspace*{-11mm}]{battlefield}
  ...
  \begin{multicols*}{2}
    ...
    It is recommended to use the Battlefield Combat Board only for \textbf{Player vs.~Player Combats}.
  \end{multicols*}
\end{expansion}
