...
\begin{expansion}{battlefield}
  ...
  \begin{center}
    {\hfill\transparent{0.2}{\includegraphics[width=0.75\linewidth]{\art/land_mine.png}}}
  \end{center}\par
  ...
  The game developers have clarified the following interactions:
  \begin{itemize}
    \item The official rules remove only Diplomacy and Logistics Ability cards, but common sense applies: the developers also recommend removing other Ability cards which provide no benefit in Battlefield modes, like \iftoggle{printable}{Ballistics}{\href{https://en.homm3bg.wiki/abilities/ballistics}{Ballistics}} or \iftoggle{printable}{Pathfinding}{\href{https://en.homm3bg.wiki/abilities/pathfinding}{Pathfinding}}.
    ...
    \item All cards in the Adventure phase are single-use.
      Consequently, resource-generating Permanent \svg[7]{permanent} cards (e.g.,~\iftoggle{printable}{Inexhaustible Cart of Ore}{\href{https://en.homm3bg.wiki/artifacts/inexhaustible_cart_of_ore}{Inexhaustible Cart of Ore}}) are limited to their bottom \svg{instant} effect only.
    ...
    \item Cards with ``Remove'' effects (e.g.,~Expert \iftoggle{printable}{Scholar}{\href{https://en.homm3bg.wiki/abilities/scholar}{Scholar}}) may be played during the Adventure phase, applying their effect to your Deck.
    \item When a card has both Combat and non-Combat effects (e.g.,~\iftoggle{printable}{Cape of Velocity}{\href{https://en.homm3bg.wiki/artifacts/cape_of_velocity}{Cape of Velocity}}), you decide whether to use it in the Adventure phase or reserve it for the final Combat.
  \end{itemize}
  \end{multicols}
\end{expansion}
