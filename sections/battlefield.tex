...
\begin{expansion}{battlefield}
  ...
  As a result, the official rules do not address many interactions, particularly those involving expansion content. The game developers have \pagetarget{battlefield card clarifications}{clarified the following interactions}:
  \begin{itemize}
    \item The official rules remove only Diplomacy and Logistics ability cards, but common sense applies: the developers also recommend removing Ballistics and Pathfinding, as none provide benefit in Battlefield modes.
