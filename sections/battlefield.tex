...
\begin{expansion}{battlefield}
  ...
  \begin{multicols}{2}
    ...
    The 5-unit limit does not apply in Skirmish Mode.
...
\begin{expansion}[before=\vspace*{-11mm}]{battlefield}
  ...
  The 5-unit limit does not apply in Adventure Mode.
  \end{multicols}
\end{expansion}
...
\begin{expansion}[before=\vspace*{-11mm}]{battlefield}
  ...
  \begin{itemize}
    ...
    \item \textbf{Place units} -- The player with the Initiative Token chooses a deployment zone and places their first unit in it, then players take turns placing their units \textbf{one by one}.
...
\begin{expansion}[before=\vspace*{-11mm}]{battlefield}
  ...
  \begin{itemize}
    ...
    \begin{minipage}{\linewidth}
      ...
      Once all units with that Initiative value are activated, pass the Initiative Token to the other player, who keeps it until an initiative ties of opposing units happens again.
    \end{minipage}
