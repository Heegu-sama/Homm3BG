...
\begin{expansion}[before=\vspace*{-11mm}]{battlefield}
  ...
  \begin{multicols*}{2}
    Although Battlefield is designed for \pagelink{Adventure and Skirmish Modes}{Adventure and Skirmish modes}, it is possible to use the Battlefield Board in regular games with slight rule modifications.
