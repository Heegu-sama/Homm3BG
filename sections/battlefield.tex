...
\begin{expansion}[before=\vspace*{-11mm}]{battlefield}
  ...
  The starting player receives the \pagetarget{Initiative Token}{\textbf{Initiative Token}}, which will be used to break any \pagelink{BF initiative tie}{Initiative ties} of opposing units.
  ...
  \begin{wrapfigure}{r}{0.4\linewidth}
    ...
    \caption{\footnotesize\imagecaption{Initiative Token}}
  \end{wrapfigure}
  ...
  \vspace{1em}
    ...
    The 5-unit limit does not apply in Battlefield modes, and players may place all available to them Faction units.
...
\begin{expansion}[before=\vspace*{-11mm}]{battlefield}
  ...
  \begin{itemize}
    ...
    \item \pagetarget{BF initiative tie}{\textbf{Initiative Tie}} -- If two or more opposing units have the same Initiative value, the player with the Token activates one of their units first.
