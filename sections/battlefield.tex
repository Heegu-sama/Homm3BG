...
\begin{expansion}[before=\vspace*{-11mm}]{battlefield}
  ...
  \begin{enumerate}[leftmargin=1.3em]
    ...
    \textbf{Note:} Before choosing the card, \textbf{the starting player} may use \svg{movement} effects from \pagelink{Adventure MM Cards}{set aside M\&M cards} to discard any number of the drawn Adventure cards and draw that many cards.\par
    ...
    \begin{itemize}
      ...
      \item Use the effects of \pagelink{Adventure MM Cards}{set aside M\&M cards}, except for \svg{movement}.
    \end{itemize}\par
