...
\begin{expansion}{battlefield}
  ...
  \begin{multicols}{2}
    ...
    \subsection*{Start of the game for both modes}
    Both players roll 2 \svg{resource_die}.
    The player with the highest total is the first player, and takes the Initiative Token.
