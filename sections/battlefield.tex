...
\begin{expansion}{battlefield}
  \begin{multicols}{2}
  \subsection*{Overview}
  The Battlefield expansion replaces the Combat Board with the large \pagelink{Battlefield Combat}{Battlefield Board}.
    ...
    \begin{enumerate}
     ...
     \begin{enumerate}[resume]
      ...
      \begin{itemize}
        ...
        \item[c)] No Town Buildings or units in the Unit Deck.  % Clarification: https://boardgamegeek.com/thread/3284421/article/44125381#44125381
      \end{itemize}
