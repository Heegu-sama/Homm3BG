...
\begin{expansion}{battlefield}
  ...
  Also you can \textbf{optionally} use the Battlefield Board instead of the Combat Board in other game modes.
...
\begin{expansion}[before=\vspace*{-11mm}]{battlefield}
  ...
  \begin{enumerate}[leftmargin=1.3em]
    ...
    \begin{itemize}
      ...
      \end{itemize}
    \end{itemize}
    \item \textbf{Determine starting player} -- in odd-numbered Rounds, it's the player \textbf{with} Initiative Token, in even-numbered Rounds, it's \textbf{without}.
...
\begin{expansion}[before=\vspace*{-11mm}]{battlefield}
  ...
  \begin{multicols*}{2}
    Although Battlefield is designed for \pagelink{Adventure and Skirmish Modes}{Adventure and Skirmish modes}, it is possible to use the Battlefield other game modes, albeit with slight rule modifications.
