...
\begin{expansion}{battlefield}
  ...
  \subsection*{Overview}
  \bigskip
  The Battlefield Expansion introduces two 1~vs.~1 game modes that focus on tactical combat on the Battlefield Board.
  ...
  This expansion introduces the large \pagelink{Battlefield Combat}{Battlefield Board}, which you can \textbf{optionally} use instead of the Combat Board.
