...
\begin{expansion}{battlefield}
  ...
  If you wish to include expansion cards, you will need to establish house rules for unresolved interactions.

  \smallskip
  Such unanswered questions include:
  \begin{itemize}
    \item Which cards should be removed from the game apart from Diplomacy and Logistics?
    \item Which cards should be removed in Skirmish Mode because they provide no Combat benefit?
    \item How should cards with Permanent effects be handled in Adventure Mode?
    \item How should cards with a ``Remove'' effect (e.~g.~Expert Learning) be handled in Adventure Mode?
    \item How should cards with both Combat and non-Combat effects (e.~g.~Cape of Velocity) be handled in Adventure Mode?
  \end{itemize}
  \end{multicols}
\end{expansion}
