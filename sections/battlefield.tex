...
\begin{expansion}[before=\vspace*{-11mm}]{battlefield}
  ...
  \begin{multicols*}{2}
  The \textbf{final Combat} is played on the Battlefield Board.
  Both players need Unit Miniatures of their Faction.
...
\begin{expansion}[before=\vspace*{-11mm}]{battlefield}
  ...
  \begin{multicols*}{2}
    ...
    \begin{itemize}
      ...
      \item Playing on the Battlefield Board requires using \pagelink{miniatures}{Miniatures} for Combat instead of unit cards.
    \end{itemize}
