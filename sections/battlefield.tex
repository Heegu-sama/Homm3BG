...
\begin{expansion}{battlefield}
  ...
  If you don't want to remove all Expansion cards from the game, you'll have to come up with house rules.

  \smallskip
  Such unanswered questions include:
  \begin{itemize}
    \item Which else cards should be removed from the game (beside Diplomacy and Logistics)?
    \item Which cards should be removed in Skirmish (they are useless for Combat)?
    ...
    \item How to handle cards with both a Combat effect and a non-Combat effect (e.~g.~Cape of Velocity) in Adventure mode?
  \end{itemize}
