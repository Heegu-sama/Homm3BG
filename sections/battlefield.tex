...
\begin{expansion}[before=\vspace*{-11mm}]{battlefield}
  ...
  \begin{itemize}
    ...
    {\centering
      \begin{tikzpicture}
        \draw (0, 0) node {\framedimage[0.9\linewidth]{\examples/bf-deploy.png}};
    ...
    \item \textbf{Place units} -- The player with the Initiative Token chooses a deployment zone and places one of their units in it, then players take turns placing their units \textbf{one by one} each in their zone.
      For Neutral Combats, place up to 5 units, otherwise, place \textbf{up to 7 units}.
...
\begin{expansion}[before=\vspace*{-11mm}]{battlefield}
  ...
  \begin{itemize}
    ...
    \begin{tikzpicture}
      ...
      \draw (2, 0) node[rotate=90, fill=black, fill opacity=0.15, text opacity=1]
        {\textbf{\liberation\large\textcolor{white}{\MakeUppercase{Deployment Zone}}}};
    \end{tikzpicture}
