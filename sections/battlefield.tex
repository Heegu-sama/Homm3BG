...
\begin{expansion}{battlefield}
  \begin{multicols}{2}
  \subsection*{Overview}
  The Battlefield expansion introduces the large \pagelink{BF for regular}{Battlefield Board}, which you can \textbf{optionally} use instead of Combat Board.
...
\begin{expansion}{battlefield}
  ...
  \begin{multicols}{2}
    ...
    \subsection*{Start of the game in both modes}
...
\begin{expansion}[before=\vspace*{-11mm}]{battlefield}
  ...
  Starting with the player with the \pagetarget{Initiative Token}{\textbf{Initiative Token}}, both players take turns choosing and placing one Obstacle Tokens on the Battlefield Board one-by-one until \textbf{all Obstacle Tokens (except Effects) are placed}.
  ...
  \vspace{1em}
    ...
    The 5-unit limit does not apply in Adventure and Skirmish, and players may place all Faction units available to them.
