...
\begin{multicols}{2}
  ...
  \begin{expansion}{inferno}
    ...
    The \textbf{\wikilink{units/pit_lords/\#__tabbed_1_2}{Pit Lords unit}} from the Inferno Faction may use their \svg{unit_alternative} ability to summon or reinforce the \wikilink{units/demons}{Demons} unit during Combat.
...
\begin{multicols}{2}
  \begin{expansion}{cove,stretchgoals2}
    ...
    \begin{wrapfigure}{r}{0.25\linewidth}
      ...
      \vspace{1em}
    \end{wrapfigure}
    \textbf{``Few'' \wikilink{units/sorceresses}{Sorceresses unit}} from the Cove Faction can use their \svg{unit_alternative} ability to place a Weakness Token on any unit.  % enemy unit?
