...
\begin{multicols}{2}
  ...
  \begin{expansion}{inferno}
    ...
    The \textbf{\wikilink{units/pit_lords/\#__tabbed_1_2}{Pit Lords unit}} from the Inferno Faction may use their \svg{unit_other} ability to summon or reinforce the \wikilink{units/demons}{Demons} unit during Combat.
...
\begin{multicols}{2}
  \begin{expansion}{cove,stretchgoals2}
    ...
    \begin{wrapfigure}{r}{0.25\linewidth}
      ...
      \vspace{1em}
    \end{wrapfigure}
    \textbf{``Few'' \wikilink{units/sorceresses}{Sorceresses unit}} from the Cove Faction can use their \svg{unit_other} ability to place a Weakness Token on any unit.  % enemy unit?
  ...
  \begin{expansion}{stronghold,stretchgoals2}
    ...
    \begin{wrapfigure}{r}{0.2\linewidth}
      ...
      \vspace{1em}
    \end{wrapfigure}
    The \textbf{\wikilink{units/ogres}{Ogres unit}} from the Stronghold Faction can use their \svg{unit_other} ability to place Attack Tokens on other allied unit cards.
