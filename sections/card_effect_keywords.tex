...
\begin{multicols}{2}
  ...
  \begin{expansion}{inferno}
    ...
    The \textbf{\wikilink{units/pit_lords/\#pack}{Pit Lords unit}} from the Inferno Faction may use their \svg{unit_alternative} ability to summon or reinforce the \wikilink{units/demons}{Demons} unit during Combat.
...
\begin{multicols}{2}
  ...
  \begin{expansion}{stronghold}
    ...
    \begin{wrapfigure}{r}{0.25\linewidth}
      ...
      \vspace{1em}
    \end{wrapfigure}
    The \textbf{\wikilink{units/behemoths/\#pack}{Behemoths unit}} from the Stronghold Faction can use their \svg{unit_attack} ability to place a Corrosion Token on a unit attacked by them.
