...
\begin{expansion}{stretchgoals2}
  ...
  Depending on the \svg{empower} used, take 2, 4 or 6 \textbf{Land Mine Tokens}.
...
\begin{multicols}{2}
  ...
  \begin{expansion}{inferno}
    ...
    The \textbf{Pit Lords unit} from the Inferno Faction may use their \svg{unit_alternative} ability to summon or reinforce the Demons unit during Combat.
...
\begin{multicols}{2}
  \begin{expansion}{cove,stretchgoals2}
    ...
    \begin{wrapfigure}{r}{0.25\linewidth}
      ...
      \vspace{1em}
    \end{wrapfigure}
    \textbf{``Few'' Sorceresses unit} from the Cove Faction can use their \svg{unit_alternative} ability to place a Weakness Token on any unit.  % enemy unit?
  ...
  \begin{expansion}{stronghold,stretchgoals2}
    ...
    \begin{wrapfigure}{r}{0.2\linewidth}
      ...
      \vspace{1em}
    \end{wrapfigure}
    The \textbf{Ogres unit} from the Stronghold Faction can use their \svg{unit_alternative} ability to place Attack Tokens on other allied unit cards.
