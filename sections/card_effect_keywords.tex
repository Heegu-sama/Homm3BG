...
\begin{expansion}{stretchgoals2}
  ...
  While casting the \wikilink{/spells/land_mine}{\textbf{Land Mine Spell}}, depending on the \svg{empower} used, take 2, 4 or 6 \textbf{Land Mine Tokens} from the same set (blue or red).
