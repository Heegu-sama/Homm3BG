...
\textbf{Expansion Content}: Content from different expansions is marked with colored bars on the left margin:

\begin{expansion}{tower}
Tower content is marked with gray.
\end{expansion}

\begin{expansion}{rampart}
Rampart content is marked with green.
\end{expansion}

\begin{expansion}{fortress}
Fortress content is marked with dark olive.
\end{expansion}

\begin{expansion}{inferno}
Inferno content is marked with red.
\end{expansion}

\begin{expansion}{stronghold}
Stronghold content is marked with tan.
\end{expansion}

\begin{expansion}{conflux}
Conflux content is marked with magenta.
\end{expansion}

\begin{expansion}{cove}
Cove content is marked with teal.
\end{expansion}

\begin{expansion}{battlefield}
Battlefield content is marked with dark gray.
\end{expansion}

\begin{expansion}{navalbattles}
Naval Battles content is marked with dark blue.
\end{expansion}
...
{\transparent{0.2}{\includegraphics[width=\linewidth]{\art/tome_of_fire_magic.png}}}
