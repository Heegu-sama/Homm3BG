...
\begin{itemize}
  \item \svg[12]{building_city_hall} \textbf{City Hall} -- Provides Resource income or a Faction-Specific Ability.
  ...
  \columnbreak
  \item \svg{bronze},~\svg{silver},~\svg{golden} \textbf{Unit Dwellings}\index{Dwellings} -- Allows you to recruit units of your Faction.
