...
\begin{itemize}
  \item \svg[12]{building-horn} \textbf{City Hall} -- Provides Resource income or a Faction-Specific Ability.
  ...
  \item \svg[12]{building-guild} \textbf{Mage Guild}\index{Mage Guild} -- gains you \pagelink{spells}{Spells}.
  \item \svg[12]{building-tent},~\svg[12]{building-gears} \textbf{Faction Building} -- a Faction-Specific Building with a unique effect.
  \columnbreak
