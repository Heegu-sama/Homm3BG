...
\begin{itemize}
  \item \svg{building-horn} \textbf{City Hall} -- Provides Resource income or a Faction-Specific Ability.
  \item \svg{building-citadel} \textbf{Citadel} -- Allows you to Reinforce Units when using the Population Token.
        Also \pagelink{Walls}{protects your Town} when it is attacked.
  \item \svg{building-guild} \textbf{Mage Guild}\index{Mage Guild} -- gains you \pagelink{spells}{Spells}.
  \item \svg{building-tent},~\svg{building-gears} \textbf{Faction Building} -- a Faction-Specific Building with a unique effect.
  \columnbreak
