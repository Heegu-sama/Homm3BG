...
\begin{itemize}
  ...
  \item \svg[12]{building_mage_guild} \textbf{Mage Guild}\index{Mage Guild} -- gains you \pagelink{spells}{Spells}: upon building it, and later using \pagelink{Town Actions}{the Spell Book Town Action}.
