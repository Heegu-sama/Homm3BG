...
\begin{multicols*}{2}
  ...
  \begin{expansion}{navalbattles}
    \pagelink{Creature Banks Rules}{Creature Bank Units} do not have a tier, so they ignore the tiers in the priority list above and attack the closest unit.
    If you have Creature Bank Units in your army, they are added to the priority list at the bottom: enemy units will prioritize attacking all other units first.
  \end{expansion}
