...
\begin{multicols*}{2}
  ...
  \begin{itemize}
    ...
    \begin{expansion}{navalbattles}
      If you have \pagelink{Creature Banks Rules}{Creature Bank Units} in your army, they are added to the priority list at the bottom: enemy units will prioritize attacking all other units first.
      This is demarked as \textbf{CB} in the examples below.
    \end{expansion}
    ...
    - CB\svg{unit_ground}\svg{unit_flying}.}
  \end{itemize}
  ...
  \begin{expansion}{navalbattles}
    \pagelink{Creature Banks Rules}{Creature Bank Units} do not have a tier, so they ignore the tiers in the priority list above and attack the closest valid target.
  \end{expansion}
