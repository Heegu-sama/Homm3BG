...
\begin{multicols*}{2}
  \begin{tikzpicture}
    ...
    \begin{scope}[
      ...
      \draw (0.2, 0.5) node {\encircle{3}};
      \draw (0.6, 0.5) node {\encircle{4}};
      \draw (0.2, 0.3) node {\encircle{5}};
      \draw (0.6, 0.3) node {\encircle{6}};
  ...
  For certains spells it can be unclear how AI are supposed to use them.
...
\begin{multicols*}{2}
  ...
  \subsection*{Spells attacking multiple targets (like \wikilink{spells/fireball}{Fireball} and \wikilink{spells/chain_lightning}{Chain Lightning})}
  ...
  \subsection*{Instant Defense spells (like \wikilink{spells/stone_skin}{Stone Skin})}
  ...
  \columnbreak
  \subsection*{Healing spells (like \wikilink{spells/cure}{Cure})}
  ...
  \subsection*{Single-round buffs (like \wikilink{spells/fire_shield}{Fire Shield})}
  ...
  \subsection*{Attack-weakening spells (like \wikilink{spells/weakness}{Weakness})}
