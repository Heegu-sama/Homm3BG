...
\begin{multicols*}{2}
  ...
  \textbf{If you are besieging an AI Town:} When the Walls and Gate\index{Walls and Gate} are mentioned in Combat preparation but no additional information on how to arrange them is given, arrange them as a human player would:
  ...
  AI treats \pagelink{Walls}{the Arrow Tower}\index{Arrow Tower} like a Silver \svg{silver}\svg{unit_ranged} unit.
  ...
  \textbf{If AI Hero besieges you}, the Arrow Tower is treated like a Silver \svg{silver}\svg{unit_ranged} unit as well.
