...
The Might card \svg[12]{might} is attached to the unit until the first respective attack/defense happens.
Same happens for other cards which increase \svg{defense}.
