...
\begin{multicols*}{2}
  ...
  If more than half of those units have already activated this Round, do not cast the Spell -- instead, set it aside and cast it when the first AI unit activates next Round.
