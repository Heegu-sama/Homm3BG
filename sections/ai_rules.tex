...
\begin{multicols*}{2}
  ...
  When the Walls and Gate\index{Walls and Gate} are mentioned in Combat preparation but no additional information on how to arrange them is given, arrange them as a human player would:
  ...
  The \pagelink{Walls}{Arrow Tower}\index{Arrow Tower} is treated like a Silver \svg{silver}\svg{unit_ranged} unit.
