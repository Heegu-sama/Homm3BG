...
\pl{
  \addsection{Pozostałe zasady}{\skills/armorer.png}
}
...
\pl{}
\note{5}{
  \en{Specialty, Statistic, Starting Ability and Magic Arrows \textbf{cannot be removed} in the Trading Post.}
  \pl{}
}\par
\en{In \textbf{Alliance} and \textbf{Cooperative} Scenarios, players are allowed to trade Resources and cards following these rules:}
\pl{}
\begin{itemize}
  \en{\item In Alliance Scenarios, allies may trade Resources freely at any time on their Turns except during Combat.}
  \pl{\item}
  \en{\item In Cooperative Scenarios, Resources may be given to other players when Visiting a Trading Post.}
  \pl{\item}
  \en{
...
\pl{}
\begin{itemize}
  \en{\item \textbf{Easy} – Roll 2 \includesvg[height=10px]{\svgs/resource_die.svg} and receive Resources from both – OR – \textbf{Search} (2) the Artifact Deck, twice.}
  \pl{\item}
  \en{\item \textbf{Normal} – Roll 2 \includesvg[height=10px]{\svgs/resource_die.svg} and receive the Resources from one of them – OR – \textbf{Search} (2) the artifact Deck.}
  \pl{\item}
  \en{\item \textbf{Hard} – Roll 1 \includesvg[height=10px]{\svgs/resource_die.svg} and receive the Resources on it – OR – reveal cards from the top of the Artifact Deck until you find 1 Minor Artifact and add it to your hand.}
  \pl{\item}
  \en{\item \textbf{Impossible} – No starting bonus.}
  \pl{\item}
\end{itemize}

\note{5}{
  \en{Campaign missions have unique bonuses that replace the regular starting bonus.}
  \pl{}
}
...
\vfill
\hfill\includegraphics[width=0.8\linewidth]{\art/cerberi.png}
