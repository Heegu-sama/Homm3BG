...
\begin{expansion}[before=\vspace*{-11mm}]{navalbattles}
  ...
  \begin{center}
    ...
    \textbf{\footnotesize\textit{\textcolor{darkcandyapplered}{6 middle places -- player deployment zone}}}\\
    \textbf{\footnotesize\textit{\textcolor{darkcandyapplered}{Corners -- Neutral Units deployment zone}}}\\
  \end{center}
  \bigskip
