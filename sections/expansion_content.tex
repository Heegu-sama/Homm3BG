...
\begin{expansion}[before=\vspace*{0pt}]{navalbattles}
  ...
  Cause these fields haven't any difficulty level, so a Quick Combat is never going to happen, there is no round limit and no need to spend MP to extend the combat and you don't provide any \svg{experience}.
  The defending Units and all effects of all Creature Bank Locations are listed in \pagelink{All Map Locations}{All Map Locations}.
  \vspace*{1em}
  \end{expansion}
