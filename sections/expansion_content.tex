...
\begin{multicols*}{2}
  ...
  \begin{minipage}{0.65\linewidth}
    \centering
    \includegraphics[width=0.6\linewidth]{\map_locations/creature-bank.png}\\
    \imagecaption{Creature Bank (Near)}\\
  \end{minipage}
  \hfill
  \begin{minipage}{0.3\linewidth}
    \centering
    \includegraphics[width=0.7\linewidth]{\images/stack-token.png}\\
    \imagecaption{Stack Token}\\
  \end{minipage}\\

  \begin{center}
    \begin{multicols*}{2}
      \includegraphics[width=\linewidth]{\cards/creature-bank-back.png}\\
      \includegraphics[width=\linewidth]{\cards/creature-bank.png}\\
    \end{multicols*}
    \vspace*{-0.5em}
