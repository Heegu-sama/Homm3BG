...
\begin{expansion}{stretchgoals2}
  ...
  \begin{center}
    \begin{multicols}{2}
      \includegraphics[width=\linewidth]{\cards/town-card-back.png}

      \includegraphics[width=\linewidth]{\cards/town-card.png}
    \end{multicols}
  \end{center}
  ...
  Skip the cards with Factions which you don't have.
\end{expansion}
\vspace*{\fill}
\columnbreak
\begin{center}
...
\begin{expansion}{stretchgoals2}
  ...
  \end{center}
    ...
    \end{wrapfigure}
    A second \textbf{Manticore unit card} with slightly different statistics is included in this expansion.
    When playing the Dungeon Faction, choose one of the two Manticore cards to use in the game.
\end{expansion}

\vspace*{\fill}
{\transparent{0.2}\hfill\includegraphics[width=0.8\linewidth]{\art/blind.png}\hfill~}
\vspace*{\fill}
\columnbreak
