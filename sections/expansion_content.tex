...
\begin{expansion}[before=\vspace*{-11mm}]{navalbattles}
    ...
    \begin{center}
        \begin{tikzpicture}
          \draw(1.5, -1.5) node {\includegraphics[width=0.3\linewidth]{\examples/pile.png}};
          \begin{scope}[cm={cos(45),-0.5*sin(45),sin(45),0.5*cos(45),(1.5,-1.4)}, transform shape]
            \draw(0, 0) node {\includegraphics[width=0.17\linewidth]{\cards/necromancy_card.png}};
            \filldraw[fill=black, draw=black, opacity=0.5] (-0.6, -0.9) rectangle(0.6, 0.9);
          \end{scope}
          \draw(-1, 0.5) node[rotate=15] {\includegraphics[width=0.3\linewidth]{\cards/ability-wisdom.png}};
          \begin{scope}[rotate=-15, transform shape]
            \draw(0, 0) node {\includegraphics[width=0.48\linewidth]{\examples/glow.png}};
            \draw(0, 0) node {\includegraphics[width=0.3\linewidth]{\cards/ability-offense.png}};
          \end{scope}
        \end{tikzpicture}
    \end{center}
