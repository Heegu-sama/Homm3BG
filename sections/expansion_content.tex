...
In addition to new gameplay mechanics, expansions also expand the variety of existing components: new Factions, new Spells, new Heroes, new Artifacts, and much more...

\begin{center}
  \transparent{0.3}{\includegraphics[width=0.7\linewidth]{\art/tome_of_earth_magic.png}}
\end{center}
\end{multicols*}
\pagebreak
...
\begin{expansion}[before=\vspace*{-11mm}]{navalbattles}
  ...
  \note{4}{The exact mechanics of the rewarded Stacked Units is not confirmed with developers yet.}
