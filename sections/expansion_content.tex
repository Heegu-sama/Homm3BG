...
\begin{multicols}{4}
    \begin{center}
        ...
        \footnotesize contains the \nth{1} campaign's props and neutral miniatures\par
        \columnbreak
        \includegraphics[width=0.8\linewidth]{\boxcovers/stretchgoals-chest.png}
        \footnotesize contains the \nth{2} campaign's stretch goal gameplay components\par
        \columnbreak
        \includegraphics[width=0.8\linewidth]{\boxcovers/stretchgoals-crystal.png}
        \footnotesize contains the \nth{2} campaign's props and neutral miniatures\par
    \end{center}
\end{multicols}
