...
\begin{expansion}{fortress}
  \subsection*{Fortress Expansion}
  \setlength\intextsep{0pt}
  \setlength\columnsep{0.8em}
  \begin{wrapfigure}{r}{0.35\textwidth}
      \includegraphics[width=\linewidth]{\images/fortress-box.png}
  \end{wrapfigure}
  This expansion brings the swamp-loving \textbf{Fortress Faction} and their Beastmaster into the game.\par
  \medskip
  Furthermore it introduces the following new storytelling Card type:
  \medskip
...
\begin{expansion}{rampart}
    \subsection*{Rampart Expansion}
    \setlength\intextsep{0pt}
    \setlength\columnsep{0.8em}
    \begin{wrapfigure}{r}{0.35\textwidth}
        \includegraphics[width=\linewidth]{\images/rampart-box.png}
    \end{wrapfigure}
    Rangers and Druids from the nature-loving \textbf{Rampart Faction} will be introduced into the game.\par
    \medskip
    With them comes a new Card type: The use of \pagelink{War Machines}{War Machines} support you permanent in your combats.
\end{expansion}

\vspace*{1em}
\begin{expansion}{inferno}
    \subsection*{Inferno Expansion}
    \setlength\intextsep{0pt}
    \setlength\columnsep{0.8em}
    \begin{wrapfigure}{r}{0.35\textwidth}
        \includegraphics[width=\linewidth]{\images/inferno-box.png}
    \end{wrapfigure}
    The daemonic \textbf{Inferno Faction} with its fire associated Units comes to Antagarich.\par
    \medskip
    And one of its Units is able to use a unique ability to \pagelink{Summoning}{Summon Daemons} in a combat.
    Your Heroes can \pagelink{Empowered Statistic}{empower Statistic Cards} to get much more powerful.
    And the new \pagelink{Random Town}{Random Town} Map Location with unique combat rules provides charming rewards.
\end{expansion}

\vspace*{1em}
\begin{expansion}{conflux}
   \subsection*{Conflux Expansion}
   \setlength\intextsep{0pt}
   \setlength\columnsep{0.8em}
   \begin{wrapfigure}{r}{0.35\textwidth}
       \includegraphics[width=\linewidth]{\images/conflux-box.png}
   \end{wrapfigure}
   The new \textbf{Conflux Faction} unites all elemental creatures under one banner led by Elementalists.\par
   \medskip
   Let your Heroes travel through \pagelink{Elemental Map Tiles}{elemental Map Tiles} to cast their Spells more powerfully or let them reach long distances on the Map by using magical \pagelink{Monoliths}{Monoliths} to teleport.
   During combat, use a unique new type of Spell Cards to \pagelink{Detailed Card Effects}{Summon Elemental Units}, which support you in your Combat.
\end{expansion}
\vspace*{\fill}

\columnbreak
\begin{expansion}{stronghold}
    \subsection*{Stronghold Expansion}
    \setlength\intextsep{0pt}
    \setlength\columnsep{0.8em}
    \begin{wrapfigure}{r}{0.35\textwidth}
        \includegraphics[width=\linewidth]{\images/stronghold-box.png}
    \end{wrapfigure}With this expansion come Barbarians and Warlords from the \textbf{Stronghold Faction} with their Orcs and Ogres to Antagarich.\par
    \medskip
    The expansion introduces new \pagelink{Subterranean Map Tiles}{Subterranean Map Tiles} which you can explore and it offers \pagelink{War Machines}{mystical Spell Scrolls}, % TODO: update link
    which allow your Heroes to cast additional Spells, even if they are not so familiar with magic.
\end{expansion}

\vspace*{1em}
\begin{expansion}{tower}
    \subsection*{Tower Expansion}
    \setlength\intextsep{0pt}
    \setlength\columnsep{0.8em}
    \begin{wrapfigure}{r}{0.35\textwidth}
        \includegraphics[width=\linewidth]{\images/tower-box.png}
    \end{wrapfigure}
    Wizards and alchemists of the \textbf{Tower faction} enter the game.\par
    \medskip
    This expansion doesn't include any new game play mechanics, but extends many existing components, especially more Heroes of different factions.
\end{expansion}
\vspace*{\fill}
\columnbreak

\begin{expansion}{cove}
    \subsection*{Cove Expansion}
    \setlength\intextsep{0pt}
    \setlength\columnsep{0.8em}
    \begin{wrapfigure}{r}{0.35\textwidth}
        \includegraphics[width=\linewidth]{\images/cove-box.png}
    \end{wrapfigure}
    The \textbf{Cove Faction} with its pirates and sea monsters comes from the wide ocean to Antagarich.\par
    \medskip
    In this expansion, your Heroes can set sail and explore \pagelink{Sea Map Tiles}{Sea Map Tiles}, which bring a lot new Sea Locations to Antagarich. \pagelink{Discover Location Tokens}{Whirlpools} allow your Heroes to quickly travel between distant Sea Tiles… but \pagelink{Whirlpool}{at a cost}.
    And with the cannon, another powerful one is added to the pool of \pagelink{War Machines}{War Machines}.
\end{expansion}
...
\begin{expansion}{navalbattles}
    \subsection*{Naval Battles Expansion}
    \setlength\intextsep{0pt}
    \setlength\columnsep{0.8em}
    \begin{wrapfigure}{r}{0.35\textwidth}
        \includegraphics[width=\linewidth]{\images/navalbattles-box.png}
    \end{wrapfigure}
...
\begin{expansion}{battlefield}
    ...
    \setlength\columnsep{0.8em}
    \begin{wrapfigure}{r}{0.35\textwidth}
        \includegraphics[width=\linewidth]{\images/battlefield-box.png}
    \end{wrapfigure}
...
\begin{expansion}[before=\vspace*{-11mm}]{navalbattles}
    ...
    \begin{center}
        \begin{tikzpicture}
            ...
            \draw (-1, 1) node {\svg[25]{green_tick}};
            \draw (2, 0) node {\includegraphics[width=0.3\linewidth]{\cards/ability-wisdom.png}};
            \draw (3, 1) node {\svg[25]{red_cross}};
        \end{tikzpicture}
    \end{center}
...
\begin{multicols*}{2}
 \begin{expansion}{stretchgoals2}
   \subsection*{Stretch Goals 2 Expansion}
   \setlength\intextsep{0pt}
   \setlength\columnsep{0.8em}
   \begin{wrapfigure}{r}{0.35\textwidth}
       \includegraphics[width=\linewidth]{\images/stretchgoals-box.png}
   \end{wrapfigure}
   This expansion primarily contains aesthetic components, but it also includes Town Cards for randomly drawing factions and the following game play variation to the Pandora's Box map location:
   \medskip
