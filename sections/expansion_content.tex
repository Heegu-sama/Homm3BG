...
\begin{expansion}[title=]{inferno}
    ...
    New gameplay mechanics:\par
    \smallskip
    A new Unit Ability to \pagelink{Summoning}{Summon Demons} in a combat; \pagelink{Empowered Statistic}{Empowered Statistic Cards} to make your Hero's Statistic Cards more powerful and the \pagelink{Random Town}{Random Town} Map Location with unique combat rules.
\end{expansion}
...
\begin{expansion}[title=]{conflux}
   ...
   New gameplay mechanics:\par
   \smallskip
   \pagelink{Elemental Map Tiles}{Elemental Map Tiles} aligned with Schools of Magic; magical \pagelink{Monoliths}{Monoliths}, which allow your Heroes to traverse long distances on the Map; a new \pagelink{elemental damage}{type of damage}, that ignores defense; and a unique Spell effect to \pagelink{Detailed Card Effects}{Summon Elemental Units (TODO: fix link)}, which support you in your Combat.
\end{expansion}
\vspace*{\fill}
...
\begin{expansion}[title=]{cove}
    ...
    New gameplay mechanics:\par
    \smallskip
    \pagelink{Sea Map Tiles}{Sea Map Tiles} with many new Sea Locations to discover; \pagelink{Discover Location Tokens}{Whirlpools} to travel quickly between distant Sea Tiles… but \pagelink{Whirlpool}{at a cost} and the cannon, a new \pagelink{War Machines}{War Machine}.
\end{expansion}
...
\begin{expansion}[title=]{navalbattles}
    ...
    The \pagelink{}{empowered Ability Cards} is a new reward.
\end{expansion}
...
Take a look at the \textbf{fanmade expansions and contents} that the \textbf{HoMM3 BG Community} has developed. They are still work in progress. Feel free to contribute.
  ...
  \begin{center}
    \hfill
    \includegraphics[width=0.42\linewidth]{\images/mission-book-title.png}
    \includegraphics[width=0.42\linewidth]{\images/factory-book-title.png}
  \end{center}
  \begin{itemize}
    \begin{minipage}{5cm}
        \item Bring your own creative ideas to live by building own Scenarios with the help of the \textbf{Scenario Map Editor}:
