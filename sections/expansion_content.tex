...
\begin{multicols}{2}
Four boxes of stretchgoal content have been released for the boardgame.\par
These expansions primarily contain aesthetic components (like Miniatures of Neutral Units or Map Locations), but they also extend the variety of existing components (like additional Artifact or Spell cards or new Hero Boards for all Factions).
...
\begin{center}
    \footnotesize
    \includegraphics[width=0.4\linewidth]{\boxcovers/stretchgoals-factionunits.png}\\[1em]
    \imagecaption{Core Game Faction Miniatures}
    \vspace*{\fill}

    \includegraphics[width=0.4\linewidth]{\boxcovers/stretchgoals-neutral.png}\\[1em]
    \imagecaption{\nth{1} Campaign Miniatures}
    \vspace*{\fill}

    \includegraphics[width=0.4\linewidth]{\boxcovers/stretchgoals-chest.png}\\[1em]
    \imagecaption{\nth{2} Campaign \mbox{Gameplay Components}}
    \vspace*{\fill}

    \includegraphics[width=0.4\linewidth]{\boxcovers/stretchgoals-crystal.png}\\[1em]
    \imagecaption{\nth{2} Campaign Miniatures}
    \vspace*{\fill}
\end{center}

\columnbreak
\includegraphics[width=\linewidth]{\art/golem.png}
\columnbreak
