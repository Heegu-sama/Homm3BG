...
These expansions primarily contains aesthetic components (like miniatures of Map Locations), but they also extend the variety of existing components (like additional Hero Cards).\par
\smallskip
The only new game variant contained in a Stretchgoal box is explained below.
...
\vspace*{1em}
\begin{center}
    \footnotesize All four available stretch goal boxes
\end{center}
\begin{multicols}{4}
    \begin{center}
        \includegraphics[width=0.8\linewidth]{\boxcovers/stretchgoals-factionunits.png}
        \footnotesize contains the core game's Faction Unit miniatures\par
        \columnbreak
        \includegraphics[width=0.8\linewidth]{\boxcovers/stretchgoals-neutral.png}
        \footnotesize contains the 1st campaign's props and neutral miniatures\par
        \columnbreak
        \includegraphics[width=0.8\linewidth]{\boxcovers/stretchgoals-chest.png}
        \footnotesize contains the 2nd campaign's stretch goal gameplay components\par
        \columnbreak
        \includegraphics[width=0.8\linewidth]{\boxcovers/stretchgoals-crystal.png}
        \footnotesize contains the 2nd campaign's props and neutral miniatures\par
    \end{center}
\end{multicols}
