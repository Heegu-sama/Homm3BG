...
\columnbreak
    ...
    \subsubsection*{Gaining Empowered Ability Example}
...
\begin{expansion}{battlefield}
  ...
  \begin{itemize}
    \item \textbf{Place obstacles} – Starting with the attacking player, both players take turns choosing and placing one Obstacle Token on the Battlefield Board until \textbf{all Obstacle Tokens are placed}.
...
\begin{expansion}{battlefield}
  ...
  \begin{itemize}
    ...
    \footnotesize\textit{Example: Halberdier and Crusader (defenders) may enter the Gate Token only along the green arrows, but Troglodyte and Harpies are still able to attack the Gate Token from any side.}
  \end{itemize}
  \end{multicols*}
\end{expansion}
