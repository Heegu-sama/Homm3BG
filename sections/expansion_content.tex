...
\begin{expansion}{battlefield}
  ...
  \begin{itemize}
    ...
    \begin{tikzpicture}
      ...
      \draw (2.5, 0) node[rotate=90] {\includegraphics[width=0.9\linewidth]{\examples/bf-deploy-text.png}};
    \end{tikzpicture}
...
\begin{expansion}{battlefield}
  ...
  \begin{itemize}
    ...
    \begin{tikzpicture}
      ...
      \draw (2, 0) node[rotate=90] {\includegraphics[width=0.9\linewidth]{\examples/bf-deploy-text.png}};
    \end{tikzpicture}
