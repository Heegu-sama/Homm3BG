...
\textbf{The following contents are added by specific expansions:}
\begin{multicols*}{2}
...
\begin{expansion}{inferno}
  ...
  Basically a new \pagelink{Random Town}{Map Locations}, but with unique rules, that it makes it worth to be mention separately.
\end{expansion}
...
\begin{expansion}{conflux}
	...
	When your heroes travel through these areas, they can cast their spells more powerfully. explained in \pagelink{Elemental Map Tiles}{Map Elements}.
\end{expansion}
...
\begin{expansion}{conflux}
	...
	They are explained in a new chapter \pagelink{Detailed Card Effects}{Detailed Card Effects}.
\end{expansion}
...
\begin{expansion}{conflux}
	...
	It allows you to build new interesting scenario map layouts. Detailed information in \pagelink{Discover Location Tokens}{Map Elements} and \pagelink{Monolith}{All Map Locations}.
\end{expansion}
