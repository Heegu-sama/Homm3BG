...
\begin{minipage}[h]{\linewidth}
  ...
  \end{center}
  \shadowimage[width=\linewidth]{\images/war_machine_factory.jpg}
...
\begin{minipage}[h]{\linewidth}
  ...
  \begin{scriptsize}
    \begin{tikzpicture}
      \draw (0, 0) node[inner sep=0] {\makebox[\linewidth][c]{\includegraphics[width=\linewidth]{\images/event_card.png}}};
...
\begin{center}
  \includegraphics[width=\linewidth]{\images/empowered_statistics.png}
\end{center}
...
\begin{minipage}[h]{\linewidth}
  ...
  \end{center}
  \shadowimage[width=\linewidth]{\images/random_town.jpg}
  \footnotesize{Category: \scriptsize\textbf{Flaggable}}
\end{minipage}
