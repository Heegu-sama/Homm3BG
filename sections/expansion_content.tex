...
\subheader{New Gameplay Mechanics and Game Modes}
\begin{multicols*}{2}
...
\subheader{\pagetarget{Creature Banks Rules}{Creature Banks}}
\begin{multicols*}{2}
...
\subheader{\pagetarget{Empowered Ability Token}{Empowered Ability Cards}}
\begin{multicols*}{2}
...
\begin{expansion}{battlefield}
  \subheader{\pagetarget{Battlefield Combat}{Battlefield in regular games}}
  \begin{multicols*}{2}
