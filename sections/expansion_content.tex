...
\begin{expansion}{stronghold}
   ...
   How to reach this Subterranean Map Tiles is explained in \pagelink{Subterranean Map Tiles}{Map elements}.
\end{expansion}
...
\begin{expansion}{stronghold}
   ...
   They are explained in \pagelink{War Machines}{Deck-building}. % TODO: update link
\end{expansion}
...
\begin{expansion}{inferno}
    ...
    A new Card type which improves your regular Statistic Cards, explained in \pagelink{Empowered Statistic}{Deck-building}.
\end{expansion}

\vspace*{1em}
\begin{expansion}{inferno}
    \subsection*{Random Town}\index{Random Town}
    A new \pagelink{Random Town}{Map Location} with unique rules.
\end{expansion}
\end{multicols*}
...
\begin{multicols*}{2}
  ...
  \begin{expansion}{battlefield}
    ...
    Two new game \pagelink{Battlefield Modes}{modes} focused on the battlefield.
  \end{expansion}
\end{multicols*}
...
\begin{expansion}{navalbattles}
    ...
    Using the \pagelink{combat}{Naval Battle Board} lets your Heroes fight a Combat on ships, what is more challenging than on the normal Combat Board.
\end{expansion}
...
\begin{expansion}{cove}
    ...
    In this expansion, your Heroes can set sail and explore \pagelink{Sea Map Tiles}{Sea Map Tiles}, which bring a lot new Sea Locations to Antagarich.
\end{expansion}

\vspace*{1em}
\begin{expansion}{cove}
    \subsection*{Whirlpool}
    \pagelink{Discover Location Tokens}{Whirlpools} allow your Heroes to quickly travel between distant Sea Tiles… \pagelink{Whirlpool}{at a cost}.
\end{expansion}
...
Take a look at the \textbf{fanmade expansions and contents} that the \textbf{HoMM3 BG Community} has developed:
  ...
  \begin{itemize}
    ...
    \begin{minipage}{2.5cm}
        \includegraphics[width=\linewidth]{\images/qr-mission-book.png}
    \end{minipage}
    \begin{minipage}{5.5cm}
    ...
    \hfill
    \begin{minipage}{2.5cm}
        \includegraphics[width=\linewidth]{\images/qr-factory.png}
    \end{minipage}
  \end{itemize}
  \begin{multicols}{2}
  ...
  \begin{itemize}
    ...
    \hfill
    \begin{minipage}{2.5cm}
        \includegraphics[width=\linewidth]{\images/qr-map-editor.png}
    \end{minipage}
    \begin{minipage}{5.5cm}
    ...
    \hfill
    \begin{minipage}{2.5cm}
        \includegraphics[width=\linewidth]{\images/qr-hero-creator.png}
    \end{minipage}
  \end{itemize}
