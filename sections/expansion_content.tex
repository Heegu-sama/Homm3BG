...
This effect can be used \textbf{once per Combat}.
It cannot Summon Units from the Neutral Units Deck or your Units Deck.
...
Alternatively, you can Reinforce the Unit already on the Combat Board with this effect, and may pay no gold.
...
\vfill
\hspace{2em}
{\transparent{0.2}\includegraphics[width=1\linewidth]{\art/implosion.png}}
\vfill
