...
\textbf{The following expansions each offer a new Faction and some new specific gameplay mechanics:}
\begin{multicols}{2}
...
Four Boxes of stretchgoal content have been released for HoMM3 The Boardgame whose cover design and main content is shown at the bottom of this page.\par
...
The only new gameplay variant contained in a Stretchgoal box is explained below.\par
\vspace*{1em}
...
Take a look at the \textbf{fanmade expansions and contents} that the \textbf{HoMM3 BG Community} has developed. They are still work in progress. Feel free to contribute.
  \begin{itemize}
    \begin{minipage}{5cm}
    \item The \href{https://github.com/qwrtln/Homm3BG-mission-book}{Fanmade Mission Book} contains many well playtested Scenarios with unique rules for even more spice in your games.
    \end{minipage}
    \hfill
    \begin{minipage}{2cm}
        \begin{center}
            \includegraphics[width=\linewidth]{\qr/mission-book.png}
            \scriptsize Link to \textbf{Github}
        \end{center}
    \end{minipage}\par
    \smallskip
    \begin{minipage}{5cm}
  ...
  \end{itemize}
\begin{center}
    \includegraphics[width=0.48\linewidth]{\images/mission-book-title.png} \includegraphics[width=0.48\linewidth]{\images/factory-book-title.png}
\end{center}
  \begin{itemize}
    \begin{minipage}{5cm}
    ...
    \begin{minipage}{2cm}
        \begin{center}
            ...
            \scriptsize Link to the \textbf{App}
        \end{center}
    \end{minipage}\par
    \smallskip
    \begin{minipage}{5cm}
