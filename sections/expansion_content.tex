...
\begin{expansion}[before=\vspace*{-11mm}]{navalbattles}
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \draw (0, 0.2) node {\textbf{\footnotesize\textit{\textcolor{darkcandyapplered}{Player deployment}}}};
      \draw (0, -0.2) node {\textbf{\footnotesize\textit{\textcolor{darkcandyapplered}{zone}}}};
      \draw (2.9, 1.9) node {\textbf{\footnotesize\textit{\textcolor{black}{Neutral}}}};
      \draw (2.9, 1.5) node {\textbf{\footnotesize\textit{\textcolor{black}{Unit}}}};
      \draw (-3.1, 1.9) node {\textbf{\footnotesize\textit{\textcolor{black}{Neutral}}}};
      \draw (-3.1, 1.5) node {\textbf{\footnotesize\textit{\textcolor{black}{Unit}}}};
      \draw (2.9, -1.5) node {\textbf{\footnotesize\textit{\textcolor{black}{Neutral}}}};
      \draw (2.9, -1.9) node {\textbf{\footnotesize\textit{\textcolor{black}{Unit}}}};
      \draw (-3.1, -1.5) node {\textbf{\footnotesize\textit{\textcolor{black}{Neutral}}}};
      \draw (-3.1, -1.9) node {\textbf{\footnotesize\textit{\textcolor{black}{Unit}}}};
    \end{tikzpicture}
  \end{center}
  \bigskip
