...
\begin{figure}[H]
  \begin{minipage}[t]{0.47\textwidth}
    ...
    \expansionlabel{conflux}
    \caption{\small Category: \textbf{Revisitable}\\
      Move your Hero to the corresponding Exit Monolith (see to the right).
    }
  \end{minipage}\hfill
  \begin{minipage}[t]{0.47\textwidth}
    \vspace{0pt}
...
\begin{figure}[H]
  ...
  \begin{minipage}[t]{0.47\textwidth}
    ...
    \caption{{\raggedright \small Category: \textbf{Revisitable}}\\
      ...
      Discover the connected Field, if it wasn't discovered alrady.
    }
  \end{minipage}
\end{figure}
...
\begin{table*}[!hb]
  \hommtable[]{50}{
    \centering
    \medskip
    \pagetarget{Creature Bank List}{\textbf{Far (II--III) Tile Creature Banks}}\\
    \bigskip
    \begin{tabularx}{0.95\linewidth}{
      ...
      & \darkcell[1.2]{Units}
      & \darkcell[1.2]{Reward}
      & \darkcell[1.2]{Extra reward for X Stacks} \\
      ...
      & \lightcellleft[3.7]{Griffins are Stacked, if there were at least 2 Stacks.} \\
      ...
      & \lightcellleft[3.4]{Dragon Flies are Stacked, if there were at least 2 Stacks.} \\
...
\begin{table*}[!hb]
  \hommtable[]{50}{
    \centering
    \medskip
    \textbf{Near (IV--V) Tile Creature Banks}\\
    \bigskip
    \begin{tabularx}{0.95\linewidth}{
        >{\centering}p{0.2\linewidth}
