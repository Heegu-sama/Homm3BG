...
\begingroup
  ...
  \begin{tabularx}{\linewidth}{Y m{0.8\linewidth}}
    ...
    {\LARGE\textbf{?}} & Special effect, see \pagelink{Revisitable Fields}{Revisitable} or \pagelink{Other Fields}{Other} fields.\\
  \end{tabularx}
\endgroup
...
\begin{itemize}[itemsep=0.4em]
  ...
  \item [{\LARGE\textbf{2}}] \svg[14]{treasure}{\LARGE\textbf{$\boldsymbol{/}$2}} \svg[14]{resource_die} \svgeven{arrow_right}{\LARGE\textbf{1}} —
...
\begin{center}
  ...
  {\transparent{0.2}{\includegraphics[width=0.8\linewidth]{\art/meteor_shower.png}}}
\end{center}
...
All mines have the \svg{ongoing} symbol and a picture of the Resource they produce.
...
\textit{Towns from all expansions.}
\end{center}
\pagebreak
...
\begin{minipage}[h]{\linewidth}
  \centering
  \includegraphics[width=0.49\linewidth]{\map_locations/castle_settlement.png}
  \includegraphics[width=0.49\linewidth]{\map_locations/dungeon_settlement.png}
  \includegraphics[width=0.49\linewidth]{\map_locations/necropolis_settlement.png}
  \includegraphics[width=0.49\linewidth]{\map_locations/rampart_settlement.png}
  \includegraphics[width=0.49\linewidth]{\map_locations/fortress_settlement.png}
  \includegraphics[width=0.49\linewidth]{\map_locations/inferno_settlement.png}
  \includegraphics[width=0.49\linewidth]{\map_locations/tower_settlement.png}
  \includegraphics[width=0.49\linewidth]{\map_locations/stronghold_settlement.png}
  \includegraphics[width=0.49\linewidth]{\map_locations/conflux_settlement.png}
  \includegraphics[width=0.49\linewidth]{\map_locations/cove_settlement.png}
  \par
