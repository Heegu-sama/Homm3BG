...
\begin{center}
  ...
  \textit{Towns from the core game:\\Necropolis, Castle, Dungeon.}

  \framedimage[\linewidth]{\map_locations/town-tower.jpg}\\
  \expansionlabelnocap{tower}

  \medskip

  \framedimage[\linewidth]{\map_locations/town-rampart.jpg}\\
  \expansionlabelnocap{rampart}

  \vspace*{\fill}
  \columnbreak

  \framedimage[\linewidth]{\map_locations/town-fortress.jpg}\\
  \expansionlabelnocap{fortress}

  \medskip

  \framedimage[\linewidth]{\map_locations/town-inferno.jpg}\\
  \expansionlabelnocap{inferno}

  \medskip

  \framedimage[\linewidth]{\map_locations/town-stronghold.jpg}\\
  \expansionlabelnocap{stronghold}

  \medskip

  \framedimage[\linewidth]{\map_locations/town-conflux.jpg}\\
  \expansionlabelnocap{conflux}

  \medskip

  \framedimage[\linewidth]{\map_locations/town-cove.jpg}\\
  \expansionlabelnocap{cove}
\end{center}
