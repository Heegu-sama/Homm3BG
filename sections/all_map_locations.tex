...
\begin{figure}[H]
  ...
  \begin{minipage}[t]{0.47\textwidth}
    ...
    \expansionlabel{stronghold}
    \caption{{\raggedright \small Category: \textbf{Revisitable}}\\
      Connects a sufrace and a \protect\pagelink{Subterranean Map Tiles}{Subterranean Map Tile}.
...
\begin{table*}[!hb]
  ...
  \hommtable[]{50}{
    ...
    \begin{tabularx}{0.95\linewidth}{
      ...
      & \lightcellleft[3.4]{4 × Dragon Flies}
      & \lightcellleft[3.4]{1 × Dragon Flies}
      & \lightcellleft[3.4]{Dragon Flies are Stacked, if there were at least 2 Stacked Units.} \\
...
\begin{table*}[!hb]
  ...
  \hommtable[]{50}{
    ...
    \begin{tabularx}{0.95\linewidth}{
      ...
      & \lightcellleft[3.3]{2 × Gold Golems\\2 × Diamond Golems}
      & \lightcellleft[3.3]{Search (5) the Spell Deck.}
      & \lightcellleft[3.3]{X times: You may Remove 1 Spell, Ability, or Artifact from your hand or discard, then Search (5) that deck.} \\
      ...
      & \lightcellleft[3.3]{X times: Search (5) the Artifact or Spell Deck.} \\
    \end{tabularx}
  }
  \end{expansion}
\end{table*}
