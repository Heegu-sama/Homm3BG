...
\begin{figure}[H]
  \begin{minipage}[t]{0.48\textwidth}
    ...
    \caption{ \scriptsize Category: \textbf{Revisitable}\\You may
  ...
  \begin{minipage}[t]{0.48\textwidth}
    ...
    \caption[black market]{\scriptsize Category: \textbf{Revisitable}\\Look at the top 4 cards from the Artifact discard pile.
...
\begin{figure}[H]
  \begin{minipage}[t]{0.48\textwidth}
    ...
    \caption{ \scriptsize Category: \textbf{Revisitable}\\
  ...
  \begin{minipage}[t]{0.48\textwidth}
    ...
    \caption{ \scriptsize Category: \textbf{Revisitable}\\You can \includesvg[height=8px]{\svgs/pay_v2.svg}
...
\begin{figure}[H]
  \begin{minipage}[t]{0.48\textwidth}
    ...
    \caption{\scriptsize Category: \textbf{Visitable}\\You may
      \includesvg[height=8px]{\svgs/pay_v2.svg}
  ...
  \begin{minipage}[t]{0.48\textwidth}
    ...
    \caption{ \scriptsize Category: \textbf{Visitable}\\Discover a tile adjacent to this one.}
  \end{minipage}
\end{figure}
...
\begin{figure}[H]
  \begin{minipage}[t]{0.48\textwidth}
    ...
    \caption{ \scriptsize Category: \textbf{Flaggable}\\
...
\begin{figure}[H]
  \begin{minipage}[t]{0.48\textwidth}
    ...
    \caption[scholar they]{\scriptsize Category: \textbf{Visitable}\\
      Roll 1 Attack die.
