...
\begingroup
  ...
  \begin{tabularx}{\linewidth}{Y m{0.7\linewidth}}
    ...
    % \\
    % & \textbf{Resource Symbols:} \\
    % \includesvg[height=15px]{\svgs/gold.svg} & Gold \\
    % \includesvg[height=15px]{\svgs/building_materials.svg} & Building Materials \\
    % \includesvg[height=15px]{\svgs/valuablegreater.svg} & Valuables
  \end{tabularx}
\endgroup
