...
\begin{itemize} 
	\item Increase your \svg{gold}, \svg{building_materials} or \svg{valuablegreater} income by one space. As with Mines, if you are the first player to Flag a Settlement, you \textbf{immediately} gain Resources equal to that increase in production. Mark the Settlement with an appropriate Resource Token to show which Resource it produces. When you Flag an enemy Settlement, you may change this Resource.
	\item \textbf{instead of increasing Resource Production}, you may choose to \textbf{Reinforce} one of your \svgunit{bronze} or \svgunit{silver} Units immediately for half the normal cost, rounded up. If you were the first player to Flag the Settlement, Reinforce that Unit \textbf{for free} instead. Do not place any Resource Tokens on the Settlement if you choose to Reinforce.
\end{itemize}
...
\begin{figure}[H]
  \begin{minipage}[t]{0.47\textwidth}
    ...
    \caption{\small Category: \textbf{Revisitable}\\
      \textbf{Choose one}: \protect\pagelink{Trading}{Trade} resources OR Remove one card and gain 1 \svg{gold} OR buy a \protect\pagelink{War Machines}{War Machine} at the higher cost.
    }
  \end{minipage}\hfill
  \begin{minipage}[t]{0.47\textwidth}
    \vspace{0pt}
    ...
    \caption{\small Category: \textbf{Revisitable}\\Buy a \protect\pagelink{War Machines}{War Machine} at the cheaper cost.\phantom{.......}}
  \end{minipage}
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{minipage}[t]{0.47\textwidth}
    ...
    \caption{\small Category: \textbf{Visitable}\\Discover a face down Tile adjacent to this one OR \pagelink{Placing}{place} a new Tile from your supply adjacent to this and a further tile.}
  \end{minipage}
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{minipage}[t]{0.47\textwidth}
    \vspace{0pt}
    \centering
    \phantom{j}\textbf{Random Town}\phantom{j}\par
