...
\begin{minipage}[t]{0.47\textwidth}
  \vspace{0pt}
  \centering
  \locationtitle{Pandora's Box (water)}
...
{\centering
  ...
  \begin{tikzpicture}[remember picture, overlay]
    \node[opacity=0.2] at ([xshift=12em, yshift=12em]current page.south) {\includegraphics[width=0.9\linewidth]{\art/morale_high.png}};
  \end{tikzpicture}
}
...
\textlang{english}{\begin{tikzpicture}[remember picture, overlay]
  \node(cover)[anchor=center, yshift=12em, opacity=0.07] at (current page.south) {
...
\begin{figure}[H]
  \begin{minipage}[t]{0.47\textwidth}
    \vspace{0pt}
    \centering
    \pagetarget{Monolith}{\locationtitle{One-Way Entrance Monolith}}
...
\begin{figure}[H]
  ...
  \begin{minipage}[t]{0.47\textwidth}
    \vspace{0pt}
    \centering
    \locationtitle{Subterranean Gate}
...
\begin{figure}[H]
  \begin{minipage}[t]{0.47\textwidth}
    \vspace{0pt}
    \centering
    \pagetarget{Whirlpool}{\locationtitle{Whirlpool}}
