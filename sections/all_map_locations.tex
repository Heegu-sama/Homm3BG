...
\begin{expansion}[before=\vspace*{-11mm}]{inferno}
  ...
  \begin{itemize}
    \item a ``Pack'' of \svgunit{bronze} Units, chosen by the player who controls the defense during this Combat,
    \item two ``Packs'' of \svgunit{silver} Units,
    \item two ``Fews'' of \svgunit{golden} Units.
  \end{itemize}
...
\begin{center}
  \framedimage[\linewidth]{\map_locations/settlements-1.jpg}\\
  \framedimage[\linewidth]{\map_locations/settlements-2.jpg}\\
