...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.18\linewidth]{\map_locations/whirlpool-token.png}
  \includegraphics[width=0.18\linewidth]{\map_locations/monolith_token.png}
  \includegraphics[width=0.18\linewidth]{\map_locations/creature_bank_token.png}
  \includegraphics[width=0.35\linewidth]{\map_locations/subterranean_gate_horizontal.png}
\end{figure}
