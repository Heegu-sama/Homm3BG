...
\begin{minipage}[h]{\linewidth}
  \centering
  \shadowimage[width=0.7\linewidth]{\map_locations/castle_settlement.jpg}
  \shadowimage[width=0.7\linewidth]{\map_locations/dungeon_settlement.jpg}
  \shadowimage[width=0.7\linewidth]{\map_locations/necropolis_settlement.jpg}
  \shadowimage[width=0.7\linewidth]{\map_locations/rampart_settlement.jpg}
  \shadowimage[width=0.7\linewidth]{\map_locations/fortress_settlement.jpg}
  \shadowimage[width=0.7\linewidth]{\map_locations/inferno_settlement.jpg}
  \shadowimage[width=0.7\linewidth]{\map_locations/tower_settlement.jpg}
  \par
