...
\begin{minipage}[h]{\linewidth}
  \centering
  \shadowimage[width=0.7\linewidth]{\images/castle_settlement.jpg}\hfill%
  \shadowimage[width=0.7\linewidth]{\images/dungeon_settlement.jpg}\hfill%
  \shadowimage[width=0.7\linewidth]{\images/necropolis_settlement.jpg}\\
  \shadowimage[width=0.7\linewidth]{\images/rampart_settlement.jpg}\hfill%
  \shadowimage[width=0.7\linewidth]{\images/fortress_settlement.jpg}\hfill%
  \shadowimage[width=0.7\linewidth]{\images/inferno_settlement.jpg}\\
  \shadowimage[width=0.7\linewidth]{\images/tower_settlement.jpg}\\%
