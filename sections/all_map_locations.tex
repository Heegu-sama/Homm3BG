...
\begingroup
  ...
  \begin{tabularx}{\linewidth}{Y m{0.8\linewidth}}
    ...
    \includesvg[height=15px]{\svgs/treasure.svg} & Roll a Treasure Die and gain the indicated bonus (\includesvg[height=10px]{\svgs/resource_die.svg}, \includesvg[height=10px]{\svgs/2_treasure_die.svg}, \includesvg[height=10px]{\svgs/experience.svg}, or \includesvg[height=10px]{\svgs/artifact.svg}).\index{Treasure Die} \\
...
{\centering\textbf{\pagetarget{Random Town}{Random Town}}\par}
