...
\textbf{Note:} In the following Fields skip the move if you would be stepping onto allied Hero and don't have enough MP to move off it immediately.
...
\begin{figure}[H]
  \begin{minipage}[t]{0.47\textwidth}
    ...
    \caption{{\raggedright \small Category: \textbf{Revisitable}}\\
      ...
      If there are 3 Whirlpools, roll an Attack Die to determine where your Hero goes, and reroll any Die which shows the number of the Whirlpool your Hero is moving from.
