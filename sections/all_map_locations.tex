...
\begin{figure}[H]
  ...
  \begin{minipage}[t]{0.47\textwidth}
    ...
    \caption{\small Category: \textbf{Visitable}\\Discover a face down Tile adjacent to this one OR \protect\pagelink{Placing}{place} a new Tile from your pool adjacent to this one.}
  \end{minipage}
\end{figure}
