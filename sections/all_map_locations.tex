...
\begin{center}
  \hspace{-14em}
  \includegraphics[scale=0.11]{\art/ballista.png}
\end{center}

\begin{center}
  \includegraphics[width=\linewidth]{\images/symbols.png}
\end{center}
...
\begin{minipage}[h]{\linewidth}
  \centering
  \shadowimage[width=0.75\linewidth]{\images/castle_settlement.jpg}\hfill%
  \shadowimage[width=0.75\linewidth]{\images/dungeon_settlement.jpg}\hfill%
  \shadowimage[width=0.75\linewidth]{\images/necropolis_settlement.jpg}\\
  \shadowimage[width=0.75\linewidth]{\images/rampart_settlement.jpg}\hfill%
  \shadowimage[width=0.75\linewidth]{\images/fortress_settlement.jpg}\hfill%
  \shadowimage[width=0.75\linewidth]{\images/inferno_settlement.jpg}\\
  \shadowimage[width=0.75\linewidth]{\images/tower_settlement.jpg}\\%
...
\begin{minipage}{\linewidth}
  ...
  \end{center}
  \shadowimage[width=\linewidth]{\images/library.jpg}
  \small{Category: \textbf{Revisitable}\\
    You may \includesvg[height=8px]{\svgs/pay_v2.svg}
...
\begin{minipage}{\linewidth}
  ...
  \end{center}
  \shadowimage[width=\linewidth]{\images/black_market.jpg}
  \small{Category: \textbf{Revisitable}\\
...
\begin{minipage}{\linewidth}
  ...
  \end{center}
  \shadowimage[width=\linewidth]{\images/tavern.jpg}
  \small{Category: \textbf{Revisitable}\\
...
\begin{minipage}{\linewidth}
  ...
  \end{center}
  \shadowimage[width=\linewidth]{\images/trading_post.jpg}
  \small{Category: \textbf{Revisitable}\\
...
\begin{minipage}{\linewidth}
  ...
  \end{center}
  \shadowimage[width=\linewidth]{\images/stables.jpg}
  \small{Category: \textbf{Revisitable}\\
...
\vfill
\begin{center}
  \includegraphics[scale=0.1]{\art/mine_field.png}
\end{center}
...
\vfill
\begin{center}
  \includegraphics[scale=0.1]{\art/implosion.png}
\end{center}
...
\begin{figure*}[!hb]
  \centering
  \includegraphics[width=\textwidth]{\art/gold_dragon.jpg}
\end{figure*}
