...
\begin{figure}[H]
  \begin{minipage}[t]{0.47\textwidth}
    ...
    \caption{\small Category: \textbf{Revisitable}\\
      ...
      Also, buy a \protect\hyperlink{War Machines}{War Machine}.
    }
  \end{minipage}\hfill
  \begin{minipage}[t]{0.47\textwidth}
    \vspace{0pt}
...
\begin{figure}[H]
  ...
  \begin{minipage}[t]{0.47\textwidth}
    % \hspace{2em}
    % \includegraphics[width=0.8\linewidth]{\art/implosion.png}
  \end{minipage}
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{minipage}[t]{0.47\textwidth}
    ...
    \captionsetup{singlelinecheck=off}
    \centering
    \phantom{j}\textbf{\hypertarget{Random Town}{Random Town}}\par
    \framedimage[\linewidth]{\map_locations/random_town.jpg}
    \caption[scholar they]{\small Category: \textbf{Flaggable}\\
