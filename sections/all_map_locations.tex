...
\textbf{Note:} In the following Fields skip the move if you would be stepping onto allied Hero and have not enough MP to move off it immediately.
If your Hero moved to a Location Token on a still face down Tile, discover that Tile.
