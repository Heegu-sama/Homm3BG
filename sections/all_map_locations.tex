...
\begin{expansion}{inferno}
  ...
  \begin{itemize}
    ...
    \item Draw a random unused \pagelink{Town Card}{Town Card}.
    \end{expansion}
  \end{itemize}
...
\makebox[\linewidth][c]{\begin{tikzpicture}
  ...
  \node (whirl) [right=1em of subgate.south east, anchor=south west] {\includegraphics[width=0.18\linewidth]{\map_locations/whirlpool-token.png}};
