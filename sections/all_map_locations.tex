...
\begin{figure}[H]
  \begin{minipage}[t]{0.47\textwidth}
    ...
    \expansionlabel{stronghold}
    \caption{\small Category: \textbf{Visitable}\\
      When preparing the Neutral Army guarding this location, instead of drawing 1 \svg{azure} unit, find 2 \svg{golden} \protect\wikilink{units/cyclops}{Cyclops} and add them to the Neutral Army (look for them first in the \svg{golden} discard pile, and then in the \svg{golden} Neutral Unit Deck).
