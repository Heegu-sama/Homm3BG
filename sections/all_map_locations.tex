...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.47\textwidth}
        ...
        \caption{\small Category: \textbf{Visitable}\\Discover a Tile adjacent to this one (either a face down one, or a \protect\pagelink{Placing}{new one} from your supply).
            In \protect\pagelink{Tournament Mode}{Tournament Mode} you may instead freely rotate a adjacent Tile not occupied by a Hero, as long as it doesn't contradict the \protect\pagelink{Placing}{standard rules for placing Tiles}.}
    \end{minipage}
\end{figure}
