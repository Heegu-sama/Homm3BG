...
\begingroup
  ...
  \begin{tabularx}{\linewidth}{Y m{0.8\linewidth}}
    ...
    \includesvg[height=15px]{\svgs/treasure.svg} & \parbox{0.7\hsize}{
      Roll a \hypertarget{Treasure Die}{Treasure Die}\index{Treasure Die}\index{Dice} and gain the indicated bonus (\includesvg[height=10px]{\svgs/resource_die.svg}, \includesvg[height=10px]{\svgs/2_treasure_die.svg}, \includesvg[height=10px]{\svgs/experience.svg}, or \includesvg[height=10px]{\svgs/artifact.svg}).
    }
...
\begin{figure}[H]
  \begin{minipage}[t]{0.47\textwidth}
    \vspace{0pt}
    \centering
    \phantom{j}\textbf{\hypertarget{Grail}{Grail}}\par
...
{\centering\textbf{\hypertarget{Random Town}{Random Town}\index{Random Town}}\par}
