...
Effects of the following \textbf{Visitable} fields are described clearly by the symbols in the table on the right:
\setlength{\columnsep}{1em}
\begin{multicols}{2}
  \centering\small
  \phantom{j}\textbf{Artifact}
  \includegraphics[width=\linewidth]{\map_locations/artifact_symbol.jpg}
  \phantom{j}\textbf{Treasure}
  \includegraphics[width=\linewidth]{\map_locations/treasure_symbol.jpg}
  \phantom{j}\textbf{Windmill}
  \includegraphics[width=\linewidth]{\map_locations/windmill.jpg}
  \phantom{j}\textbf{Temple}
  \includegraphics[width=\linewidth]{\map_locations/temple.jpg}
  \phantom{j}\textbf{Learning Stone}
  \includegraphics[width=\linewidth]{\map_locations/learning_stone.jpg}
  \phantom{j}\textbf{Shrine of Magic...}
  \includegraphics[width=\linewidth]{\map_locations/shrine_of_magic_whatever.jpg}
  % columnsep
  \phantom{j}\textbf{Resource}
  \includegraphics[width=\linewidth]{\map_locations/resource_symbol.jpg}
  \phantom{j}\textbf{Fountain of Youth}
  \includegraphics[width=\linewidth]{\map_locations/fountain_of_youth.jpg}
  \phantom{j}\textbf{Water Wheel}
  \includegraphics[width=\linewidth]{\map_locations/water_wheel.jpg}
  \phantom{j}\textbf{Warrior's Tomb}
  \includegraphics[width=\linewidth]{\map_locations/warriors_tomb.jpg}
  \phantom{j}\textbf{Mystical Garden}
  \includegraphics[width=\linewidth]{\map_locations/mystical_garden.jpg}
  \phantom{j}\textbf{Pandora's Box}
  \includegraphics[width=\linewidth]{\map_locations/pandoras_box.jpg}
\end{multicols}
% \begin{itemize}
%   \item Learning Stone
...
\vspace*{\fill}
%   \vspapandoras_boxce{4.4em}
\note{4}{
  Search? Spend resources? \textbf{lol nope}
