...
\subsection*{\pagetarget{Location Token}{Location Tokens and Creature Banks}}

Keep the rules for \pagelink{Discover Location Token}{discovering Tiles with Location Token} in mind. Below you find the rules for entering a location token.

\begin{figure}[H]
  \begin{minipage}[t]{0.47\textwidth}
    \vspace{0pt}
    \centering
    \phantom{j}\pagetarget{Monolith}{\textbf{One-Way Entrance Monolith}}\par
...
% 		\vspace{0pt}
% 		\centering
% 		\phantom{j}\pagetarget{Whirlpool}{\textbf{Whirlpool}}\par
...
%     }
%     % What does losing mean: complete unit card? Or reduce pack to few?
% 	\end{minipage}\hfill
% 	\begin{minipage}[t]{0.47\textwidth}
% 		\vspace{0pt}
% 		\centering
...
% 		\caption{\small Category: \textbf{Visitable}\\
% 			When you enter a Creature Bank (see \pagelink{Creature Banks}{List} below), start a \pagelink{Creature Bank Rules}{Creature Bank Combat} against the specified units.
%       If you win, receive the reward and the bonus (depending on defeated stacked units).
%       Creature banks count as \textbf{land fields} (even if designed as sea locations), and should not be confused with Other Fields of the same name.
%     }
% 	\end{minipage}
% \end{figure}
...
\begin{figure}[H]
  \begin{minipage}[t]{0.47\textwidth}
    \vspace{0pt}
    \centering
    \phantom{j}\textbf{Whirlpool}\par
    \framedimage[\textwidth]{\map_locations/whirlpool.jpg}
    % \includegraphics[width=0.4\textwidth]{\map_locations/whirlpool-token.png}
    \expansionlabel{cove}
    \caption{{\raggedright \small Category: \textbf{Revisitable}}\\
			Move your Hero immediately to another Whirlpool Token.
			If there are multiple valid targets, roll an Attack Die to determine where it takes your Hero.
  ...
  \begin{minipage}[t]{0.47\textwidth}
    ...
    \centering
    \phantom{j}\textbf{Creature Bank}\par
    \includegraphics[width=0.4\textwidth]{\map_locations/creature_bank_token.png}
    \expansionlabel{navalbattles}
    \caption{{\raggedright \small Category: \textbf{Revisitable}}\\
      When you enter a Creature Bank (see \protect\pagelink{Creature Banks}{List} below), start a \protect\pagelink{Creature Bank Rules}{Creature Bank Combat} against the specified units.
      If you win, receive the reward and the bonus (depending on defeated stacked units).
      Creature banks count as \textbf{land fields} (even if designed as sea locations), and should not be confused with Other Fields of the same name.
    }
  \end{minipage}
...
\begin{table*}[!hb]
  \hommtable[]{50}{
    \centering
    \medskip
    \textbf{Far (II--III) Tile Creature Banks}\\
    \bigskip
