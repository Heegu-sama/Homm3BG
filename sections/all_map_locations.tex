...
{\centering
  ...
  \begin{figure}[H]
      ...
      \caption{\small Due to a misprint, the Windmill on tile \texttt{\#N3} has a \textbf{?}. It should be ``\textbf{+}1\includesvg[height=0.8\baselineskip]{\svgs/valuablegreater.svg}''.}
  \end{figure}
}
