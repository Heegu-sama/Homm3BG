...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.47\textwidth}
        ...
        \protect\newline
        In \protect\pagelink{Tournament Mode}{Tournament Mode}: Rotate an adjacent Tile not occupied by a Hero, but keep the \protect\pagelink{Placing}{standard rules for placing Tiles}.}
    \end{minipage}
\end{figure}
