...
\note{small}{Combat against Azure \includesvg[height=10px]{\svgs/azure.svg} Units, other players or \hyperlink{AIrules}{AI Heroes} have no time limit.}

% \vspace*{\fill}
% \hspace{6em}
% \includegraphics[width=0.55\linewidth]{\art/cavalryman.png}
%
% \end{multicols*}
%
% \begin{multicols}{2}
...
\note{medium}{Attacks against Walls are always successful and they do not follow the normal framework for attacking other Units.
  Do not roll the Combat Die, activate any \includesvg[height=10px]{\svgs/unit_attack.svg} Abilities or play any Statistics altering \includesvg[height=10px]{\svgs/instant.svg} Cards during them.
}\par
...
\note{small}{Note: you cannot surrender when defending a Town.}\par
