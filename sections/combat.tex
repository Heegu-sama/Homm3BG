...
Instant \svg{instant} cards may be played \textbf{at any time} except between rolling the Attack Die and resolving damage unless otherwise stated. \textbf{Reroll effects} affecting the Attack Die are an exception to this and may be played after the die is rolled.
