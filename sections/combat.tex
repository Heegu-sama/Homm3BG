...
\begin{center}
  \vspace*{-1em}
  \hspace*{1em}\transparent{0.2}\includegraphics[width=1.6\linewidth]{\art/minotaur.png}
\end{center}
\end{multicols*}
...
\subheader{\pagetarget{Walls}{Defending a Town With a Citadel}}\index{Defending Town}
\begin{multicols}{2}
