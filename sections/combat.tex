...
\begin{itemize}
  \item Players Activate their Units in decreasing order of Unit \hyperlink{Initiative}{Intiative}. \textbf{If there's a tie}, alternate between attackers and defenders starting with an attacker.
...
\subsection*{Player vs Neutral Units}
Fight with Neutral Units works identically to a fight against an \hyperlink{AI Combat}{AI Hero}.
