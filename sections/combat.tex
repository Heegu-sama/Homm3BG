...
\note{Attacks against Walls are always successful and they do not follow the normal framework for attacking other Units.
...
\note{\textbf{Important exception}: If \textbf{all} of your Units from your Unit Deck were defeated during Neutral Combat, your Main Hero must be moved to a friendly Town or Settlement.
...
\note{You cannot surrender when defending a Town.}\par
