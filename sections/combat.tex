...
\pagetarget{Combat}{Combat}\index{Combat} with \textbf{Neutral Units} starts when a Hero moves to an \textbf{unvisited} Field with a roman numeral, signifying the \pagelink{Difficulty Table}{type and number} of Neutral Units guarding that Field.
...
\begin{itemize}
  ...
  \item Check the \pagelink{Difficulty Table}{\textbf{Difficulty Table}} and draw the corresponding number of Neutral Unit cards from their Decks.
