...
A \textbf{defeated Main Hero} has to move to a friendly Town or Settlement. If they were defeated by another player's army (with or without hero), they gain 1~\svg{morale_negative} and have to pay 5 \svg{gold} to the winner. Furthermore, they give a \pagelink{End}{Faction Cube} to the winning player. Defeating a Main Hero may cause \pagelink{End}{Player Elimination}.\par
A \textbf{defeated Secondary Hero} (even instantly defeated without combat) is removed from the map. If defeated by another player's Hero/Town/Settlement they also get a Faction Cube.\par
...
If your \textbf{Faction Town} is defeated, give the winner a Faction Cube (in addition to the winner flagging this Town).\par
