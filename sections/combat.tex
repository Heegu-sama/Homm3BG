...
\begin{expansion}{conflux}\textbf{\pagetarget{Elemental Damage}{Elemental Damage}} – If Units deal elemental damage, they attack normally, but the resulting damage works similary to \svg{damage} dealt by spells and it ignores the unit's \svg{defense}.
...
\begin{expansion}{battlefield}
  ...
  \begin{center}
    \hspace*{-1em}\includegraphics[width=1.15\linewidth]{\images/battlefield.png}
  \end{center}
\end{expansion}
