...
\textbf{Note:} Such attacks are always successful and they do not follow the normal framework for attacking other units.
Do not roll the Combat Die, activate any \includesvg[height=10px]{\svgs/unit_attack.svg} Abilities or play any Statistics altering \includesvg[height=10px]{\svgs/instant.svg} Cards during them.\par
