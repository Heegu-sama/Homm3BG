...
\begin{expansion}[left=4mm]{navalbattles}
  \item A \pagelink{Creature Banks}{Creature Bank Location}.
...
\begin{itemize}
  ...
  \item You move into a Town or Settlement owned by them, see \pagelink{Town Siege}{Town Siege}.
\end{itemize}
...
\begin{center}
  \transparent{0.2}\includegraphics[width=0.7\linewidth]{\art/wyvern.png}
\end{center}

\subheader{\pagetarget{Quick}{Quick Combat}}\index{Quick Combat}
...
\subheader{\pagetarget{Combatsetup}{Combat Setup}}
\begin{multicols*}{2}
...
\subheader{\pagetarget{Combatterminology}{Combat Terminology}}
\begin{multicols*}{2}
...
\begin{tikzpicture}[overlay]
  \node[blend mode=multiply, opacity=0.7] at (7, 0) {\includegraphics[width=0.2\linewidth]{\images/attack_die.png}};
  \node[blend mode=multiply, opacity=1.0] at (7, 0) {\includegraphics[width=0.2\linewidth]{\images/attack_die.png}};
...
\subheader{\pagetarget{combatround}{Combat Round Structure}}
\begin{multicols*}{2}
...
\subheader{\pagetarget{Endcombat}{End of Combat}}
\begin{multicols*}{2}
...
\vspace*{\fill}
\begin{center}
  \transparent{0.2}\includegraphics[width=0.8\linewidth]{\art/basilisk.png}
\end{center}
\end{multicols*}
...
\subheader{\pagetarget{Town Siege}{Town Siege}}\index{Defending Town}
\begin{multicols*}{2}
...
\vspace{0.5em}
\note{3.5}{You cannot surrender when defending your Faction Town.}\par
...
\pagetarget{Walls}{The Wall and Gate}\index{Walls and Gate} Cards can be destroyed by any adjacent \svg{unit_ground} or \svg{unit_flying} Unit's attack, even by your own defending Units.
...
Walls \pagelink{Walls protection}{protect the Defending Units behind it}.
\vspace*{\fill}
\columnbreak
...
In a siege against AI, the Arrow Tower follows the priority-rules like a Silver \svg{silver} Unit. But if there are many valid targets, it cannot attack the nearest one, so it will attack the one that is closest to perishing (the smallest difference between \svg{health_points} and current \svg{damage}).

\vspace*{\fill}
\begin{center}
  \transparent{0.2}\includegraphics[width=0.95\linewidth]{\art/coin.png}
\end{center}
\end{multicols*}
...
\begin{center}
  \transparent{0.2}\includegraphics[width=\linewidth]{\art/curse.png}
\end{center}
\end{multicols}
...
\subheader{\pagetarget{Alternative Combat Boards}{Alternative Combat Boards}}
...
\begin{expansion}{battlefield}
  ...
  Refer to the \pagelink{Battlefield Combat}{expansion content section} for the rule changes regarding this Combat type.
