...
\note{small}{Combat against Azure \includesvg[height=10px]{\notes_svgs/azure.svg} Units, other players or \hyperlink{AIrules}{AI Heroes} have no time limit.}
...
\note{medium}{Attacks against Walls are always successful and they do not follow the normal framework for attacking other Units.
  Do not roll the Combat Die, activate any \includesvg[height=10px]{\notes_svgs/unit_attack.svg} Abilities or play any Statistics altering \includesvg[height=10px]{\notes_svgs/instant.svg} Cards during them.
}\par
...
\begin{figure*}[!hb]
  ...
  \begin{minipage}[t]{0.4\textwidth}
    \centering
    \shadowimage[width=0.9\linewidth]{\examples/ranged_protected.jpg}
  ...
  \begin{minipage}[t]{0.4\textwidth}
    \centering
    \shadowimage[width=0.9\linewidth]{\examples/ranged_unprotected.jpg}
...
\note{medium}{\textbf{Important exception}: If \textbf{all} of your Units from your Unit Deck were defeated during Neutral Combat, your Main Hero must be moved to a friendly Town or Settlement.
...
\note{small}{You cannot surrender when defending a Town.}\par
