...
\note{3}{Combat against Azure \includesvg[height=10px]{\svgs/azure-note.svg} Units, other players or \hyperlink{AIrules}{AI Heroes} have no time limit.}
...
\note{7}{Attacks against Walls are always successful and they do not follow the normal framework for attacking other Units.
...
\note{3}{You cannot surrender when defending a Town.}\par
