...
Effects of Instant Cards, which increase a Unit's \includesvg[height=10px]{\svgs/attack.svg} (e.g. the Statistics Cards), expire whenever the first attack performed by that unit resolves or the Activation ends, whichever comes first.
Likewise, increased \includesvg[height=10px]{\svgs/defense.svg} expires whenever the defense resolves, or the Activation ends.
