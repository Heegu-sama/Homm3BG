...
\begin{itemize}
  ...
  \item In \textbf{Clash} or \textbf{Alliance} Scenarios, the enemy player sitting to your right controls the Neutral Units and decides their placement.
    \svg{unit_ranged} Units must be placed in the Backline if possible.
...
\note{11}{
    If your Town or Settlement is attacked by an enemy Hero and your Hero is not on that Field, you may immediately \textbf{pay 8} \svg{gold} to fight a defending Combat \textbf{using only your Units}.
...
Instant \svg{instant} Cards may be played \textbf{at any time} except between rolling the Combat Die and resolving damage unless otherwise stated.
...
When a Secondary Hero is attacked, they may also choose to be \textbf{instantly defeated} instead of fighting a Combat in order to preserve the Units.
