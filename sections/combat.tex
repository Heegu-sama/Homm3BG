...
Effects of Instant Cards, such as the Attack and Defense Statistic cards, which increase a Unit's \includesvg[height=10px]{\svgs/attack.svg} or \includesvg[height=10px]{\svgs/defense.svg}, expire whenever an attack happens or the Activation ends, whichever comes first.
