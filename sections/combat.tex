...
Ongoing \includesvg[height=10px]{\svgs/ongoing.svg} and \includesvg[height=10px]{\svgs/activation.svg} activate effects can be used only when activating a unit and before it attacks.
...
% TODO: explain why one space to the right? Why not all the way to the right?
...
In neutral combat, enemy units cannot defend.
  ...
  %TODO priority? Who can play the first card?
...
Defeating a neutral combat which involved an azure \includesvg[height=10px]{\svgs/azure.svg} unit grants you level 7 immediately.
...
\includesvg[height=10px]{\svgs/unit_ranged.svg} units prioritize other \includesvg[height=10px]{\svgs/unit_ranged.svg} units of the same tier, then lower tier, and finally higher tier.
