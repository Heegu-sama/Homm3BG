...
A \textbf{defeated Main Hero} has to move to a friendly Town or Settlement. If they were defeated by another player's Hero or Town, they gain 1~\svg{morale_negative} and have to pay 5 \svg{gold} to the winner. Furthermore, they give a \pagelink{End}{Faction Cube} to the winning player. Defeating a Main Hero may cause \pagelink{End}{Player Elimination}.\par
A \textbf{defeated Secondary Hero} (even instantly defeated without combat) is removed from the map. If defeated by another player's Hero/Town they also get a Faction Cube.\par
A \textbf{defeated \pagelink{Siege Combat}{Town}} gives the winner a Faction Cube.\par
...
\vspace*{\fill}
\begin{center}
  \transparent{0.2}\includegraphics[width=0.5\linewidth]{\art/basilisk.png}
\end{center}
\end{multicols*}
