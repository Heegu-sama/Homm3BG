...
\vspace*{\fill}
\subheader{Campaign and Cooperative Combat}
...
\vspace*{\fill}
\begin{center}
  \transparent{0.15}\reflectbox{\includegraphics[width=0.7\linewidth]{\art/wyvern.png}}
\end{center}
\vspace*{\fill}
...
\vspace{0.5em}
\note{3.5}{You cannot surrender when defending a Town (or a Settlement?).}\par
...
\begin{center}
  \includegraphics[width=1.05\linewidth]{\art/crystal_dragon.jpg}
\end{center}
