...
\hypertarget{Combat}{Combat\index{Combat}} is resolved on the separate Combat Board.
...
\textbf{Combat Obstacles\index{Combat Obstacles}} – Every card placed on the Combat Board counts as a Combat Obstacle.
...
If the player cannot win the Combat before the end of the current Combat Round, they must either \hyperlink{Endcombat}{Retreat\index{Retreat}} or spend 1 MP from the Hero that started the combat in order to play another Combat Round.\par
\note{5}{Combat against Azure \includesvg[height=10px]{\svgs/azure-note.svg} Units, other players or \hyperlink{AIrules}{AI Heroes} have no time limit.}

\subsection*{\hypertarget{Walls}{Defending a Town With a Citadel\index{Defending Town}}}
...
The Wall and Gate cards can be destroyed by any adjacent \includesvg[height=10px]{\svgs/unit_ground.svg} or \includesvg[height=10px]{\svgs/unit_flying.svg} Unit's attack.\par
\note{8}{Attacks against Walls are always successful and they do not follow the normal framework for attacking other Units.
  Do not roll the Combat Die, activate any \includesvg[height=10px]{\svgs/unit_attack-note.svg} Abilities or play any Statistics altering \includesvg[height=10px]{\svgs/instant-note.svg} Cards during them.
}\par
...
\begin{figure*}[!hb]
  ...
  \caption[halberdiers protected]{\textit{Halberdiers are behind a non-destroyed Gate, they \textbf{are protected} when attacked from behind the Wall line.
    Evil Eyes \textbf{reduce \includesvg[height=10px]{\svgs/unit_ranged.svg} attack damage by 1}.}}
  \end{minipage}
  \hfill%
  \begin{minipage}[t]{0.4\textwidth}
    \centering
