...
\vspace{0.5em}
\note{3.5}{Note: you cannot surrender when defending your Faction Town.}\par
...
In a siege against an AI Hero, the Arrow Tower follows the priority rules like a Silver \svg{silver} Unit.
