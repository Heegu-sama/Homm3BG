...
\note{17}{
  ...
  When a \pagelink{Secondary}{Secondary Hero} is attacked, they \textbf{may choose} to be \pagelink{Endcombat}{instantly defeated} instead of fighting a Combat, because this helps preserving the Units.
}
