...
\begin{itemize}
	...
	\item \textbf{Retreat:} The player runs out of time or loses all combating units, but has still units in his Unit Deck.
	\item \textbf{Defeat:} The player loses all combating Units and haven't any Units in his Unit Deck.
\end{itemize} 
...
\begin{itemize}
	...
	\item \textbf{Surrender:} Instead of activating one of his Units, a Hero can decide to  surrender to the other players Hero by paying them 10 \svg{gold} to prevent his army. In this case the combat ends immediately without having a winning or defeated hero.
\end{itemize} 
...
A \textbf{Winning Hero} gets \pagelink{Combatexperience}{Experience}, if it was the main hero. If it was the attacker he must Visit the Field where the combat took place.\par
...
A \textbf{defeated Secondary Hero} (even instantly defeated without combat) is removed from the map. If defeated by another players hero they get also a Faction Cube.\par
A \textbf{Surrendering Hero} doesn’t count as defeated. Move a surrendering main hero to a town or settlement, or remove a secondary hero from the map as if he had been defeated. The other player neither get Experience nor Faction Cubes.\par
