...
\begin{itemize}
  ...
  \item You move into a Town or Settlement owned by them, see \pagelink{Town Combat}{Town Combat}.
\end{itemize}
...
\pagetarget{Town Combat}{\subheader{Town Combat}}\index{Defending Town}
\begin{multicols*}{2}
