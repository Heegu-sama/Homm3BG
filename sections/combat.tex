...
A neutral combat starts as well, when a hero moves to an \textbf{unvisited} \pagelink{All Map Location}{Creature Bank Location}. In this case follow the rules for \pagelink{Creature Banks}{Combat against Creature Banks}.
\end{expansion}
