...
Level numbers written in gold on the Level Tracker (\svgeven{level1}, \svgeven{level4} and \svgeven{level6}) give you a Specialty Card, while silver Levels (II, III, V, VII) give you an Ability Card.
\end{itemize}
\vfill\null
\columnbreak
List of all effects:
