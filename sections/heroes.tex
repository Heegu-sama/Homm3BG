...
Experience is gained from \pagelink{Combatexperience}{winning Combat}, Visiting certain \pagelink{All}{Locations} and the \pagelink{Resources}{Treasure Die} \includesvg[height=10px]{\svgs/treasure.svg}.
...
If a Secondary Hero gains any Cards, \pagelink{Playerdecks}{place them into your hand} as normal.
...
If your Secondary Hero is attacked by an enemy Hero, you can choose to have your Hero be \pagelink{Endcombat}{instantly defeated instead of fighting a Combat}.
...
The most common sources of gaining Experience are the \pagelink{Resources}{Treasure Die} and \pagelink{Combatexperience}{Combat}.
...
\item At which Levels your Main Hero must \pagelink{Playerdecks}{\textbf{Search}} for a new \pagelink{Ability}{Ability Card} or gain a \pagelink{Specialty}{Specialty Card}.
