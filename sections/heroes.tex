...
\vspace*{\fill}
\hspace{2em}
{\transparent{0.2}\includegraphics[width=\linewidth]{\art/teleport.png}}
\vspace*{\fill}
...
\begin{figure}[h]
  ...
  \begin{minipage}[t]{0.48\textwidth}
    ...
    \hspace*{1em}
    \begin{tikzpicture}
      \node (board) [inner sep=0] {\makebox[\textwidth][c]{\includegraphics[width=\linewidth]{\cards/hero.png}}};
