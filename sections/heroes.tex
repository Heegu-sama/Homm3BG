...
\pl{
  \addsection{Bohaterowie}{\skills/sorcery.png}
}
...
\en{
  ...
  Gaining 1 Experience\index{Experience} is represented by the symbol \includesvg[height=10px]{\svgs/experience.svg}.
}
\pl{
  \subsection*{Bohater Główny}
  Bohater Główny\index{Bohater Główny}...
}
...
\pl{
  \subsection*{\hypertarget{Pomocniczy}{Bohater Pomocniczy}}
}
...
\pl{
  \subsection*{\hypertarget{Planszetki}{Planszetki Bohaterów}}\index{Planszetki Bohaterów}
}
\bigbreak
\begin{figure}[h]
  \begin{minipage}[t]{0.5\textwidth}
    ...
    \begin{enumerate}[itemsep=5pt]
      ...
      \pl{\item}
      \en{\item \textbf{Faction Color} – Reminder for the color of the Faction's cubes and miniatures.}
      \pl{\item}
      \en{\item \textbf{Attack} – Number of Attack Cards in your Starting Deck.}
      \pl{\item}
      \en{\item \textbf{Defense} – Number of Defense Cards in your Starting Deck.}
      \pl{\item}
      \en{\item \textbf{Power} – Number of Power Cards in your Starting Deck.}
      \pl{\item}
      \en{\item \textbf{Knowledge} – Number of Knowledge Cards in your Starting Deck.}
      \pl{\item}
      \en{\item \textbf{Starting Ability} – Reminder for the unique Ability Card\index{Ability Card} the Hero starts with.}
      \pl{\item}
      \en{
      ...
      \pl{\item}
      \en{
        \item \textbf{Level Tracker} – Whenever a Main Hero gains 1 or more Experience \includesvg[height=10px]{\svgs/experience.svg}, move the cube that number of steps on this track.
  ...
  \begin{minipage}[t]{0.48\textwidth}
    ...
    \end{scriptsize}
    \break
    \en{\footnotesize{\textbf{\textit{\textcolor{darkcandyapplered}{Hero Card}}}}}
    \pl{\footnotesize{\textbf{\textit{\textcolor{darkcandyapplered}{planszetka Bohatera}}}}}
    \scriptsize
    \begin{multicols}{2}
      \begin{itemize}
        \en{\item[\textbf{1.}] \textbf{Name}}
        \pl{\item}
        \en{\item[\textbf{2.}] \textbf{Class}}
        \pl{\item}
        \en{\item[\textbf{3.}] \textbf{Type}}
        \pl{\item}
        \en{\item[\textbf{4.}] \textbf{Faction Color}}
        \pl{\item}
        \en{\item[\textbf{5.}] \textbf{Attack}}
        \pl{\item}
        \en{\item[\textbf{6.}] \textbf{Defense}}
        \pl{\item}
        \en{\item[\textbf{7.}] \textbf{Power}}
        \pl{\item}
        \en{\item[\textbf{8.}] \textbf{Knowledge}}
        \pl{\item}
        \en{\item[\textbf{9.}] \textbf{Starting Ability}}
        \pl{\item}
        \en{\item[\textbf{10.}] \textbf{Specialty}}
        \pl{\item}
        \en{\item[\textbf{11.}] \textbf{Level Tracker}}
        \pl{\item}
        \en{\item[\textbf{\phantom{.}}] \phantom{.}}
        \pl{\item}
      \end{itemize}
    \end{multicols}
  \end{minipage}
...
\en{
  ...
  Main Heroes always start each Scenario at Level 1\index{Level} and may Level up by gaining Experience \includesvg[height=10px]{\svgs/experience.svg}.
...
\pl{}
\begin{itemize}
  \en{\item Your Main Hero's current Level and amount of Experience gained, shown by the cube's position.}
  \pl{\item}
  \en{\item Your current Hand Limit \includesvg[height=10px]{\svgs/hand.svg}.}
  \pl{\item}
  \en{\item The number of \hyperlink{Ability}{Expert Effects} \includesvg[height=10px]{\svgs/expert.svg} you may use during a Round.}
  \pl{\item}
  \en{
