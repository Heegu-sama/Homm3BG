...
\begin{figure}[h]
  \begin{minipage}[t]{0.5\textwidth}
    ...
    \begin{enumerate}[itemsep=5pt]
      ...
      \item \textbf{Attack}\index{Attack} – Number of \wikilink{statistics/attack}{Attack} cards in your Starting Deck.
      \item \textbf{Defense}\index{Defense} – Number of \wikilink{statistics/defense}{Defense} cards in your Starting Deck.
