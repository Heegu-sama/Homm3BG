...
\begin{itemize}
  ...
  \item At Levels \level{II}, \level{III}, \level{V}, and \level{VII} (marked with silver Roman numerals on the tracker), \pagelink{Playerdecks}{Search~(2) the Ability Deck} and add the chosen card to your hand.
  \item At Levels \level{I}, \level{IV}, and \level{VI} (marked in gold), gain the corresponding \pagelink{Specialty}{Specialty card} and add it to your hand.
  ...
  \item \pagetarget{Expert Effect Markers}{}Each time you reach an Expert Effects \svg{expert} slot, you may play one additional card for its Expert Effect per Round (up to a maximum of 3 at Level~\level{VI}).
