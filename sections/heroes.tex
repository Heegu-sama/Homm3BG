...
\begin{itemize}
  ...
  \item At Levels {\liberation\textbf{II}}, {\liberation\textbf{III}}, {\liberation\textbf{V}}, and {\liberation\textbf{VII}} (marked with silver Roman numerals on the tracker), \pagelink{Playerdecks}{Search~(2) the Ability Deck} and add the chosen card to your hand.
  \item At Levels \svg[8.7]{level1}, \svg[8.7]{level4}, and \svg[8.7]{level6} (marked in gold), gain the corresponding \pagelink{Specialty}{Specialty card} and add it to your hand.
  ...
  \item \pagetarget{Expert Effect Markers}{}Each time you reach an Expert Effects \svg{expert} slot, you may play one additional card for its Expert Effect per Round (up to a maximum of 3 at Level~\svg[8.7]{level6}).
