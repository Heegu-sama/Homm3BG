...
\pagetarget{Difficulty}{\addsection{Difficulty}{\spells/berserk.png}}\index{Difficulty}

\begin{multicols}{2}

During setup, players must choose the game's Difficulty.
There are four different Difficulties, each with a different starting bonus\index{Starting Bonus} that players receive during step 17 of the setup:
\begin{itemize}
